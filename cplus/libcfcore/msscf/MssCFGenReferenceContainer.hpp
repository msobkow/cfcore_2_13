...
namespace cfcore {
	...
	class MssCFGenReferenceContainer : public MssCFGenReferenceObj
	{
		public:

			static const std::string CLASS_NAME;

			MssCFGenReferenceContainer();
			MssCFGenReferenceContainer( MssCFEngine* schema );
			MssCFGenReferenceContainer(
				MssCFEngine* engine,
			...
			virtual ~MssCFGenReferenceContainer();
