// Description: C++18 Instance Edit Object interface implementation for CFGenKb GelCall.
...
namespace cfcore {
	...
	const std::string ICFGenKbGelCallEditObj::CLASS_NAME( "ICFGenKbGelCallEditObj" );

	ICFGenKbGelCallEditObj::ICFGenKbGelCallEditObj()
