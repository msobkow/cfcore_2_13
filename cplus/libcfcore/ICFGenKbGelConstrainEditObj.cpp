// Description: C++18 Instance Edit Object interface implementation for CFGenKb GelConstrain.
...
namespace cfcore {
	...
	const std::string ICFGenKbGelConstrainEditObj::CLASS_NAME( "ICFGenKbGelConstrainEditObj" );

	ICFGenKbGelConstrainEditObj::ICFGenKbGelConstrainEditObj()
