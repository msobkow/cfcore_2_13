...
namespace cfcore {
	const std::string MssCFGenReferenceObj::CLASS_NAME( "MssCFGenReferenceObj" );
	const std::string MssCFGenReferenceObj::S_Asterisk( "*" );
	const std::string MssCFGenReferenceObj::S_GenContext( "genContext" );
	const std::string MssCFGenReferenceObj::S_Object( "Object" );

	ICFGenKbDefClassObj* MssCFGenReferenceObj::getDetailClass() {
		return( detailClass );
	}

	void MssCFGenReferenceObj::setDetailClass( ICFGenKbDefClassObj* value ) {
		detailClass = value;
	}

	MssCFGenReferenceObj::MssCFGenReferenceObj()
	: CFGenKbGenReferenceObj()
	{
	}

	MssCFGenReferenceObj::MssCFGenReferenceObj( MssCFEngine* schema )
	: CFGenKbGenReferenceObj( schema )
	{
	}
	...
	std::string MssCFGenReferenceObj::expandBody( MssCFGenContext* genContext ) {
	...
	cflib::ICFLibAnyObj* MssCFGenReferenceObj::dereference( MssCFGenContext* genContext ) {
