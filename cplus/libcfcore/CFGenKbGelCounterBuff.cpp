// Description: C++18 implementation for a GelCounter buffer object.
...
namespace cfcore {
	...
	const std::string CFGenKbGelCounterBuff::GENDEFNAME( "GelCounter" );
	const classcode_t CFGenKbGelCounterBuff::CLASS_CODE = 0xa92dL;
	const std::string CFGenKbGelCounterBuff::CLASS_NAME( "CFGenKbGelCounterBuff" );
		const std::string CFGenKbGelCounterBuff::COLNAME_COUNTERNAME( "CounterName" );
	const int64_t CFGenKbGelCounterBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFGenKbGelCounterBuff::GELCACHEID_INIT_VALUE = 0LL;
	const int64_t CFGenKbGelCounterBuff::GELINSTID_INIT_VALUE = 0LL;
	const std::string CFGenKbGelCounterBuff::COUNTERNAME_INIT_VALUE( "" );
	const int64_t CFGenKbGelCounterBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFGenKbGelCounterBuff::GELCACHEID_MIN_VALUE = 0LL;
	const int64_t CFGenKbGelCounterBuff::GELINSTID_MIN_VALUE = 0LL;
	const std::string::size_type CFGenKbGelCounterBuff::COUNTERNAME_MAX_LEN = 127;

	CFGenKbGelCounterBuff::CFGenKbGelCounterBuff()
	: CFGenKbGelInstructionBuff()
	{
		requiredCounterName = new std::string( cfcore::CFGenKbGelCounterBuff::COUNTERNAME_INIT_VALUE );
	}

	CFGenKbGelCounterBuff::CFGenKbGelCounterBuff( const CFGenKbGelCounterBuff& src )
	: CFGenKbGelInstructionBuff()
	{
		requiredCounterName = new std::string( cfcore::CFGenKbGelCounterBuff::COUNTERNAME_INIT_VALUE );
	...
	CFGenKbGelCounterBuff::~CFGenKbGelCounterBuff() {
		if( requiredCounterName != NULL ) {
			delete requiredCounterName;
			requiredCounterName = NULL;
		}
	}

	cflib::ICFLibCloneableObj* CFGenKbGelCounterBuff::clone() {
		CFGenKbGelCounterBuff* copy = new CFGenKbGelCounterBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFGenKbGelCounterBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFGenKbGelCounterBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFGenKbGelCounterBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const std::string& CFGenKbGelCounterBuff::getRequiredCounterName() const {
		return( *requiredCounterName );
	}

	const std::string* CFGenKbGelCounterBuff::getRequiredCounterNameReference() const {
		return( requiredCounterName );
	}

	void CFGenKbGelCounterBuff::setRequiredCounterName( const std::string& value ) {
		static const std::string S_ProcName( "setRequiredCounterName" );
		if( value.length() > CFGenKbGelCounterBuff::COUNTERNAME_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE_LENGTH,
				value.length(),
				CFGenKbGelCounterBuff::COUNTERNAME_MAX_LEN );
		}
		if( requiredCounterName != NULL ) {
			delete requiredCounterName;
			requiredCounterName = NULL;
		}
		requiredCounterName = new std::string( value );
	}

	size_t CFGenKbGelCounterBuff::hashCode() const {
		size_t hashCode = CFGenKbGelInstructionBuff::hashCode();
		hashCode = hashCode + cflib::CFLib::hash( getRequiredCounterName() );
		return( hashCode );
	}

	CFGenKbGelCounterBuff CFGenKbGelCounterBuff::operator =( cfcore::CFGenKbGelCounterBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredGelCacheId( src.getRequiredGelCacheId() );
		setRequiredGelInstId( src.getRequiredGelInstId() );
		setRequiredRevision( src.getRequiredRevision() );
	...
	bool CFGenKbGelCounterBuff::operator <( const CFGenKbGelInstructionPKey& rhs ) {
	...
	bool CFGenKbGelCounterBuff::operator <( const CFGenKbGelCounterBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
		...
		if( getRequiredCounterName() > rhs.getRequiredCounterName() ) {
			return( false );
		}
		else if( getRequiredCounterName() < rhs.getRequiredCounterName() ) {
			return( true );
		}
		return( false );
	}
	...
	std::string CFGenKbGelCounterBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFGenKbGelCounterBuff" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredXmlString( &S_Space, S_CounterName, getRequiredCounterName() ) );
...
namespace std {
	...
	bool operator <(const  cfcore::CFGenKbGelCounterBuff& lhs, const cfcore::CFGenKbGelCounterBuff& rhs ) {
		...
		if( lhs.getRequiredCounterName() > rhs.getRequiredCounterName() ) {
			return( false );
		}
		else if( lhs.getRequiredCounterName() < rhs.getRequiredCounterName() ) {
			return( true );
		}
		return( false );
	}
