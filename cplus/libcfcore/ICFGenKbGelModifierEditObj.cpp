// Description: C++18 Instance Edit Object interface implementation for CFGenKb GelModifier.
...
namespace cfcore {
	...
	const std::string ICFGenKbGelModifierEditObj::CLASS_NAME( "ICFGenKbGelModifierEditObj" );

	ICFGenKbGelModifierEditObj::ICFGenKbGelModifierEditObj()
