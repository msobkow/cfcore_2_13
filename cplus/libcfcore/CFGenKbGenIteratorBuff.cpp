// Description: C++18 implementation for a GenIterator buffer object.
...
namespace cfcore {
	...
	const std::string CFGenKbGenIteratorBuff::GENDEFNAME( "GenIterator" );
	const classcode_t CFGenKbGenIteratorBuff::CLASS_CODE = 0xa921L;
	const std::string CFGenKbGenIteratorBuff::CLASS_NAME( "CFGenKbGenIteratorBuff" );
	const int64_t CFGenKbGenIteratorBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFGenKbGenIteratorBuff::CARTRIDGEID_INIT_VALUE = 0LL;
	const int64_t CFGenKbGenIteratorBuff::ITEMID_INIT_VALUE = 0LL;
	const int64_t CFGenKbGenIteratorBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFGenKbGenIteratorBuff::CARTRIDGEID_MIN_VALUE = 0LL;
	const int64_t CFGenKbGenIteratorBuff::ITEMID_MIN_VALUE = 0LL;
	const int64_t CFGenKbGenIteratorBuff::ITEMID_MAX_VALUE = 2147483647LL;

	CFGenKbGenIteratorBuff::CFGenKbGenIteratorBuff()
	: CFGenKbGenItemBuff()
	{
	}

	CFGenKbGenIteratorBuff::CFGenKbGenIteratorBuff( const CFGenKbGenIteratorBuff& src )
	: CFGenKbGenItemBuff()
	{
	...
	cflib::ICFLibCloneableObj* CFGenKbGenIteratorBuff::clone() {
		CFGenKbGenIteratorBuff* copy = new CFGenKbGenIteratorBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFGenKbGenIteratorBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFGenKbGenIteratorBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFGenKbGenIteratorBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	size_t CFGenKbGenIteratorBuff::hashCode() const {
		size_t hashCode = CFGenKbGenItemBuff::hashCode();
		return( hashCode );
	}

	CFGenKbGenIteratorBuff CFGenKbGenIteratorBuff::operator =( cfcore::CFGenKbGenIteratorBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredCartridgeId( src.getRequiredCartridgeId() );
		setRequiredItemId( src.getRequiredItemId() );
		setRequiredRevision( src.getRequiredRevision() );
	...
	bool CFGenKbGenIteratorBuff::operator <( const CFGenKbGenItemPKey& rhs ) {
	...
	bool CFGenKbGenIteratorBuff::operator <( const CFGenKbGenIteratorBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFGenKbGenIteratorBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFGenKbGenIteratorBuff" );
...
namespace std {
	...
	bool operator <(const  cfcore::CFGenKbGenIteratorBuff& lhs, const cfcore::CFGenKbGenItemPKey& rhs ) {
	...
	bool operator <(const  cfcore::CFGenKbGenIteratorBuff& lhs, const cfcore::CFGenKbGenIteratorBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
