...
namespace cfcore {
	...
	const std::string CFGenKbSecFormPKey::CLASS_NAME( "CFGenKbSecFormPKey" );
	const std::string CFGenKbSecFormPKey::S_VALUE( "value" );
	const std::string CFGenKbSecFormPKey::S_VALUE_LENGTH( "value.length()" );

	CFGenKbSecFormPKey::CFGenKbSecFormPKey() {
	...
	CFGenKbSecFormPKey::CFGenKbSecFormPKey( const CFGenKbSecFormPKey& src ) {
		requiredClusterId = cfcore::CFGenKbSecFormBuff::CLUSTERID_INIT_VALUE;
		requiredSecFormId = cfcore::CFGenKbSecFormBuff::SECFORMID_INIT_VALUE;
	...
	const int64_t CFGenKbSecFormPKey::getRequiredClusterId() const {
		return( requiredClusterId );
	}

	const int64_t* CFGenKbSecFormPKey::getRequiredClusterIdReference() const {
		return( &requiredClusterId );
	}

	void CFGenKbSecFormPKey::setRequiredClusterId( const int64_t value ) {
	...
	const int32_t CFGenKbSecFormPKey::getRequiredSecFormId() const {
		return( requiredSecFormId );
	}

	const int32_t* CFGenKbSecFormPKey::getRequiredSecFormIdReference() const {
		return( &requiredSecFormId );
	}

	void CFGenKbSecFormPKey::setRequiredSecFormId( const int32_t value ) {
	...
	bool CFGenKbSecFormPKey::operator <( const CFGenKbSecFormPKey& rhs ) {
	...
	bool CFGenKbSecFormPKey::operator <( const CFGenKbSecFormBuff& rhs ) {
		if( getRequiredClusterId() > rhs.getRequiredClusterId() ) {
			return( false );
		}
		else if( getRequiredClusterId() < rhs.getRequiredClusterId() ) {
	...
	CFGenKbSecFormPKey CFGenKbSecFormPKey::operator =( cfcore::CFGenKbSecFormPKey& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredSecFormId( src.getRequiredSecFormId() );
		return( *this );
	}

	CFGenKbSecFormPKey CFGenKbSecFormPKey::operator =( cfcore::CFGenKbSecFormBuff& src ) {
		setRequiredClusterId( src.getRequiredClusterId() );
		setRequiredSecFormId( src.getRequiredSecFormId() );
		return( *this );
	}

	size_t CFGenKbSecFormPKey::hashCode() const {
		size_t hashCode = 0;
	...
	std::string CFGenKbSecFormPKey::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFGenKbSecFormPKey" );
