...
// Description: C++18 base object instance specification for CFGenKb TSecGrpMemb.
...
namespace cfcore {
	...
	class CFGenKbTSecGrpMembObj
	: public virtual ICFGenKbTSecGrpMembObj
	{
	protected:
		cfcore::ICFGenKbSecUserObj* createdBy = NULL;
		cfcore::ICFGenKbSecUserObj* updatedBy = NULL;
		bool isNew;
		cfcore::ICFGenKbTSecGrpMembEditObj* edit;
	...
	public:
		...
		CFGenKbTSecGrpMembObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbTSecGrpMembObj();
		...
		virtual cfcore::ICFGenKbTSecGrpMembObj* realize();
		...
		virtual cfcore::ICFGenKbTSecGrpMembEditObj* beginEdit();
