...
// Description: C++18 Object interface for CFGenKb DefClass.
...
namespace cfcore {
	...
	public:
		...
		virtual cfcore::ICFGenKbDefClassObj* realize() = 0;

		virtual cfcore::ICFGenKbDefClassObj* read( bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbDefClassEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfcore::ICFGenKbDefClassEditObj* getEdit() = 0;

		virtual cfcore::ICFGenKbDefClassEditObj* getDefClassEdit() = 0;

		virtual cfcore::ICFGenKbDefClassTableObj* getDefClassTable() = 0;

		virtual cfcore::ICFGenKbSchemaObj* getSchema() = 0;

		virtual cfcore::CFGenKbDefClassBuff* getBuff() = 0;
		virtual void setBuff( cfcore::CFGenKbDefClassBuff* value ) = 0;

		inline cfcore::CFGenKbDefClassBuff* getDefClassBuff() {
			return( static_cast<cfcore::CFGenKbDefClassBuff*>( getBuff() ) );
		};

		inline cfcore::CFGenKbDefClassBuff* getDefClassEditBuff() {
			return( dynamic_cast<cfcore::CFGenKbDefClassBuff*>( getBuff() ) );
		};

		virtual cfcore::CFGenKbDefClassPKey* getPKey() = 0;
		virtual void setPKey( cfcore::CFGenKbDefClassPKey* value ) = 0;
		...
		virtual bool isOptionalBaseIdNull() = 0;
		virtual const int16_t getOptionalBaseIdValue() = 0;
		virtual const int16_t* getOptionalBaseIdReference() = 0;

		virtual cfcore::ICFGenKbDefClassObj* getOptionalParentBaseDefClass( bool forceRead = false ) = 0;
