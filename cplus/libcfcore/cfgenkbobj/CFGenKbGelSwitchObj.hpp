...
// Description: C++18 base object instance specification for CFGenKb GelSwitch.
...
namespace cfcore {
	...
	class CFGenKbGelSwitchObj
	: public CFGenKbGelInstructionObj,
	  public virtual ICFGenKbGelSwitchObj
	{
	protected:
	public:
		...
		CFGenKbGelSwitchObj();
		CFGenKbGelSwitchObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGelSwitchObj();
