...
// Description: C++18 base object instance specification for CFGenKb SecUser.
...
namespace cfcore {
	...
	class CFGenKbSecUserObj
	: public virtual ICFGenKbSecUserObj
	{
	protected:
		cfcore::ICFGenKbSecUserObj* createdBy = NULL;
		cfcore::ICFGenKbSecUserObj* updatedBy = NULL;
		bool isNew;
		cfcore::ICFGenKbSecUserEditObj* edit;
	...
	public:
		...
		CFGenKbSecUserObj();
		CFGenKbSecUserObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbSecUserObj();
		...
		virtual cfcore::ICFGenKbSecUserObj* realize();
		...
		virtual cfcore::ICFGenKbSecUserEditObj* beginEdit();
