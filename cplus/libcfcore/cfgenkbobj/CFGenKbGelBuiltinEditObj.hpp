...
// Description: C++18 edit object instance specification for CFGenKb GelBuiltin.
...
namespace cfcore {
	...
	class CFGenKbGelBuiltinEditObj
	: public CFGenKbGelInstructionEditObj,
	  public virtual ICFGenKbGelBuiltinEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFGenKbGelBuiltinEditObj( cfcore::ICFGenKbGelBuiltinObj* argOrig );
		virtual ~CFGenKbGelBuiltinEditObj();
		...
		virtual cfcore::ICFGenKbGelBuiltinTableObj* getGelBuiltinTable();

		virtual cfcore::ICFGenKbGelBuiltinEditObj* getGelBuiltinEdit();

		virtual ICFGenKbGelInstructionEditObj* beginEdit();

		virtual cfcore::ICFGenKbGelBuiltinObj* getOrigAsGelBuiltin();

		virtual cfcore::CFGenKbGelInstructionBuff* getBuff();
		virtual void setBuff( cfcore::CFGenKbGelInstructionBuff* value );

		inline cfcore::CFGenKbGelBuiltinBuff* getGelBuiltinBuff() {
			// Buff is always instantiated when constructed over an original object
			return( static_cast<cfcore::CFGenKbGelBuiltinBuff*>( buff ) );
		};

		inline cfcore::CFGenKbGelBuiltinBuff* getGelBuiltinEditBuff() {
			// Buff is always instantiated when constructed over an original object
