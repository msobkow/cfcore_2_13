...
// Description: C++18 Instance Edit Object interface for CFGenKb GenTrunc.
...
namespace cfcore {
	...
	: public virtual cfcore::ICFGenKbGenRuleEditObj,
	  public virtual cfcore::ICFGenKbGenTruncObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFGenKbGenTruncEditObj();
		virtual ~ICFGenKbGenTruncEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfcore::CFGenKbGenTruncBuff* getGenTruncBuff() {
			return( static_cast<cfcore::CFGenKbGenTruncBuff*>( getBuff() ) );
		};

		inline cfcore::CFGenKbGenTruncBuff* getGenTruncEditBuff() {
			return( dynamic_cast<cfcore::CFGenKbGenTruncBuff*>( getBuff() ) );
		};

		virtual cfcore::ICFGenKbGenTruncObj* getOrigAsGenTrunc() = 0;

		virtual cfcore::ICFGenKbGenItemEditObj* beginEdit() = 0;

		virtual const int32_t getRequiredTruncateAt() = 0;
		virtual const int32_t* getRequiredTruncateAtReference() = 0;
		virtual void setRequiredTruncateAt( const int32_t value ) = 0;
