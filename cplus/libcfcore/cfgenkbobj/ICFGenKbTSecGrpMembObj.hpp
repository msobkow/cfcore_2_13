...
// Description: C++18 Object interface for CFGenKb TSecGrpMemb.
...
namespace cfcore {
	...
	public:
		...
		virtual ~ICFGenKbTSecGrpMembObj();
		...
		virtual cfcore::ICFGenKbTSecGrpMembObj* realize() = 0;

		virtual cfcore::ICFGenKbTSecGrpMembObj* read( bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbTSecGrpMembEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfcore::ICFGenKbTSecGrpMembEditObj* getEdit() = 0;

		virtual cfcore::ICFGenKbTSecGrpMembEditObj* getTSecGrpMembEdit() = 0;

		virtual cfcore::ICFGenKbTSecGrpMembTableObj* getTSecGrpMembTable() = 0;

		virtual cfcore::ICFGenKbSchemaObj* getSchema() = 0;

		virtual cfcore::CFGenKbTSecGrpMembBuff* getBuff() = 0;
		virtual void setBuff( cfcore::CFGenKbTSecGrpMembBuff* value ) = 0;
		...
		virtual cfcore::CFGenKbTSecGrpMembPKey* getPKey() = 0;
		virtual void setPKey( cfcore::CFGenKbTSecGrpMembPKey* value ) = 0;
