...
// Description: C++18 base object instance specification for CFGenKb DefClass.
...
namespace cfcore {
	...
	class CFGenKbDefClassObj
	: public virtual ICFGenKbDefClassObj
	{
	protected:
		bool isNew;
		cfcore::ICFGenKbDefClassEditObj* edit;
	...
	public:
		...
		CFGenKbDefClassObj();
		CFGenKbDefClassObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbDefClassObj();
		...
		virtual cfcore::ICFGenKbDefClassObj* realize();
		...
		virtual cfcore::ICFGenKbDefClassEditObj* beginEdit();
