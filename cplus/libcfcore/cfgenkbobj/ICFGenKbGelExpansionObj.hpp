...
// Description: C++18 Object interface for CFGenKb GelExpansion.
...
namespace cfcore {
	...
	public:
		...
		virtual ~ICFGenKbGelExpansionObj();
		virtual cfcore::ICFGenKbGelInstructionEditObj* beginEdit() = 0;

		virtual cfcore::ICFGenKbGelExpansionEditObj* getGelExpansionEdit() = 0;
