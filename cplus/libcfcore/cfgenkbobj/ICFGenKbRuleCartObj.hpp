...
// Description: C++18 Object interface for CFGenKb RuleCart.
...
namespace cfcore {
	...
	public:
		...
		virtual cfcore::ICFGenKbRuleCartObj* realize() = 0;

		virtual cfcore::ICFGenKbRuleCartObj* read( bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbRuleCartEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfcore::ICFGenKbRuleCartEditObj* getEdit() = 0;

		virtual cfcore::ICFGenKbRuleCartEditObj* getRuleCartEdit() = 0;

		virtual cfcore::ICFGenKbRuleCartTableObj* getRuleCartTable() = 0;

		virtual cfcore::ICFGenKbSchemaObj* getSchema() = 0;

		virtual cfcore::CFGenKbRuleCartBuff* getBuff() = 0;
		virtual void setBuff( cfcore::CFGenKbRuleCartBuff* value ) = 0;

		inline cfcore::CFGenKbRuleCartBuff* getRuleCartBuff() {
			return( static_cast<cfcore::CFGenKbRuleCartBuff*>( getBuff() ) );
		};

		inline cfcore::CFGenKbRuleCartBuff* getRuleCartEditBuff() {
			return( dynamic_cast<cfcore::CFGenKbRuleCartBuff*>( getBuff() ) );
		};

		virtual cfcore::CFGenKbRuleCartPKey* getPKey() = 0;
		virtual void setPKey( cfcore::CFGenKbRuleCartPKey* value ) = 0;
		...
		virtual std::vector<cfcore::ICFGenKbGenItemObj*> getOptionalComponentsRule( bool forceRead = false ) = 0;
