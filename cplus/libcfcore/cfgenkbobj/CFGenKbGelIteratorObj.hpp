...
// Description: C++18 base object instance specification for CFGenKb GelIterator.
...
namespace cfcore {
	...
	class CFGenKbGelIteratorObj
	: public CFGenKbGelInstructionObj,
	  public virtual ICFGenKbGelIteratorObj
	{
	protected:
	public:
		...
		CFGenKbGelIteratorObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGelIteratorObj();
