...
// Description: C++18 base object instance specification for CFGenKb GelPrefixLine.
...
namespace cfcore {
	...
	class CFGenKbGelPrefixLineObj
	: public CFGenKbGelInstructionObj,
	  public virtual ICFGenKbGelPrefixLineObj
	{
	protected:
	public:
		...
		CFGenKbGelPrefixLineObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGelPrefixLineObj();
