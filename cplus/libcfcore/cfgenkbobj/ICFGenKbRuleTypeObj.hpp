...
// Description: C++18 Object interface for CFGenKb RuleType.
...
namespace cfcore {
	...
	public:
		...
		virtual cfcore::ICFGenKbRuleTypeObj* realize() = 0;

		virtual cfcore::ICFGenKbRuleTypeObj* read( bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbRuleTypeEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfcore::ICFGenKbRuleTypeEditObj* getEdit() = 0;

		virtual cfcore::ICFGenKbRuleTypeEditObj* getRuleTypeEdit() = 0;

		virtual cfcore::ICFGenKbRuleTypeTableObj* getRuleTypeTable() = 0;

		virtual cfcore::ICFGenKbSchemaObj* getSchema() = 0;

		virtual cfcore::CFGenKbRuleTypeBuff* getBuff() = 0;
		virtual void setBuff( cfcore::CFGenKbRuleTypeBuff* value ) = 0;

		inline cfcore::CFGenKbRuleTypeBuff* getRuleTypeBuff() {
			return( static_cast<cfcore::CFGenKbRuleTypeBuff*>( getBuff() ) );
		};

		inline cfcore::CFGenKbRuleTypeBuff* getRuleTypeEditBuff() {
			return( dynamic_cast<cfcore::CFGenKbRuleTypeBuff*>( getBuff() ) );
		};

		virtual cfcore::CFGenKbRuleTypePKey* getPKey() = 0;
		virtual void setPKey( cfcore::CFGenKbRuleTypePKey* value ) = 0;
