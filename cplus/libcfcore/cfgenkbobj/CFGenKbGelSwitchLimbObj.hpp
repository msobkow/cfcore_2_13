...
// Description: C++18 base object instance specification for CFGenKb GelSwitchLimb.
...
namespace cfcore {
	...
	class CFGenKbGelSwitchLimbObj
	: public virtual ICFGenKbGelSwitchLimbObj
	{
	protected:
		bool isNew;
		cfcore::ICFGenKbGelSwitchLimbEditObj* edit;
	...
	public:
		...
		CFGenKbGelSwitchLimbObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGelSwitchLimbObj();
		...
		virtual cfcore::ICFGenKbGelSwitchLimbObj* realize();
		...
		virtual cfcore::ICFGenKbGelSwitchLimbEditObj* beginEdit();
