...
namespace cfcore {
	...
	{
	public:
		ICFGenKbGenRuleTableObj();
		virtual ~ICFGenKbGenRuleTableObj();
		...
		virtual cfcore::ICFGenKbGenRuleObj* newInstance() = 0;

		virtual cfcore::ICFGenKbGenRuleEditObj* newEditInstance( cfcore::ICFGenKbGenRuleObj* orig ) = 0;

		virtual cfcore::ICFGenKbGenRuleObj* realizeGenRule( cfcore::ICFGenKbGenRuleObj* Obj ) = 0;
		...
		virtual void reallyDeepDisposeGenRule( cfcore::ICFGenKbGenRuleObj* Obj ) = 0;
		virtual void deepDisposeByBodyIdx( const int64_t* BodyTenantId,
			const int64_t* BodyGelCacheId,
			const int64_t* BodyGelId ) = 0;
		virtual cfcore::ICFGenKbGenRuleObj* createGenRule( cfcore::ICFGenKbGenRuleEditObj* Obj ) = 0;

		virtual cfcore::ICFGenKbGenRuleObj* readGenRule( cfcore::CFGenKbGenItemPKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbGenRuleObj* lockGenRule( cfcore::CFGenKbGenItemPKey* pkey ) = 0;

		virtual std::vector<cfcore::ICFGenKbGenRuleObj*> readAllGenRule( bool forceRead = false ) = 0;
		...
		virtual cfcore::ICFGenKbGenRuleObj* readCachedGenRule( cfcore::CFGenKbGenItemPKey* pkey ) = 0;

		virtual cfcore::ICFGenKbGenRuleObj* readCachedGenRuleByItemIdIdx(const int64_t TenantId,
			const int64_t CartridgeId,
			const int64_t ItemId ) = 0;

		virtual std::vector<cfcore::ICFGenKbGenRuleObj*> readCachedGenRuleByTenantIdx( const int64_t TenantId ) = 0;

		virtual std::vector<cfcore::ICFGenKbGenRuleObj*> readCachedGenRuleByCartIdx( const int64_t TenantId,
			const int64_t CartridgeId ) = 0;

		virtual std::vector<cfcore::ICFGenKbGenRuleObj*> readCachedGenRuleByRuleTypeIdx( const int16_t RuleTypeId ) = 0;

		virtual std::vector<cfcore::ICFGenKbGenRuleObj*> readCachedGenRuleByToolSetIdx( const int16_t ToolSetId ) = 0;

		virtual std::vector<cfcore::ICFGenKbGenRuleObj*> readCachedGenRuleByScopeIdx( const int16_t* ScopeDefId ) = 0;

		virtual std::vector<cfcore::ICFGenKbGenRuleObj*> readCachedGenRuleByGenDefIdx( const int16_t GenDefId ) = 0;
		...
		virtual cfcore::ICFGenKbGenRuleObj* updateGenRule( cfcore::ICFGenKbGenRuleEditObj* Obj ) = 0;

		virtual void deleteGenRule( cfcore::ICFGenKbGenRuleEditObj* Obj ) = 0;

		virtual void deleteGenRuleByItemIdIdx( const int64_t TenantId,
			const int64_t CartridgeId,
			const int64_t ItemId ) = 0;

		virtual void deleteGenRuleByTenantIdx( const int64_t TenantId ) = 0;

		virtual void deleteGenRuleByCartIdx( const int64_t TenantId,
			const int64_t CartridgeId ) = 0;

		virtual void deleteGenRuleByRuleTypeIdx( const int16_t RuleTypeId ) = 0;

		virtual void deleteGenRuleByToolSetIdx( const int16_t ToolSetId ) = 0;

		virtual void deleteGenRuleByScopeIdx( const int16_t* ScopeDefId ) = 0;

		virtual void deleteGenRuleByGenDefIdx( const int16_t GenDefId ) = 0;
		...
		virtual void reallyDetachFromIndexesGenRule( cfcore::ICFGenKbGenRuleObj* Obj ) = 0;
