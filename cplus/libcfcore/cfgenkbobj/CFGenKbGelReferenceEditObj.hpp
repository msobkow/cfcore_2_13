...
// Description: C++18 edit object instance specification for CFGenKb GelReference.
...
namespace cfcore {
	...
	class CFGenKbGelReferenceEditObj
	: public CFGenKbGelInstructionEditObj,
	  public virtual ICFGenKbGelReferenceEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFGenKbGelReferenceEditObj( cfcore::ICFGenKbGelReferenceObj* argOrig );
		virtual ~CFGenKbGelReferenceEditObj();
		...
		virtual cfcore::ICFGenKbGelReferenceTableObj* getGelReferenceTable();

		virtual cfcore::ICFGenKbGelReferenceEditObj* getGelReferenceEdit();

		virtual ICFGenKbGelInstructionEditObj* beginEdit();

		virtual cfcore::ICFGenKbGelReferenceObj* getOrigAsGelReference();
		...
		inline cfcore::CFGenKbGelReferenceBuff* getGelReferenceBuff() {
			...
			return( static_cast<cfcore::CFGenKbGelReferenceBuff*>( buff ) );
		};
		...
		virtual const std::string& getRequiredReferenceName();
		virtual const std::string* getRequiredReferenceNameReference();
		virtual void setRequiredReferenceName( const std::string& value );
