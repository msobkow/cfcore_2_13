...
namespace cfcore {
	...
	{
	public:
		ICFGenKbGelSwitchTableObj();
		virtual ~ICFGenKbGelSwitchTableObj();
		...
		virtual cfcore::ICFGenKbGelSwitchObj* newInstance() = 0;

		virtual cfcore::ICFGenKbGelSwitchEditObj* newEditInstance( cfcore::ICFGenKbGelSwitchObj* orig ) = 0;

		virtual cfcore::ICFGenKbGelSwitchObj* realizeGelSwitch( cfcore::ICFGenKbGelSwitchObj* Obj ) = 0;
		...
		virtual void reallyDeepDisposeGelSwitch( cfcore::ICFGenKbGelSwitchObj* Obj ) = 0;
		virtual cfcore::ICFGenKbGelSwitchObj* createGelSwitch( cfcore::ICFGenKbGelSwitchEditObj* Obj ) = 0;

		virtual cfcore::ICFGenKbGelSwitchObj* readGelSwitch( cfcore::CFGenKbGelInstructionPKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbGelSwitchObj* lockGelSwitch( cfcore::CFGenKbGelInstructionPKey* pkey ) = 0;

		virtual std::vector<cfcore::ICFGenKbGelSwitchObj*> readAllGelSwitch( bool forceRead = false ) = 0;
		...
		virtual cfcore::ICFGenKbGelSwitchObj* readCachedGelSwitch( cfcore::CFGenKbGelInstructionPKey* pkey ) = 0;

		virtual cfcore::ICFGenKbGelSwitchObj* readCachedGelSwitchByPIdx(const int64_t TenantId,
			const int64_t GelCacheId,
			const int64_t GelInstId ) = 0;

		virtual std::vector<cfcore::ICFGenKbGelSwitchObj*> readCachedGelSwitchByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfcore::ICFGenKbGelSwitchObj* updateGelSwitch( cfcore::ICFGenKbGelSwitchEditObj* Obj ) = 0;

		virtual void deleteGelSwitch( cfcore::ICFGenKbGelSwitchEditObj* Obj ) = 0;

		virtual void deleteGelSwitchByPIdx( const int64_t TenantId,
			const int64_t GelCacheId,
			const int64_t GelInstId ) = 0;

		virtual void deleteGelSwitchByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesGelSwitch( cfcore::ICFGenKbGelSwitchObj* Obj ) = 0;
