...
// Description: C++18 base object instance specification for CFGenKb SecSession.
...
namespace cfcore {
	...
	class CFGenKbSecSessionObj
	: public virtual ICFGenKbSecSessionObj
	{
	protected:
		bool isNew;
		cfcore::ICFGenKbSecSessionEditObj* edit;
	...
	public:
		...
		CFGenKbSecSessionObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbSecSessionObj();
		...
		virtual cfcore::ICFGenKbSecSessionObj* realize();
		...
		virtual cfcore::ICFGenKbSecSessionEditObj* beginEdit();
