...
namespace cfcore {
	...
	class CFGenKbGelPrefixLineTableObj
	: public virtual ICFGenKbGelPrefixLineTableObj
	{
	protected:
		cfcore::ICFGenKbSchemaObj* schema;
		std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelPrefixLineObj*>* members;
		std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelPrefixLineObj*>* allGelPrefixLine;
		std::map< cfcore::CFGenKbGelInstructionByTenantIdxKey,
			std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelPrefixLineObj*>*>* indexByTenantIdx;
		std::map< cfcore::CFGenKbGelInstructionByGelCacheIdxKey,
			std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelPrefixLineObj*>*>* indexByGelCacheIdx;
		std::map< cfcore::CFGenKbGelInstructionByChainIdxKey,
			std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelPrefixLineObj*>*>* indexByChainIdx;
		std::map< cfcore::CFGenKbGelPrefixLineByRemainderIdxKey,
			std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelPrefixLineObj*>*>* indexByRemainderIdx;
	...
	public:
		...
		CFGenKbGelPrefixLineTableObj();
		CFGenKbGelPrefixLineTableObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual ~CFGenKbGelPrefixLineTableObj();
		...
		virtual cfcore::ICFGenKbGelPrefixLineObj* newInstance();

		virtual cfcore::ICFGenKbGelPrefixLineEditObj* newEditInstance( cfcore::ICFGenKbGelPrefixLineObj* orig );

		virtual cfcore::ICFGenKbGelPrefixLineObj* realizeGelPrefixLine( cfcore::ICFGenKbGelPrefixLineObj* Obj );
		...
		virtual void reallyDeepDisposeGelPrefixLine( cfcore::ICFGenKbGelPrefixLineObj* Obj );
		...
		virtual cfcore::ICFGenKbGelPrefixLineObj* createGelPrefixLine( cfcore::ICFGenKbGelPrefixLineEditObj* Obj );

		virtual cfcore::ICFGenKbGelPrefixLineObj* readGelPrefixLine( cfcore::CFGenKbGelInstructionPKey* pkey, bool forceRead = false );

		virtual cfcore::ICFGenKbGelPrefixLineObj* lockGelPrefixLine( cfcore::CFGenKbGelInstructionPKey* pkey );

		virtual std::vector<cfcore::ICFGenKbGelPrefixLineObj*> readAllGelPrefixLine( bool forceRead = false );
		...
		virtual cfcore::ICFGenKbGelPrefixLineObj* readCachedGelPrefixLine( cfcore::CFGenKbGelInstructionPKey* pkey );

		virtual cfcore::ICFGenKbGelPrefixLineObj* readCachedGelPrefixLineByPIdx( const int64_t TenantId,
			const int64_t GelCacheId,
			const int64_t GelInstId );

		virtual std::vector<cfcore::ICFGenKbGelPrefixLineObj*> readCachedGelPrefixLineByTenantIdx( const int64_t TenantId );
		...
		virtual cfcore::ICFGenKbGelPrefixLineObj* updateGelPrefixLine( cfcore::ICFGenKbGelPrefixLineEditObj* Obj );

		virtual void deleteGelPrefixLine( cfcore::ICFGenKbGelPrefixLineEditObj* Obj );

		virtual void deleteGelPrefixLineByPIdx( const int64_t TenantId,
			const int64_t GelCacheId,
			const int64_t GelInstId );

		virtual void deleteGelPrefixLineByTenantIdx( const int64_t TenantId );
		...
		virtual void reallyDetachFromIndexesGelPrefixLine( cfcore::ICFGenKbGelPrefixLineObj* Obj );
