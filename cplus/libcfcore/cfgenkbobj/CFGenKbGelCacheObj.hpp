...
// Description: C++18 base object instance specification for CFGenKb GelCache.
...
namespace cfcore {
	...
	class CFGenKbGelCacheObj
	: public virtual ICFGenKbGelCacheObj
	{
	protected:
		bool isNew;
		cfcore::ICFGenKbGelCacheEditObj* edit;
		cfcore::ICFGenKbSchemaObj* schema;
		cfcore::CFGenKbGelCachePKey* pKey;
		cfcore::CFGenKbGelCacheBuff* buff;
		std::map<std::string,ICFGenKbGelInstructionObj*> mapMacro;
		std::map<std::string,ICFGenKbGelExecutableObj*> mapExecutable;
	public:
		...
		CFGenKbGelCacheObj();
		CFGenKbGelCacheObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGelCacheObj();
		...
		virtual cfcore::ICFGenKbGelCacheObj* realize();
		...
		virtual cfcore::ICFGenKbGelCacheEditObj* beginEdit();
		...
		CFGenKbGelCacheObj( ICFGenKbTenantObj* tenant );
