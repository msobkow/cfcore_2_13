...
// Description: C++18 Instance Edit Object interface for CFGenKb GelCall.
...
namespace cfcore {
	...
	: public virtual cfcore::ICFGenKbGelInstructionEditObj,
	  public virtual cfcore::ICFGenKbGelCallObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFGenKbGelCallEditObj();
		virtual ~ICFGenKbGelCallEditObj();
		...
		virtual cfcore::ICFGenKbGelCallObj* getOrigAsGelCall() = 0;
		...
		virtual void setOptionalParentSeqInst( cfcore::ICFGenKbGelSequenceObj* value ) = 0;

		virtual cfcore::ICFGenKbGelInstructionObj* getOptionalLookupCallInst( bool forceRead = false ) = 0;
		virtual void setOptionalLookupCallInst( cfcore::ICFGenKbGelInstructionObj* value ) = 0;

		virtual cfcore::ICFGenKbGelCallObj* getOptionalLookupPrevInst( bool forceRead = false ) = 0;
		virtual void setOptionalLookupPrevInst( cfcore::ICFGenKbGelCallObj* value ) = 0;

		virtual cfcore::ICFGenKbGelCallObj* getOptionalLookupNextInst( bool forceRead = false ) = 0;
		virtual void setOptionalLookupNextInst( cfcore::ICFGenKbGelCallObj* value ) = 0;
