...
// Description: C++18 base object instance specification for CFGenKb Tenant.
...
namespace cfcore {
	...
	class CFGenKbTenantObj
	: public virtual ICFGenKbTenantObj
	{
	protected:
		cfcore::ICFGenKbSecUserObj* createdBy = NULL;
		cfcore::ICFGenKbSecUserObj* updatedBy = NULL;
		bool isNew;
		cfcore::ICFGenKbTenantEditObj* edit;
	...
	public:
		...
		CFGenKbTenantObj();
		CFGenKbTenantObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbTenantObj();
		...
		virtual cfcore::ICFGenKbTenantObj* realize();
		...
		virtual cfcore::ICFGenKbTenantEditObj* beginEdit();
