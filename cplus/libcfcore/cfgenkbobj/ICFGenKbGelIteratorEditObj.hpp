...
// Description: C++18 Instance Edit Object interface for CFGenKb GelIterator.
...
namespace cfcore {
	...
	: public virtual cfcore::ICFGenKbGelInstructionEditObj,
	  public virtual cfcore::ICFGenKbGelIteratorObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFGenKbGelIteratorEditObj();
		virtual ~ICFGenKbGelIteratorEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfcore::CFGenKbGelIteratorBuff* getGelIteratorBuff() {
			return( static_cast<cfcore::CFGenKbGelIteratorBuff*>( getBuff() ) );
		};

		inline cfcore::CFGenKbGelIteratorBuff* getGelIteratorEditBuff() {
			return( dynamic_cast<cfcore::CFGenKbGelIteratorBuff*>( getBuff() ) );
		};

		virtual cfcore::ICFGenKbGelIteratorObj* getOrigAsGelIterator() = 0;
