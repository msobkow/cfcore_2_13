...
// Description: C++18 Object interface for CFGenKb SecDevice.
...
namespace cfcore {
	...
	public:
		...
		virtual cfcore::ICFGenKbSecDeviceObj* realize() = 0;

		virtual cfcore::ICFGenKbSecDeviceObj* read( bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbSecDeviceEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfcore::ICFGenKbSecDeviceEditObj* getEdit() = 0;

		virtual cfcore::ICFGenKbSecDeviceEditObj* getSecDeviceEdit() = 0;

		virtual cfcore::ICFGenKbSecDeviceTableObj* getSecDeviceTable() = 0;

		virtual cfcore::ICFGenKbSchemaObj* getSchema() = 0;

		virtual cfcore::CFGenKbSecDeviceBuff* getBuff() = 0;
		virtual void setBuff( cfcore::CFGenKbSecDeviceBuff* value ) = 0;
		...
		virtual cfcore::CFGenKbSecDevicePKey* getPKey() = 0;
		virtual void setPKey( cfcore::CFGenKbSecDevicePKey* value ) = 0;
