...
// Description: C++18 Object interface for CFGenKb Tool.
...
namespace cfcore {
	...
	public:
		...
		virtual cfcore::ICFGenKbToolObj* realize() = 0;

		virtual cfcore::ICFGenKbToolObj* read( bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbToolEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfcore::ICFGenKbToolEditObj* getEdit() = 0;

		virtual cfcore::ICFGenKbToolEditObj* getToolEdit() = 0;

		virtual cfcore::ICFGenKbToolTableObj* getToolTable() = 0;

		virtual cfcore::ICFGenKbSchemaObj* getSchema() = 0;

		virtual cfcore::CFGenKbToolBuff* getBuff() = 0;
		virtual void setBuff( cfcore::CFGenKbToolBuff* value ) = 0;

		inline cfcore::CFGenKbToolBuff* getToolBuff() {
			return( static_cast<cfcore::CFGenKbToolBuff*>( getBuff() ) );
		};

		inline cfcore::CFGenKbToolBuff* getToolEditBuff() {
			return( dynamic_cast<cfcore::CFGenKbToolBuff*>( getBuff() ) );
		};

		virtual cfcore::CFGenKbToolPKey* getPKey() = 0;
		virtual void setPKey( cfcore::CFGenKbToolPKey* value ) = 0;
		...
		virtual bool isOptionalReplacesIdNull() = 0;
		virtual const int16_t getOptionalReplacesIdValue() = 0;
		virtual const int16_t* getOptionalReplacesIdReference() = 0;

		virtual const bool getRequiredIsSupported() = 0;
		virtual const bool* getRequiredIsSupportedReference() = 0;

		virtual cfcore::ICFGenKbToolObj* getOptionalLookupReplaces( bool forceRead = false ) = 0;
