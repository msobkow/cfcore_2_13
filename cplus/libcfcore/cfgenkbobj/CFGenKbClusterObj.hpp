...
// Description: C++18 base object instance specification for CFGenKb Cluster.
...
namespace cfcore {
	...
	class CFGenKbClusterObj
	: public virtual ICFGenKbClusterObj
	{
	protected:
		cfcore::ICFGenKbSecUserObj* createdBy = NULL;
		cfcore::ICFGenKbSecUserObj* updatedBy = NULL;
		bool isNew;
		cfcore::ICFGenKbClusterEditObj* edit;
	...
	public:
		...
		CFGenKbClusterObj();
		CFGenKbClusterObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbClusterObj();
		...
		virtual cfcore::ICFGenKbClusterObj* realize();
		...
		virtual cfcore::ICFGenKbClusterEditObj* beginEdit();
