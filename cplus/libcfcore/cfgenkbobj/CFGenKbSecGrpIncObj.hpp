...
// Description: C++18 base object instance specification for CFGenKb SecGrpInc.
...
namespace cfcore {
	...
	class CFGenKbSecGrpIncObj
	: public virtual ICFGenKbSecGrpIncObj
	{
	protected:
		cfcore::ICFGenKbSecUserObj* createdBy = NULL;
		cfcore::ICFGenKbSecUserObj* updatedBy = NULL;
		bool isNew;
		cfcore::ICFGenKbSecGrpIncEditObj* edit;
	...
	public:
		...
		CFGenKbSecGrpIncObj();
		CFGenKbSecGrpIncObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbSecGrpIncObj();
		...
		virtual cfcore::ICFGenKbSecGrpIncObj* realize();
		...
		virtual cfcore::ICFGenKbSecGrpIncEditObj* beginEdit();
