...
// Description: C++18 base object instance specification for CFGenKb GenReference.
...
namespace cfcore {
	...
	class CFGenKbGenReferenceObj
	: public CFGenKbGenItemObj,
	  public virtual ICFGenKbGenReferenceObj
	{
	protected:
	public:
		...
		CFGenKbGenReferenceObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGenReferenceObj();
