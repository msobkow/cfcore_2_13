...
// Description: C++18 base object instance specification for CFGenKb GelConstrain.
...
namespace cfcore {
	...
	class CFGenKbGelConstrainObj
	: public CFGenKbGelInstructionObj,
	  public virtual ICFGenKbGelConstrainObj
	{
	protected:
	public:
		...
		CFGenKbGelConstrainObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGelConstrainObj();
