...
// Description: C++18 base object instance specification for CFGenKb SysCluster.
...
namespace cfcore {
	...
	class CFGenKbSysClusterObj
	: public virtual ICFGenKbSysClusterObj
	{
	protected:
		bool isNew;
		cfcore::ICFGenKbSysClusterEditObj* edit;
	...
	public:
		...
		CFGenKbSysClusterObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbSysClusterObj();
		...
		virtual cfcore::ICFGenKbSysClusterObj* realize();
		...
		virtual cfcore::ICFGenKbSysClusterEditObj* beginEdit();
