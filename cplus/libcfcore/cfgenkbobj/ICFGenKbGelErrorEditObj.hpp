...
// Description: C++18 Instance Edit Object interface for CFGenKb GelError.
...
namespace cfcore {
	...
	class ICFGenKbGelErrorEditObj
	: public virtual cfcore::ICFGenKbGelBoilerplateEditObj,
	  public virtual cfcore::ICFGenKbGelErrorObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFGenKbGelErrorEditObj();
		virtual ~ICFGenKbGelErrorEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfcore::CFGenKbGelErrorBuff* getGelErrorBuff() {
			return( static_cast<cfcore::CFGenKbGelErrorBuff*>( getBuff() ) );
		};

		inline cfcore::CFGenKbGelErrorBuff* getGelErrorEditBuff() {
			return( dynamic_cast<cfcore::CFGenKbGelErrorBuff*>( getBuff() ) );
		};

		virtual cfcore::ICFGenKbGelErrorObj* getOrigAsGelError() = 0;
