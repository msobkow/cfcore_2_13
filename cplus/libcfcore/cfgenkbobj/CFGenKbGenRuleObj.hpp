...
// Description: C++18 base object instance specification for CFGenKb GenRule.
...
namespace cfcore {
	...
	class CFGenKbGenRuleObj
	: public CFGenKbGenItemObj,
	  public virtual ICFGenKbGenRuleObj
	{
	protected:
	public:
		...
		CFGenKbGenRuleObj();
		CFGenKbGenRuleObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGenRuleObj();
		...
		static ICFGenKbGelExecutableObj* getBodyBin( MssCFGelCompiler* gelCompiler, ICFGenKbGenRuleObj* genRule );	};
}
