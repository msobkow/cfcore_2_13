...
// Description: C++18 Instance Edit Object interface for CFGenKb SecUser.
...
namespace cfcore {
	...
	class ICFGenKbSecUserEditObj
	: public virtual cfcore::ICFGenKbSecUserObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFGenKbSecUserEditObj();
		virtual ~ICFGenKbSecUserEditObj();
		...
		virtual cfcore::ICFGenKbSecUserObj* getOrig() = 0;

		virtual cfcore::ICFGenKbSecUserObj* getOrigAsSecUser() = 0;
		...
		virtual cfcore::ICFGenKbSecUserObj* create() = 0;

		virtual cfcore::ICFGenKbSecUserEditObj* update() = 0;

		virtual cfcore::ICFGenKbSecUserEditObj* deleteInstance() = 0;
		...
		virtual void setOptionalLookupDefDev( cfcore::ICFGenKbSecDeviceObj* value ) = 0;
