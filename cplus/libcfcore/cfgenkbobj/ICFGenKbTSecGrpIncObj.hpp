...
// Description: C++18 Object interface for CFGenKb TSecGrpInc.
...
namespace cfcore {
	...
	public:
		...
		virtual cfcore::ICFGenKbTSecGrpIncObj* realize() = 0;

		virtual cfcore::ICFGenKbTSecGrpIncObj* read( bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbTSecGrpIncEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfcore::ICFGenKbTSecGrpIncEditObj* getEdit() = 0;

		virtual cfcore::ICFGenKbTSecGrpIncEditObj* getTSecGrpIncEdit() = 0;

		virtual cfcore::ICFGenKbTSecGrpIncTableObj* getTSecGrpIncTable() = 0;

		virtual cfcore::ICFGenKbSchemaObj* getSchema() = 0;

		virtual cfcore::CFGenKbTSecGrpIncBuff* getBuff() = 0;
		virtual void setBuff( cfcore::CFGenKbTSecGrpIncBuff* value ) = 0;
		...
		virtual cfcore::CFGenKbTSecGrpIncPKey* getPKey() = 0;
		virtual void setPKey( cfcore::CFGenKbTSecGrpIncPKey* value ) = 0;
		...
		virtual const int64_t getRequiredTSecGrpIncId() = 0;
		virtual const int64_t* getRequiredTSecGrpIncIdReference() = 0;
