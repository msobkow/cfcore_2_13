...
namespace cfcore {
	...
	{
	public:
		ICFGenKbSecFormTableObj();
		virtual ~ICFGenKbSecFormTableObj();
		...
		virtual cfcore::ICFGenKbSecFormObj* newInstance() = 0;

		virtual cfcore::ICFGenKbSecFormEditObj* newEditInstance( cfcore::ICFGenKbSecFormObj* orig ) = 0;

		virtual cfcore::ICFGenKbSecFormObj* realizeSecForm( cfcore::ICFGenKbSecFormObj* Obj ) = 0;
		...
		virtual void reallyDeepDisposeSecForm( cfcore::ICFGenKbSecFormObj* Obj ) = 0;
		virtual cfcore::ICFGenKbSecFormObj* createSecForm( cfcore::ICFGenKbSecFormEditObj* Obj ) = 0;

		virtual cfcore::ICFGenKbSecFormObj* readSecForm( cfcore::CFGenKbSecFormPKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbSecFormObj* lockSecForm( cfcore::CFGenKbSecFormPKey* pkey ) = 0;

		virtual std::vector<cfcore::ICFGenKbSecFormObj*> readAllSecForm( bool forceRead = false ) = 0;
		...
		virtual cfcore::ICFGenKbSecFormObj* readCachedSecForm( cfcore::CFGenKbSecFormPKey* pkey ) = 0;

		virtual cfcore::ICFGenKbSecFormObj* readCachedSecFormByIdIdx(const int64_t ClusterId,
			const int32_t SecFormId ) = 0;

		virtual std::vector<cfcore::ICFGenKbSecFormObj*> readCachedSecFormByClusterIdx( const int64_t ClusterId ) = 0;
		...
		virtual cfcore::ICFGenKbSecFormObj* updateSecForm( cfcore::ICFGenKbSecFormEditObj* Obj ) = 0;

		virtual void deleteSecForm( cfcore::ICFGenKbSecFormEditObj* Obj ) = 0;
		...
		virtual void reallyDetachFromIndexesSecForm( cfcore::ICFGenKbSecFormObj* Obj ) = 0;
