...
// Description: C++18 Instance Edit Object interface for CFGenKb GelBuiltin.
...
namespace cfcore {
	...
	: public virtual cfcore::ICFGenKbGelInstructionEditObj,
	  public virtual cfcore::ICFGenKbGelBuiltinObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFGenKbGelBuiltinEditObj();
		virtual ~ICFGenKbGelBuiltinEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfcore::CFGenKbGelBuiltinBuff* getGelBuiltinBuff() {
			return( static_cast<cfcore::CFGenKbGelBuiltinBuff*>( getBuff() ) );
		};

		inline cfcore::CFGenKbGelBuiltinBuff* getGelBuiltinEditBuff() {
			return( dynamic_cast<cfcore::CFGenKbGelBuiltinBuff*>( getBuff() ) );
		};

		virtual cfcore::ICFGenKbGelBuiltinObj* getOrigAsGelBuiltin() = 0;
