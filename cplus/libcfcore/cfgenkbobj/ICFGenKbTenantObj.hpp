...
// Description: C++18 Object interface for CFGenKb Tenant.
...
namespace cfcore {
	...
	public:
		...
		virtual cfcore::ICFGenKbTenantObj* realize() = 0;

		virtual cfcore::ICFGenKbTenantObj* read( bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbTenantEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfcore::ICFGenKbTenantEditObj* getEdit() = 0;

		virtual cfcore::ICFGenKbTenantEditObj* getTenantEdit() = 0;

		virtual cfcore::ICFGenKbTenantTableObj* getTenantTable() = 0;

		virtual cfcore::ICFGenKbSchemaObj* getSchema() = 0;

		virtual cfcore::CFGenKbTenantBuff* getBuff() = 0;
		virtual void setBuff( cfcore::CFGenKbTenantBuff* value ) = 0;

		inline cfcore::CFGenKbTenantBuff* getTenantBuff() {
			return( static_cast<cfcore::CFGenKbTenantBuff*>( getBuff() ) );
		};

		inline cfcore::CFGenKbTenantBuff* getTenantEditBuff() {
			return( dynamic_cast<cfcore::CFGenKbTenantBuff*>( getBuff() ) );
		};

		virtual cfcore::CFGenKbTenantPKey* getPKey() = 0;
		virtual void setPKey( cfcore::CFGenKbTenantPKey* value ) = 0;
		...
		virtual const std::string& getRequiredTenantName() = 0;
		virtual const std::string* getRequiredTenantNameReference() = 0;

		virtual cfcore::ICFGenKbClusterObj* getRequiredContainerCluster( bool forceRead = false ) = 0;

		virtual std::vector<cfcore::ICFGenKbTSecGroupObj*> getOptionalComponentsTSecGroup( bool forceRead = false ) = 0;

		virtual std::vector<cfcore::ICFGenKbRuleCartObj*> getOptionalComponentsRuleCart( bool forceRead = false ) = 0;
