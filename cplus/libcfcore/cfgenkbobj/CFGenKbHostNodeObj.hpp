...
// Description: C++18 base object instance specification for CFGenKb HostNode.
...
namespace cfcore {
	...
	class CFGenKbHostNodeObj
	: public virtual ICFGenKbHostNodeObj
	{
	protected:
		cfcore::ICFGenKbSecUserObj* createdBy = NULL;
		cfcore::ICFGenKbSecUserObj* updatedBy = NULL;
		bool isNew;
		cfcore::ICFGenKbHostNodeEditObj* edit;
	...
	public:
		...
		CFGenKbHostNodeObj();
		CFGenKbHostNodeObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbHostNodeObj();
		...
		virtual cfcore::ICFGenKbHostNodeObj* realize();
		...
		virtual cfcore::ICFGenKbHostNodeEditObj* beginEdit();
