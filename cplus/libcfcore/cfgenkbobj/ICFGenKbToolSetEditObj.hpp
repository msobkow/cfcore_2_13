...
// Description: C++18 Instance Edit Object interface for CFGenKb ToolSet.
...
namespace cfcore {
	...
	class ICFGenKbToolSetEditObj
	: public virtual cfcore::ICFGenKbToolSetObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFGenKbToolSetEditObj();
		virtual ~ICFGenKbToolSetEditObj();
		...
		virtual cfcore::ICFGenKbToolSetObj* getOrig() = 0;

		virtual cfcore::ICFGenKbToolSetObj* getOrigAsToolSet() = 0;
		...
		virtual cfcore::ICFGenKbToolSetObj* create() = 0;

		virtual cfcore::ICFGenKbToolSetEditObj* update() = 0;

		virtual cfcore::ICFGenKbToolSetEditObj* deleteInstance() = 0;
		...
		virtual void setOptionalDescrNull() = 0;
		virtual void setOptionalDescrValue( const std::string& value ) = 0;
