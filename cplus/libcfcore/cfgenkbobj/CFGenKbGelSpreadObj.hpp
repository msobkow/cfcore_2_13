...
// Description: C++18 base object instance specification for CFGenKb GelSpread.
...
namespace cfcore {
	...
	class CFGenKbGelSpreadObj
	: public CFGenKbGelInstructionObj,
	  public virtual ICFGenKbGelSpreadObj
	{
	protected:
	public:
		...
		CFGenKbGelSpreadObj();
		CFGenKbGelSpreadObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGelSpreadObj();
