...
// Description: C++18 Instance Edit Object interface for CFGenKb GelExpansion.
...
namespace cfcore {
	...
	: public virtual cfcore::ICFGenKbGelInstructionEditObj,
	  public virtual cfcore::ICFGenKbGelExpansionObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFGenKbGelExpansionEditObj();
		virtual ~ICFGenKbGelExpansionEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfcore::CFGenKbGelExpansionBuff* getGelExpansionBuff() {
			return( static_cast<cfcore::CFGenKbGelExpansionBuff*>( getBuff() ) );
		};

		inline cfcore::CFGenKbGelExpansionBuff* getGelExpansionEditBuff() {
			return( dynamic_cast<cfcore::CFGenKbGelExpansionBuff*>( getBuff() ) );
		};

		virtual cfcore::ICFGenKbGelExpansionObj* getOrigAsGelExpansion() = 0;

		virtual cfcore::ICFGenKbGelInstructionEditObj* beginEdit() = 0;

		virtual const std::string& getRequiredMacroName() = 0;
		virtual const std::string* getRequiredMacroNameReference() = 0;
		virtual void setRequiredMacroName( const std::string& value ) = 0;
