...
// Description: C++18 Object interface for CFGenKb GelCache.
...
namespace cfcore {
	...
	public:
		...
		virtual cfcore::ICFGenKbGelCacheObj* realize() = 0;

		virtual cfcore::ICFGenKbGelCacheObj* read( bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbGelCacheEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfcore::ICFGenKbGelCacheEditObj* getEdit() = 0;

		virtual cfcore::ICFGenKbGelCacheEditObj* getGelCacheEdit() = 0;

		virtual cfcore::ICFGenKbGelCacheTableObj* getGelCacheTable() = 0;

		virtual cfcore::ICFGenKbSchemaObj* getSchema() = 0;

		virtual cfcore::CFGenKbGelCacheBuff* getBuff() = 0;
		virtual void setBuff( cfcore::CFGenKbGelCacheBuff* value ) = 0;

		inline cfcore::CFGenKbGelCacheBuff* getGelCacheBuff() {
			return( static_cast<cfcore::CFGenKbGelCacheBuff*>( getBuff() ) );
		};

		inline cfcore::CFGenKbGelCacheBuff* getGelCacheEditBuff() {
			return( dynamic_cast<cfcore::CFGenKbGelCacheBuff*>( getBuff() ) );
		};

		virtual cfcore::CFGenKbGelCachePKey* getPKey() = 0;
		virtual void setPKey( cfcore::CFGenKbGelCachePKey* value ) = 0;
		...
		virtual const std::string& getRequiredCacheName() = 0;
		virtual const std::string* getRequiredCacheNameReference() = 0;
		...
		virtual ICFGenKbGelInstructionObj* lookupMacro( const std::string& macroBody ) = 0;
		virtual ICFGenKbGelInstructionObj* rememberMacro( const std::string& macroBody, ICFGenKbGelInstructionObj* gel ) = 0;
		virtual ICFGenKbGelExecutableObj* lookupExecutable( const std::string& macroBody ) = 0;
		virtual ICFGenKbGelExecutableObj* rememberExecutable( const std::string& macroBody, ICFGenKbGelExecutableObj* gel ) = 0;
	};
}
