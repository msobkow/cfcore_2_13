...
// Description: C++18 Object interface for CFGenKb SecGrpMemb.
...
namespace cfcore {
	...
	public:
		...
		virtual cfcore::ICFGenKbSecGrpMembObj* realize() = 0;

		virtual cfcore::ICFGenKbSecGrpMembObj* read( bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbSecGrpMembEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfcore::ICFGenKbSecGrpMembEditObj* getEdit() = 0;

		virtual cfcore::ICFGenKbSecGrpMembEditObj* getSecGrpMembEdit() = 0;

		virtual cfcore::ICFGenKbSecGrpMembTableObj* getSecGrpMembTable() = 0;

		virtual cfcore::ICFGenKbSchemaObj* getSchema() = 0;

		virtual cfcore::CFGenKbSecGrpMembBuff* getBuff() = 0;
		virtual void setBuff( cfcore::CFGenKbSecGrpMembBuff* value ) = 0;
		...
		virtual cfcore::CFGenKbSecGrpMembPKey* getPKey() = 0;
		virtual void setPKey( cfcore::CFGenKbSecGrpMembPKey* value ) = 0;
		...
		virtual const int64_t getRequiredSecGrpMembId() = 0;
		virtual const int64_t* getRequiredSecGrpMembIdReference() = 0;
