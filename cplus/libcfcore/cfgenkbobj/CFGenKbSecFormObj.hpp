...
// Description: C++18 base object instance specification for CFGenKb SecForm.
...
namespace cfcore {
	...
	class CFGenKbSecFormObj
	: public virtual ICFGenKbSecFormObj
	{
	protected:
		cfcore::ICFGenKbSecUserObj* createdBy = NULL;
		cfcore::ICFGenKbSecUserObj* updatedBy = NULL;
		bool isNew;
		cfcore::ICFGenKbSecFormEditObj* edit;
	...
	public:
		...
		CFGenKbSecFormObj();
		CFGenKbSecFormObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbSecFormObj();
		...
		virtual cfcore::ICFGenKbSecFormObj* realize();
		...
		virtual cfcore::ICFGenKbSecFormEditObj* beginEdit();
