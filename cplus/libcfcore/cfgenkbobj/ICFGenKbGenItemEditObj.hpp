...
// Description: C++18 Instance Edit Object interface for CFGenKb GenItem.
...
namespace cfcore {
	...
	class ICFGenKbGenItemEditObj
	: public virtual cfcore::ICFGenKbGenItemObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFGenKbGenItemEditObj();
		virtual ~ICFGenKbGenItemEditObj();
		...
		virtual cfcore::ICFGenKbGenItemObj* getOrig() = 0;

		virtual cfcore::ICFGenKbGenItemObj* getOrigAsGenItem() = 0;
		...
		virtual cfcore::ICFGenKbGenItemObj* create() = 0;

		virtual cfcore::ICFGenKbGenItemEditObj* update() = 0;

		virtual cfcore::ICFGenKbGenItemEditObj* deleteInstance() = 0;
		...
		virtual void setOptionalGelExecutableTenantIdNull() = 0;
		virtual void setOptionalGelExecutableTenantIdValue( const int64_t value ) = 0;
		...
		virtual void setOptionalGelExecutableGelCacheIdNull() = 0;
		virtual void setOptionalGelExecutableGelCacheIdValue( const int64_t value ) = 0;
		...
		virtual void setOptionalGelExecutableIdNull() = 0;
		virtual void setOptionalGelExecutableIdValue( const int64_t value ) = 0;

		virtual cfcore::ICFGenKbTenantObj* getRequiredOwnerTenant( bool forceRead = false ) = 0;
		virtual void setRequiredOwnerTenant( cfcore::ICFGenKbTenantObj* value ) = 0;

		virtual cfcore::ICFGenKbRuleCartObj* getRequiredContainerCartridge( bool forceRead = false ) = 0;
		virtual void setRequiredContainerCartridge( cfcore::ICFGenKbRuleCartObj* value ) = 0;

		virtual cfcore::ICFGenKbRuleTypeObj* getRequiredLookupRuleType( bool forceRead = false ) = 0;
		virtual void setRequiredLookupRuleType( cfcore::ICFGenKbRuleTypeObj* value ) = 0;

		virtual cfcore::ICFGenKbToolSetObj* getRequiredLookupToolSet( bool forceRead = false ) = 0;
		virtual void setRequiredLookupToolSet( cfcore::ICFGenKbToolSetObj* value ) = 0;

		virtual cfcore::ICFGenKbDefClassObj* getOptionalLookupScopeDef( bool forceRead = false ) = 0;
		virtual void setOptionalLookupScopeDef( cfcore::ICFGenKbDefClassObj* value ) = 0;

		virtual cfcore::ICFGenKbDefClassObj* getRequiredLookupGenDef( bool forceRead = false ) = 0;
		virtual void setRequiredLookupGenDef( cfcore::ICFGenKbDefClassObj* value ) = 0;

		virtual cfcore::ICFGenKbGelExecutableObj* getOptionalComponentsGelExec( bool forceRead = false ) = 0;
		virtual void setOptionalComponentsGelExec( cfcore::ICFGenKbGelExecutableObj* value ) = 0;

		virtual cfcore::ICFGenKbGenItemObj* getOptionalLookupProbe( bool forceRead = false ) = 0;
		virtual void setOptionalLookupProbe( cfcore::ICFGenKbGenItemObj* value ) = 0;
