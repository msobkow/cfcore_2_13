...
// Description: C++18 Object interface for CFGenKb SecGrpInc.
...
namespace cfcore {
	...
	public:
		...
		virtual cfcore::ICFGenKbSecGrpIncObj* realize() = 0;

		virtual cfcore::ICFGenKbSecGrpIncObj* read( bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbSecGrpIncEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfcore::ICFGenKbSecGrpIncEditObj* getEdit() = 0;

		virtual cfcore::ICFGenKbSecGrpIncEditObj* getSecGrpIncEdit() = 0;

		virtual cfcore::ICFGenKbSecGrpIncTableObj* getSecGrpIncTable() = 0;

		virtual cfcore::ICFGenKbSchemaObj* getSchema() = 0;

		virtual cfcore::CFGenKbSecGrpIncBuff* getBuff() = 0;
		virtual void setBuff( cfcore::CFGenKbSecGrpIncBuff* value ) = 0;
		...
		virtual cfcore::CFGenKbSecGrpIncPKey* getPKey() = 0;
		virtual void setPKey( cfcore::CFGenKbSecGrpIncPKey* value ) = 0;
