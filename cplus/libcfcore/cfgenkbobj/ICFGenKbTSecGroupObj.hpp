...
// Description: C++18 Object interface for CFGenKb TSecGroup.
...
namespace cfcore {
	...
	public:
		...
		virtual cfcore::ICFGenKbTSecGroupObj* realize() = 0;

		virtual cfcore::ICFGenKbTSecGroupObj* read( bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbTSecGroupEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfcore::ICFGenKbTSecGroupEditObj* getEdit() = 0;

		virtual cfcore::ICFGenKbTSecGroupEditObj* getTSecGroupEdit() = 0;

		virtual cfcore::ICFGenKbTSecGroupTableObj* getTSecGroupTable() = 0;

		virtual cfcore::ICFGenKbSchemaObj* getSchema() = 0;

		virtual cfcore::CFGenKbTSecGroupBuff* getBuff() = 0;
		virtual void setBuff( cfcore::CFGenKbTSecGroupBuff* value ) = 0;

		inline cfcore::CFGenKbTSecGroupBuff* getTSecGroupBuff() {
			return( static_cast<cfcore::CFGenKbTSecGroupBuff*>( getBuff() ) );
		};

		inline cfcore::CFGenKbTSecGroupBuff* getTSecGroupEditBuff() {
			return( dynamic_cast<cfcore::CFGenKbTSecGroupBuff*>( getBuff() ) );
		};

		virtual cfcore::CFGenKbTSecGroupPKey* getPKey() = 0;
		virtual void setPKey( cfcore::CFGenKbTSecGroupPKey* value ) = 0;
		...
		virtual cfcore::ICFGenKbTenantObj* getRequiredContainerTenant( bool forceRead = false ) = 0;

		virtual std::vector<cfcore::ICFGenKbTSecGrpIncObj*> getOptionalComponentsInclude( bool forceRead = false ) = 0;

		virtual std::vector<cfcore::ICFGenKbTSecGrpMembObj*> getOptionalComponentsMember( bool forceRead = false ) = 0;

		virtual std::vector<cfcore::ICFGenKbTSecGrpIncObj*> getRequiredChildrenIncByGroup( bool forceRead = false ) = 0;
