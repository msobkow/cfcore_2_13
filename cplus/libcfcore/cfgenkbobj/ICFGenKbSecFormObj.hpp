...
// Description: C++18 Object interface for CFGenKb SecForm.
...
namespace cfcore {
	...
	public:
		...
		virtual cfcore::ICFGenKbSecFormObj* realize() = 0;

		virtual cfcore::ICFGenKbSecFormObj* read( bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbSecFormEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfcore::ICFGenKbSecFormEditObj* getEdit() = 0;

		virtual cfcore::ICFGenKbSecFormEditObj* getSecFormEdit() = 0;

		virtual cfcore::ICFGenKbSecFormTableObj* getSecFormTable() = 0;

		virtual cfcore::ICFGenKbSchemaObj* getSchema() = 0;

		virtual cfcore::CFGenKbSecFormBuff* getBuff() = 0;
		virtual void setBuff( cfcore::CFGenKbSecFormBuff* value ) = 0;
		...
		virtual cfcore::CFGenKbSecFormPKey* getPKey() = 0;
		virtual void setPKey( cfcore::CFGenKbSecFormPKey* value ) = 0;
