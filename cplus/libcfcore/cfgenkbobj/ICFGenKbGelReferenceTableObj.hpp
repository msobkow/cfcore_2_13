...
namespace cfcore {
	...
	{
	public:
		ICFGenKbGelReferenceTableObj();
		virtual ~ICFGenKbGelReferenceTableObj();
		...
		virtual cfcore::ICFGenKbGelReferenceObj* newInstance() = 0;

		virtual cfcore::ICFGenKbGelReferenceEditObj* newEditInstance( cfcore::ICFGenKbGelReferenceObj* orig ) = 0;

		virtual cfcore::ICFGenKbGelReferenceObj* realizeGelReference( cfcore::ICFGenKbGelReferenceObj* Obj ) = 0;
		...
		virtual void reallyDeepDisposeGelReference( cfcore::ICFGenKbGelReferenceObj* Obj ) = 0;
		...
		virtual cfcore::ICFGenKbGelReferenceObj* createGelReference( cfcore::ICFGenKbGelReferenceEditObj* Obj ) = 0;

		virtual cfcore::ICFGenKbGelReferenceObj* readGelReference( cfcore::CFGenKbGelInstructionPKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbGelReferenceObj* lockGelReference( cfcore::CFGenKbGelInstructionPKey* pkey ) = 0;

		virtual std::vector<cfcore::ICFGenKbGelReferenceObj*> readAllGelReference( bool forceRead = false ) = 0;
		...
		virtual cfcore::ICFGenKbGelReferenceObj* readCachedGelReference( cfcore::CFGenKbGelInstructionPKey* pkey ) = 0;

		virtual cfcore::ICFGenKbGelReferenceObj* readCachedGelReferenceByPIdx(const int64_t TenantId,
			const int64_t GelCacheId,
			const int64_t GelInstId ) = 0;

		virtual std::vector<cfcore::ICFGenKbGelReferenceObj*> readCachedGelReferenceByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfcore::ICFGenKbGelReferenceObj* updateGelReference( cfcore::ICFGenKbGelReferenceEditObj* Obj ) = 0;

		virtual void deleteGelReference( cfcore::ICFGenKbGelReferenceEditObj* Obj ) = 0;

		virtual void deleteGelReferenceByPIdx( const int64_t TenantId,
			const int64_t GelCacheId,
			const int64_t GelInstId ) = 0;

		virtual void deleteGelReferenceByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesGelReference( cfcore::ICFGenKbGelReferenceObj* Obj ) = 0;
