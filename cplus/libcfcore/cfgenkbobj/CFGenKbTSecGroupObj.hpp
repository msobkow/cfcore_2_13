...
// Description: C++18 base object instance specification for CFGenKb TSecGroup.
...
namespace cfcore {
	...
	class CFGenKbTSecGroupObj
	: public virtual ICFGenKbTSecGroupObj
	{
	protected:
		cfcore::ICFGenKbSecUserObj* createdBy = NULL;
		cfcore::ICFGenKbSecUserObj* updatedBy = NULL;
		bool isNew;
		cfcore::ICFGenKbTSecGroupEditObj* edit;
	...
	public:
		...
		CFGenKbTSecGroupObj();
		CFGenKbTSecGroupObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbTSecGroupObj();
		...
		virtual cfcore::ICFGenKbTSecGroupObj* realize();
		...
		virtual cfcore::ICFGenKbTSecGroupEditObj* beginEdit();
