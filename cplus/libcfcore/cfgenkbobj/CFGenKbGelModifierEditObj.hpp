...
// Description: C++18 edit object instance specification for CFGenKb GelModifier.
...
namespace cfcore {
	...
	class CFGenKbGelModifierEditObj
	: public CFGenKbGelInstructionEditObj,
	  public virtual ICFGenKbGelModifierEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFGenKbGelModifierEditObj( cfcore::ICFGenKbGelModifierObj* argOrig );
		virtual ~CFGenKbGelModifierEditObj();
		...
		virtual cfcore::ICFGenKbGelModifierTableObj* getGelModifierTable();

		virtual cfcore::ICFGenKbGelModifierEditObj* getGelModifierEdit();

		virtual ICFGenKbGelInstructionEditObj* beginEdit();

		virtual cfcore::ICFGenKbGelModifierObj* getOrigAsGelModifier();
		...
		inline cfcore::CFGenKbGelModifierBuff* getGelModifierBuff() {
			...
			return( static_cast<cfcore::CFGenKbGelModifierBuff*>( buff ) );
		};
