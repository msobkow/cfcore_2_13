...
// Description: C++18 base object instance specification for CFGenKb SecDevice.
...
namespace cfcore {
	...
	class CFGenKbSecDeviceObj
	: public virtual ICFGenKbSecDeviceObj
	{
	protected:
		cfcore::ICFGenKbSecUserObj* createdBy = NULL;
		cfcore::ICFGenKbSecUserObj* updatedBy = NULL;
		bool isNew;
		cfcore::ICFGenKbSecDeviceEditObj* edit;
	...
	public:
		...
		CFGenKbSecDeviceObj();
		CFGenKbSecDeviceObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbSecDeviceObj();
		...
		virtual cfcore::ICFGenKbSecDeviceObj* realize();
		...
		virtual cfcore::ICFGenKbSecDeviceEditObj* beginEdit();
