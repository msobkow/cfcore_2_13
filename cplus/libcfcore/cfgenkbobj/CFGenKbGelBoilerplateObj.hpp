...
// Description: C++18 base object instance specification for CFGenKb GelBoilerplate.
...
namespace cfcore {
	...
	class CFGenKbGelBoilerplateObj
	: public CFGenKbGelInstructionObj,
	  public virtual ICFGenKbGelBoilerplateObj
	{
	protected:
	public:
		...
		CFGenKbGelBoilerplateObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGelBoilerplateObj();
