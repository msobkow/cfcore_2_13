...
// Description: C++18 base object instance specification for CFGenKb SecApp.
...
namespace cfcore {
	...
	class CFGenKbSecAppObj
	: public virtual ICFGenKbSecAppObj
	{
	protected:
		cfcore::ICFGenKbSecUserObj* createdBy = NULL;
		cfcore::ICFGenKbSecUserObj* updatedBy = NULL;
		bool isNew;
		cfcore::ICFGenKbSecAppEditObj* edit;
	...
	public:
		...
		CFGenKbSecAppObj();
		CFGenKbSecAppObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbSecAppObj();
		...
		virtual cfcore::ICFGenKbSecAppObj* realize();
		...
		virtual cfcore::ICFGenKbSecAppEditObj* beginEdit();
