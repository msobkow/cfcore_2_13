...
namespace cfcore {
	...
	{
	public:
		ICFGenKbGelModifierTableObj();
		virtual ~ICFGenKbGelModifierTableObj();
		...
		virtual cfcore::ICFGenKbGelModifierObj* newInstance() = 0;

		virtual cfcore::ICFGenKbGelModifierEditObj* newEditInstance( cfcore::ICFGenKbGelModifierObj* orig ) = 0;

		virtual cfcore::ICFGenKbGelModifierObj* realizeGelModifier( cfcore::ICFGenKbGelModifierObj* Obj ) = 0;
		...
		virtual void reallyDeepDisposeGelModifier( cfcore::ICFGenKbGelModifierObj* Obj ) = 0;
		...
		virtual cfcore::ICFGenKbGelModifierObj* createGelModifier( cfcore::ICFGenKbGelModifierEditObj* Obj ) = 0;

		virtual cfcore::ICFGenKbGelModifierObj* readGelModifier( cfcore::CFGenKbGelInstructionPKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbGelModifierObj* lockGelModifier( cfcore::CFGenKbGelInstructionPKey* pkey ) = 0;

		virtual std::vector<cfcore::ICFGenKbGelModifierObj*> readAllGelModifier( bool forceRead = false ) = 0;
		...
		virtual cfcore::ICFGenKbGelModifierObj* readCachedGelModifier( cfcore::CFGenKbGelInstructionPKey* pkey ) = 0;

		virtual cfcore::ICFGenKbGelModifierObj* readCachedGelModifierByPIdx(const int64_t TenantId,
			const int64_t GelCacheId,
			const int64_t GelInstId ) = 0;

		virtual std::vector<cfcore::ICFGenKbGelModifierObj*> readCachedGelModifierByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfcore::ICFGenKbGelModifierObj* updateGelModifier( cfcore::ICFGenKbGelModifierEditObj* Obj ) = 0;

		virtual void deleteGelModifier( cfcore::ICFGenKbGelModifierEditObj* Obj ) = 0;

		virtual void deleteGelModifierByPIdx( const int64_t TenantId,
			const int64_t GelCacheId,
			const int64_t GelInstId ) = 0;

		virtual void deleteGelModifierByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesGelModifier( cfcore::ICFGenKbGelModifierObj* Obj ) = 0;
