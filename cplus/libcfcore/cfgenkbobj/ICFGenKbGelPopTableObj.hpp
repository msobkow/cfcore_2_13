...
namespace cfcore {
	...
	{
	public:
		ICFGenKbGelPopTableObj();
		virtual ~ICFGenKbGelPopTableObj();
		...
		virtual cfcore::ICFGenKbGelPopObj* newInstance() = 0;

		virtual cfcore::ICFGenKbGelPopEditObj* newEditInstance( cfcore::ICFGenKbGelPopObj* orig ) = 0;

		virtual cfcore::ICFGenKbGelPopObj* realizeGelPop( cfcore::ICFGenKbGelPopObj* Obj ) = 0;
		...
		virtual void reallyDeepDisposeGelPop( cfcore::ICFGenKbGelPopObj* Obj ) = 0;
		...
		virtual cfcore::ICFGenKbGelPopObj* createGelPop( cfcore::ICFGenKbGelPopEditObj* Obj ) = 0;

		virtual cfcore::ICFGenKbGelPopObj* readGelPop( cfcore::CFGenKbGelInstructionPKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbGelPopObj* lockGelPop( cfcore::CFGenKbGelInstructionPKey* pkey ) = 0;

		virtual std::vector<cfcore::ICFGenKbGelPopObj*> readAllGelPop( bool forceRead = false ) = 0;
		...
		virtual cfcore::ICFGenKbGelPopObj* readCachedGelPop( cfcore::CFGenKbGelInstructionPKey* pkey ) = 0;

		virtual cfcore::ICFGenKbGelPopObj* readCachedGelPopByPIdx(const int64_t TenantId,
			const int64_t GelCacheId,
			const int64_t GelInstId ) = 0;

		virtual std::vector<cfcore::ICFGenKbGelPopObj*> readCachedGelPopByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfcore::ICFGenKbGelPopObj* updateGelPop( cfcore::ICFGenKbGelPopEditObj* Obj ) = 0;

		virtual void deleteGelPop( cfcore::ICFGenKbGelPopEditObj* Obj ) = 0;

		virtual void deleteGelPopByPIdx( const int64_t TenantId,
			const int64_t GelCacheId,
			const int64_t GelInstId ) = 0;

		virtual void deleteGelPopByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesGelPop( cfcore::ICFGenKbGelPopObj* Obj ) = 0;
