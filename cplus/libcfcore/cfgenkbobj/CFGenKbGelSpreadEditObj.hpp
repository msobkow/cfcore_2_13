...
// Description: C++18 edit object instance specification for CFGenKb GelSpread.
...
namespace cfcore {
	...
	class CFGenKbGelSpreadEditObj
	: public CFGenKbGelInstructionEditObj,
	  public virtual ICFGenKbGelSpreadEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFGenKbGelSpreadEditObj( cfcore::ICFGenKbGelSpreadObj* argOrig );
		virtual ~CFGenKbGelSpreadEditObj();
		...
		virtual cfcore::ICFGenKbGelSpreadTableObj* getGelSpreadTable();

		virtual cfcore::ICFGenKbGelSpreadEditObj* getGelSpreadEdit();

		virtual ICFGenKbGelInstructionEditObj* beginEdit();

		virtual cfcore::ICFGenKbGelSpreadObj* getOrigAsGelSpread();
		...
		inline cfcore::CFGenKbGelSpreadBuff* getGelSpreadBuff() {
			...
			return( static_cast<cfcore::CFGenKbGelSpreadBuff*>( buff ) );
		};
		...
		virtual bool isOptionalExpandBetweenNull();
		virtual const std::string& getOptionalExpandBetweenValue();
		virtual const std::string* getOptionalExpandBetweenReference();
