...
// Description: C++18 Instance Edit Object interface for CFGenKb GenReference.
...
namespace cfcore {
	...
	: public virtual cfcore::ICFGenKbGenItemEditObj,
	  public virtual cfcore::ICFGenKbGenReferenceObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFGenKbGenReferenceEditObj();
		virtual ~ICFGenKbGenReferenceEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfcore::CFGenKbGenReferenceBuff* getGenReferenceBuff() {
			return( static_cast<cfcore::CFGenKbGenReferenceBuff*>( getBuff() ) );
		};

		inline cfcore::CFGenKbGenReferenceBuff* getGenReferenceEditBuff() {
			return( dynamic_cast<cfcore::CFGenKbGenReferenceBuff*>( getBuff() ) );
		};

		virtual cfcore::ICFGenKbGenReferenceObj* getOrigAsGenReference() = 0;
