...
// Description: C++18 base object instance specification for CFGenKb RuleCart.
...
namespace cfcore {
	...
	class CFGenKbRuleCartObj
	: public virtual ICFGenKbRuleCartObj
	{
	protected:
		bool isNew;
		cfcore::ICFGenKbRuleCartEditObj* edit;
	...
	public:
		...
		CFGenKbRuleCartObj();
		CFGenKbRuleCartObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbRuleCartObj();
		...
		virtual cfcore::ICFGenKbRuleCartObj* realize();
		...
		virtual cfcore::ICFGenKbRuleCartEditObj* beginEdit();
