...
// Description: C++18 Object interface for CFGenKb SysCluster.
...
namespace cfcore {
	...
	public:
		...
		virtual cfcore::ICFGenKbSysClusterObj* realize() = 0;

		virtual cfcore::ICFGenKbSysClusterObj* read( bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbSysClusterEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfcore::ICFGenKbSysClusterEditObj* getEdit() = 0;

		virtual cfcore::ICFGenKbSysClusterEditObj* getSysClusterEdit() = 0;

		virtual cfcore::ICFGenKbSysClusterTableObj* getSysClusterTable() = 0;

		virtual cfcore::ICFGenKbSchemaObj* getSchema() = 0;

		virtual cfcore::CFGenKbSysClusterBuff* getBuff() = 0;
		virtual void setBuff( cfcore::CFGenKbSysClusterBuff* value ) = 0;

		inline cfcore::CFGenKbSysClusterBuff* getSysClusterBuff() {
			return( static_cast<cfcore::CFGenKbSysClusterBuff*>( getBuff() ) );
		};

		inline cfcore::CFGenKbSysClusterBuff* getSysClusterEditBuff() {
			return( dynamic_cast<cfcore::CFGenKbSysClusterBuff*>( getBuff() ) );
		};

		virtual cfcore::CFGenKbSysClusterPKey* getPKey() = 0;
		virtual void setPKey( cfcore::CFGenKbSysClusterPKey* value ) = 0;
