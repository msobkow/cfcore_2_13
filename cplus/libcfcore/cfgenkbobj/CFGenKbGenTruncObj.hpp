...
// Description: C++18 base object instance specification for CFGenKb GenTrunc.
...
namespace cfcore {
	...
	class CFGenKbGenTruncObj
	: public CFGenKbGenRuleObj,
	  public virtual ICFGenKbGenTruncObj
	{
	protected:
	public:
		...
		CFGenKbGenTruncObj();
		CFGenKbGenTruncObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGenTruncObj();
