...
// Description: C++18 base object instance specification for CFGenKb GelCall.
...
namespace cfcore {
	...
	class CFGenKbGelCallObj
	: public CFGenKbGelInstructionObj,
	  public virtual ICFGenKbGelCallObj
	{
	protected:
	public:
		...
		CFGenKbGelCallObj();
		CFGenKbGelCallObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGelCallObj();
