...
// Description: C++18 base object instance specification for CFGenKb ToolSet.
...
namespace cfcore {
	...
	class CFGenKbToolSetObj
	: public virtual ICFGenKbToolSetObj
	{
	protected:
		bool isNew;
		cfcore::ICFGenKbToolSetEditObj* edit;
	...
	public:
		...
		CFGenKbToolSetObj();
		CFGenKbToolSetObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbToolSetObj();
		...
		virtual cfcore::ICFGenKbToolSetObj* realize();
		...
		virtual cfcore::ICFGenKbToolSetEditObj* beginEdit();
