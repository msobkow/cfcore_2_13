...
// Description: C++18 Object interface for CFGenKb SecApp.
...
namespace cfcore {
	...
	public:
		...
		virtual cfcore::ICFGenKbSecAppObj* realize() = 0;

		virtual cfcore::ICFGenKbSecAppObj* read( bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbSecAppEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfcore::ICFGenKbSecAppEditObj* getEdit() = 0;

		virtual cfcore::ICFGenKbSecAppEditObj* getSecAppEdit() = 0;

		virtual cfcore::ICFGenKbSecAppTableObj* getSecAppTable() = 0;

		virtual cfcore::ICFGenKbSchemaObj* getSchema() = 0;

		virtual cfcore::CFGenKbSecAppBuff* getBuff() = 0;
		virtual void setBuff( cfcore::CFGenKbSecAppBuff* value ) = 0;
		...
		virtual cfcore::CFGenKbSecAppPKey* getPKey() = 0;
		virtual void setPKey( cfcore::CFGenKbSecAppPKey* value ) = 0;
		...
		virtual std::vector<cfcore::ICFGenKbSecFormObj*> getOptionalComponentsForm( bool forceRead = false ) = 0;
