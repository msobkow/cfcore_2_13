...
// Description: C++18 base object instance specification for CFGenKb GelCounter.
...
namespace cfcore {
	...
	class CFGenKbGelCounterObj
	: public CFGenKbGelInstructionObj,
	  public virtual ICFGenKbGelCounterObj
	{
	protected:
	public:
		...
		CFGenKbGelCounterObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGelCounterObj();
