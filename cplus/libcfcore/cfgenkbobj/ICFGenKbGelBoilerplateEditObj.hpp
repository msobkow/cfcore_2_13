...
// Description: C++18 Instance Edit Object interface for CFGenKb GelBoilerplate.
...
namespace cfcore {
	...
	: public virtual cfcore::ICFGenKbGelInstructionEditObj,
	  public virtual cfcore::ICFGenKbGelBoilerplateObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFGenKbGelBoilerplateEditObj();
		virtual ~ICFGenKbGelBoilerplateEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfcore::CFGenKbGelBoilerplateBuff* getGelBoilerplateBuff() {
			return( static_cast<cfcore::CFGenKbGelBoilerplateBuff*>( getBuff() ) );
		};

		inline cfcore::CFGenKbGelBoilerplateBuff* getGelBoilerplateEditBuff() {
			return( dynamic_cast<cfcore::CFGenKbGelBoilerplateBuff*>( getBuff() ) );
		};

		virtual cfcore::ICFGenKbGelBoilerplateObj* getOrigAsGelBoilerplate() = 0;
