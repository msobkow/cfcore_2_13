...
// Description: C++18 Instance Edit Object interface for CFGenKb GelPop.
...
namespace cfcore {
	...
	: public virtual cfcore::ICFGenKbGelInstructionEditObj,
	  public virtual cfcore::ICFGenKbGelPopObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFGenKbGelPopEditObj();
		virtual ~ICFGenKbGelPopEditObj();
		...
		virtual cfcore::ICFGenKbGelPopObj* getOrigAsGelPop() = 0;
		...
		virtual void setRequiredGoalTypeName( const std::string& value ) = 0;
