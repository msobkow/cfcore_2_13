...
// Description: C++18 base object instance specification for CFGenKb SecGroup.
...
namespace cfcore {
	...
	class CFGenKbSecGroupObj
	: public virtual ICFGenKbSecGroupObj
	{
	protected:
		cfcore::ICFGenKbSecUserObj* createdBy = NULL;
		cfcore::ICFGenKbSecUserObj* updatedBy = NULL;
		bool isNew;
		cfcore::ICFGenKbSecGroupEditObj* edit;
	...
	public:
		...
		CFGenKbSecGroupObj();
		CFGenKbSecGroupObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbSecGroupObj();
		...
		virtual cfcore::ICFGenKbSecGroupObj* realize();
		...
		virtual cfcore::ICFGenKbSecGroupEditObj* beginEdit();
