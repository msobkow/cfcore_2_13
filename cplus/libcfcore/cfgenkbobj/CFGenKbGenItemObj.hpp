...
// Description: C++18 base object instance specification for CFGenKb GenItem.
...
namespace cfcore {
	...
	class CFGenKbGenItemObj
	: public virtual ICFGenKbGenItemObj
	{
	protected:
		bool isNew;
		cfcore::ICFGenKbGenItemEditObj* edit;
	...
	public:
		...
		CFGenKbGenItemObj();
		CFGenKbGenItemObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGenItemObj();
