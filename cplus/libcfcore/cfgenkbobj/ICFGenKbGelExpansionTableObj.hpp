...
namespace cfcore {
	...
	{
	public:
		ICFGenKbGelExpansionTableObj();
		virtual ~ICFGenKbGelExpansionTableObj();
		...
		virtual cfcore::ICFGenKbGelExpansionObj* newInstance() = 0;

		virtual cfcore::ICFGenKbGelExpansionEditObj* newEditInstance( cfcore::ICFGenKbGelExpansionObj* orig ) = 0;

		virtual cfcore::ICFGenKbGelExpansionObj* realizeGelExpansion( cfcore::ICFGenKbGelExpansionObj* Obj ) = 0;
		...
		virtual void reallyDeepDisposeGelExpansion( cfcore::ICFGenKbGelExpansionObj* Obj ) = 0;
		virtual cfcore::ICFGenKbGelExpansionObj* createGelExpansion( cfcore::ICFGenKbGelExpansionEditObj* Obj ) = 0;

		virtual cfcore::ICFGenKbGelExpansionObj* readGelExpansion( cfcore::CFGenKbGelInstructionPKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbGelExpansionObj* lockGelExpansion( cfcore::CFGenKbGelInstructionPKey* pkey ) = 0;

		virtual std::vector<cfcore::ICFGenKbGelExpansionObj*> readAllGelExpansion( bool forceRead = false ) = 0;
		...
		virtual cfcore::ICFGenKbGelExpansionObj* readCachedGelExpansion( cfcore::CFGenKbGelInstructionPKey* pkey ) = 0;

		virtual cfcore::ICFGenKbGelExpansionObj* readCachedGelExpansionByPIdx(const int64_t TenantId,
			const int64_t GelCacheId,
			const int64_t GelInstId ) = 0;

		virtual std::vector<cfcore::ICFGenKbGelExpansionObj*> readCachedGelExpansionByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfcore::ICFGenKbGelExpansionObj* updateGelExpansion( cfcore::ICFGenKbGelExpansionEditObj* Obj ) = 0;

		virtual void deleteGelExpansion( cfcore::ICFGenKbGelExpansionEditObj* Obj ) = 0;

		virtual void deleteGelExpansionByPIdx( const int64_t TenantId,
			const int64_t GelCacheId,
			const int64_t GelInstId ) = 0;

		virtual void deleteGelExpansionByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesGelExpansion( cfcore::ICFGenKbGelExpansionObj* Obj ) = 0;
