...
// Description: C++18 Object interface for CFGenKb SecSession.
...
namespace cfcore {
	...
	public:
		...
		virtual cfcore::ICFGenKbSecSessionObj* realize() = 0;

		virtual cfcore::ICFGenKbSecSessionObj* read( bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbSecSessionEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfcore::ICFGenKbSecSessionEditObj* getEdit() = 0;

		virtual cfcore::ICFGenKbSecSessionEditObj* getSecSessionEdit() = 0;

		virtual cfcore::ICFGenKbSecSessionTableObj* getSecSessionTable() = 0;

		virtual cfcore::ICFGenKbSchemaObj* getSchema() = 0;

		virtual cfcore::CFGenKbSecSessionBuff* getBuff() = 0;
		virtual void setBuff( cfcore::CFGenKbSecSessionBuff* value ) = 0;
		...
		virtual cfcore::CFGenKbSecSessionPKey* getPKey() = 0;
		virtual void setPKey( cfcore::CFGenKbSecSessionPKey* value ) = 0;
