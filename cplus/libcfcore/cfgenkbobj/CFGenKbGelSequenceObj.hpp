...
// Description: C++18 base object instance specification for CFGenKb GelSequence.
...
namespace cfcore {
	...
	class CFGenKbGelSequenceObj
	: public CFGenKbGelInstructionObj,
	  public virtual ICFGenKbGelSequenceObj
	{
	protected:
	public:
		...
		CFGenKbGelSequenceObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGelSequenceObj();
