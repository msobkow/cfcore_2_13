...
// Description: C++18 base object instance specification for CFGenKb GelExecutable.
...
namespace cfcore {
	...
	class CFGenKbGelExecutableObj
	: public CFGenKbGelSequenceObj,
	  public virtual ICFGenKbGelExecutableObj
	{
	protected:
	public:
		...
		CFGenKbGelExecutableObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGelExecutableObj();
