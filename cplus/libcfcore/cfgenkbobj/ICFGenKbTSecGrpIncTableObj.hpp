...
namespace cfcore {
	...
	{
	public:
		ICFGenKbTSecGrpIncTableObj();
		virtual ~ICFGenKbTSecGrpIncTableObj();
		...
		virtual cfcore::ICFGenKbTSecGrpIncObj* newInstance() = 0;

		virtual cfcore::ICFGenKbTSecGrpIncEditObj* newEditInstance( cfcore::ICFGenKbTSecGrpIncObj* orig ) = 0;

		virtual cfcore::ICFGenKbTSecGrpIncObj* realizeTSecGrpInc( cfcore::ICFGenKbTSecGrpIncObj* Obj ) = 0;
		...
		virtual void deepDisposeByUIncludeIdx( const int64_t TenantId,
			...
			const int32_t IncludeGroupId ) = 0;
		virtual void reallyDeepDisposeTSecGrpInc( cfcore::ICFGenKbTSecGrpIncObj* Obj ) = 0;
		virtual cfcore::ICFGenKbTSecGrpIncObj* createTSecGrpInc( cfcore::ICFGenKbTSecGrpIncEditObj* Obj ) = 0;

		virtual cfcore::ICFGenKbTSecGrpIncObj* readTSecGrpInc( cfcore::CFGenKbTSecGrpIncPKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbTSecGrpIncObj* lockTSecGrpInc( cfcore::CFGenKbTSecGrpIncPKey* pkey ) = 0;

		virtual std::vector<cfcore::ICFGenKbTSecGrpIncObj*> readAllTSecGrpInc( bool forceRead = false ) = 0;
		...
		virtual cfcore::ICFGenKbTSecGrpIncObj* readCachedTSecGrpInc( cfcore::CFGenKbTSecGrpIncPKey* pkey ) = 0;

		virtual cfcore::ICFGenKbTSecGrpIncObj* readCachedTSecGrpIncByIdIdx(const int64_t TenantId,
			const int64_t TSecGrpIncId ) = 0;

		virtual std::vector<cfcore::ICFGenKbTSecGrpIncObj*> readCachedTSecGrpIncByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfcore::ICFGenKbTSecGrpIncObj* updateTSecGrpInc( cfcore::ICFGenKbTSecGrpIncEditObj* Obj ) = 0;

		virtual void deleteTSecGrpInc( cfcore::ICFGenKbTSecGrpIncEditObj* Obj ) = 0;
		...
		virtual void reallyDetachFromIndexesTSecGrpInc( cfcore::ICFGenKbTSecGrpIncObj* Obj ) = 0;
