...
// Description: C++18 Object interface for CFGenKb SecGroupForm.
...
namespace cfcore {
	...
	public:
		...
		virtual ~ICFGenKbSecGroupFormObj();
		...
		virtual cfcore::ICFGenKbSecGroupFormObj* realize() = 0;

		virtual cfcore::ICFGenKbSecGroupFormObj* read( bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbSecGroupFormEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfcore::ICFGenKbSecGroupFormEditObj* getEdit() = 0;

		virtual cfcore::ICFGenKbSecGroupFormEditObj* getSecGroupFormEdit() = 0;

		virtual cfcore::ICFGenKbSecGroupFormTableObj* getSecGroupFormTable() = 0;

		virtual cfcore::ICFGenKbSchemaObj* getSchema() = 0;

		virtual cfcore::CFGenKbSecGroupFormBuff* getBuff() = 0;
		virtual void setBuff( cfcore::CFGenKbSecGroupFormBuff* value ) = 0;
		...
		virtual cfcore::CFGenKbSecGroupFormPKey* getPKey() = 0;
		virtual void setPKey( cfcore::CFGenKbSecGroupFormPKey* value ) = 0;
