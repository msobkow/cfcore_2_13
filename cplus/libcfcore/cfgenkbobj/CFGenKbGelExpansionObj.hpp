...
// Description: C++18 base object instance specification for CFGenKb GelExpansion.
...
namespace cfcore {
	...
	class CFGenKbGelExpansionObj
	: public CFGenKbGelInstructionObj,
	  public virtual ICFGenKbGelExpansionObj
	{
	protected:
	public:
		...
		CFGenKbGelExpansionObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGelExpansionObj();
