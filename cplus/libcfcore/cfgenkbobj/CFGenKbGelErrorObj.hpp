...
// Description: C++18 base object instance specification for CFGenKb GelError.
...
namespace cfcore {
	...
	class CFGenKbGelErrorObj
	: public CFGenKbGelBoilerplateObj,
	  public virtual ICFGenKbGelErrorObj
	{
	protected:
	public:
		...
		CFGenKbGelErrorObj();
		CFGenKbGelErrorObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGelErrorObj();
