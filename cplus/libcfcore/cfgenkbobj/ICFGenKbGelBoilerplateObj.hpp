...
// Description: C++18 Object interface for CFGenKb GelBoilerplate.
...
namespace cfcore {
	...
	public:
		...
		virtual ~ICFGenKbGelBoilerplateObj();
		virtual cfcore::ICFGenKbGelInstructionEditObj* beginEdit() = 0;

		virtual cfcore::ICFGenKbGelBoilerplateEditObj* getGelBoilerplateEdit() = 0;
