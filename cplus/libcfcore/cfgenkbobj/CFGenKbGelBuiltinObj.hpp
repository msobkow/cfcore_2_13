...
// Description: C++18 base object instance specification for CFGenKb GelBuiltin.
...
namespace cfcore {
	...
	class CFGenKbGelBuiltinObj
	: public CFGenKbGelInstructionObj,
	  public virtual ICFGenKbGelBuiltinObj
	{
	protected:
	public:
		...
		CFGenKbGelBuiltinObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGelBuiltinObj();
