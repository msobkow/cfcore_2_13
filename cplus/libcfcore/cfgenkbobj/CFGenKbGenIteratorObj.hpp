...
// Description: C++18 base object instance specification for CFGenKb GenIterator.
...
namespace cfcore {
	...
	class CFGenKbGenIteratorObj
	: public CFGenKbGenItemObj,
	  public virtual ICFGenKbGenIteratorObj
	{
	protected:
	public:
		...
		CFGenKbGenIteratorObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGenIteratorObj();
