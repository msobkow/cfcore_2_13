...
// Description: C++18 Instance Edit Object interface for CFGenKb GenIterator.
...
namespace cfcore {
	...
	: public virtual cfcore::ICFGenKbGenItemEditObj,
	  public virtual cfcore::ICFGenKbGenIteratorObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFGenKbGenIteratorEditObj();
		virtual ~ICFGenKbGenIteratorEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfcore::CFGenKbGenIteratorBuff* getGenIteratorBuff() {
			return( static_cast<cfcore::CFGenKbGenIteratorBuff*>( getBuff() ) );
		};

		inline cfcore::CFGenKbGenIteratorBuff* getGenIteratorEditBuff() {
			return( dynamic_cast<cfcore::CFGenKbGenIteratorBuff*>( getBuff() ) );
		};

		virtual cfcore::ICFGenKbGenIteratorObj* getOrigAsGenIterator() = 0;
