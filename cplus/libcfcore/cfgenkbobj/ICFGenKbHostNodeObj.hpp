...
// Description: C++18 Object interface for CFGenKb HostNode.
...
namespace cfcore {
	...
	public:
		...
		virtual cfcore::ICFGenKbHostNodeObj* realize() = 0;

		virtual cfcore::ICFGenKbHostNodeObj* read( bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbHostNodeEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfcore::ICFGenKbHostNodeEditObj* getEdit() = 0;

		virtual cfcore::ICFGenKbHostNodeEditObj* getHostNodeEdit() = 0;

		virtual cfcore::ICFGenKbHostNodeTableObj* getHostNodeTable() = 0;

		virtual cfcore::ICFGenKbSchemaObj* getSchema() = 0;

		virtual cfcore::CFGenKbHostNodeBuff* getBuff() = 0;
		virtual void setBuff( cfcore::CFGenKbHostNodeBuff* value ) = 0;
		...
		virtual cfcore::CFGenKbHostNodePKey* getPKey() = 0;
		virtual void setPKey( cfcore::CFGenKbHostNodePKey* value ) = 0;
