...
// Description: C++18 base object instance specification for CFGenKb Tool.
...
namespace cfcore {
	...
	class CFGenKbToolObj
	: public virtual ICFGenKbToolObj
	{
	protected:
		bool isNew;
		cfcore::ICFGenKbToolEditObj* edit;
	...
	public:
		...
		CFGenKbToolObj();
		CFGenKbToolObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbToolObj();
		...
		virtual cfcore::ICFGenKbToolObj* realize();
		...
		virtual cfcore::ICFGenKbToolEditObj* beginEdit();
