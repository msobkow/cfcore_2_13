...
// Description: C++18 Object interface for CFGenKb GenReference.
...
namespace cfcore {
	...
	public:
		...
		virtual ~ICFGenKbGenReferenceObj();
		virtual cfcore::ICFGenKbGenItemEditObj* beginEdit() = 0;

		virtual cfcore::ICFGenKbGenReferenceEditObj* getGenReferenceEdit() = 0;
