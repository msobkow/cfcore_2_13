...
// Description: C++18 base object instance specification for CFGenKb GelReference.
...
namespace cfcore {
	...
	class CFGenKbGelReferenceObj
	: public CFGenKbGelInstructionObj,
	  public virtual ICFGenKbGelReferenceObj
	{
	protected:
	public:
		...
		CFGenKbGelReferenceObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGelReferenceObj();
