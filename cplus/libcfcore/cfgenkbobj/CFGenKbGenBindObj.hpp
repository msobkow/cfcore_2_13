...
// Description: C++18 base object instance specification for CFGenKb GenBind.
...
namespace cfcore {
	...
	class CFGenKbGenBindObj
	: public CFGenKbGenItemObj,
	  public virtual ICFGenKbGenBindObj
	{
	protected:
	public:
		...
		CFGenKbGenBindObj();
		CFGenKbGenBindObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGenBindObj();
