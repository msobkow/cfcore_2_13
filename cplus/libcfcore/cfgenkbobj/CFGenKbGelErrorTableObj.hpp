...
namespace cfcore {
	...
	class CFGenKbGelErrorTableObj
	: public virtual ICFGenKbGelErrorTableObj
	{
	protected:
		cfcore::ICFGenKbSchemaObj* schema;
		std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelErrorObj*>* members;
		std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelErrorObj*>* allGelError;
		std::map< cfcore::CFGenKbGelInstructionByTenantIdxKey,
			std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelErrorObj*>*>* indexByTenantIdx;
		std::map< cfcore::CFGenKbGelInstructionByGelCacheIdxKey,
			std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelErrorObj*>*>* indexByGelCacheIdx;
		std::map< cfcore::CFGenKbGelInstructionByChainIdxKey,
			std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelErrorObj*>*>* indexByChainIdx;
	...
	public:
		...
		CFGenKbGelErrorTableObj();
		CFGenKbGelErrorTableObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual ~CFGenKbGelErrorTableObj();
		...
		virtual cfcore::ICFGenKbGelErrorObj* newInstance();

		virtual cfcore::ICFGenKbGelErrorEditObj* newEditInstance( cfcore::ICFGenKbGelErrorObj* orig );

		virtual cfcore::ICFGenKbGelErrorObj* realizeGelError( cfcore::ICFGenKbGelErrorObj* Obj );
		...
		virtual void reallyDeepDisposeGelError( cfcore::ICFGenKbGelErrorObj* Obj );
		virtual cfcore::ICFGenKbGelErrorObj* createGelError( cfcore::ICFGenKbGelErrorEditObj* Obj );

		virtual cfcore::ICFGenKbGelErrorObj* readGelError( cfcore::CFGenKbGelInstructionPKey* pkey, bool forceRead = false );

		virtual cfcore::ICFGenKbGelErrorObj* lockGelError( cfcore::CFGenKbGelInstructionPKey* pkey );

		virtual std::vector<cfcore::ICFGenKbGelErrorObj*> readAllGelError( bool forceRead = false );
		...
		virtual cfcore::ICFGenKbGelErrorObj* readCachedGelError( cfcore::CFGenKbGelInstructionPKey* pkey );

		virtual cfcore::ICFGenKbGelErrorObj* readCachedGelErrorByPIdx( const int64_t TenantId,
			const int64_t GelCacheId,
			const int64_t GelInstId );

		virtual std::vector<cfcore::ICFGenKbGelErrorObj*> readCachedGelErrorByTenantIdx( const int64_t TenantId );
		...
		virtual cfcore::ICFGenKbGelErrorObj* updateGelError( cfcore::ICFGenKbGelErrorEditObj* Obj );

		virtual void deleteGelError( cfcore::ICFGenKbGelErrorEditObj* Obj );

		virtual void deleteGelErrorByPIdx( const int64_t TenantId,
			const int64_t GelCacheId,
			const int64_t GelInstId );

		virtual void deleteGelErrorByTenantIdx( const int64_t TenantId );
		...
		virtual void reallyDetachFromIndexesGelError( cfcore::ICFGenKbGelErrorObj* Obj );
