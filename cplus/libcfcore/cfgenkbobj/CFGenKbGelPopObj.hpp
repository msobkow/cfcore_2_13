...
// Description: C++18 base object instance specification for CFGenKb GelPop.
...
namespace cfcore {
	...
	class CFGenKbGelPopObj
	: public CFGenKbGelInstructionObj,
	  public virtual ICFGenKbGelPopObj
	{
	protected:
	public:
		...
		CFGenKbGelPopObj();
		CFGenKbGelPopObj( cfcore::ICFGenKbSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFGenKbGelPopObj();
