...
namespace cfcore {
	...
	{
	public:
		ICFGenKbGelCallTableObj();
		virtual ~ICFGenKbGelCallTableObj();
		...
		virtual cfcore::ICFGenKbGelCallObj* newInstance() = 0;

		virtual cfcore::ICFGenKbGelCallEditObj* newEditInstance( cfcore::ICFGenKbGelCallObj* orig ) = 0;

		virtual cfcore::ICFGenKbGelCallObj* realizeGelCall( cfcore::ICFGenKbGelCallObj* Obj ) = 0;
		...
		virtual void reallyDeepDisposeGelCall( cfcore::ICFGenKbGelCallObj* Obj ) = 0;
		...
		virtual cfcore::ICFGenKbGelCallObj* createGelCall( cfcore::ICFGenKbGelCallEditObj* Obj ) = 0;

		virtual cfcore::ICFGenKbGelCallObj* readGelCall( cfcore::CFGenKbGelInstructionPKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfcore::ICFGenKbGelCallObj* lockGelCall( cfcore::CFGenKbGelInstructionPKey* pkey ) = 0;

		virtual std::vector<cfcore::ICFGenKbGelCallObj*> readAllGelCall( bool forceRead = false ) = 0;
		...
		virtual cfcore::ICFGenKbGelCallObj* readCachedGelCall( cfcore::CFGenKbGelInstructionPKey* pkey ) = 0;

		virtual cfcore::ICFGenKbGelCallObj* readCachedGelCallByPIdx(const int64_t TenantId,
			const int64_t GelCacheId,
			const int64_t GelInstId ) = 0;

		virtual std::vector<cfcore::ICFGenKbGelCallObj*> readCachedGelCallByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfcore::ICFGenKbGelCallObj* updateGelCall( cfcore::ICFGenKbGelCallEditObj* Obj ) = 0;

		virtual void deleteGelCall( cfcore::ICFGenKbGelCallEditObj* Obj ) = 0;

		virtual void deleteGelCallByPIdx( const int64_t TenantId,
			const int64_t GelCacheId,
			const int64_t GelInstId ) = 0;

		virtual void deleteGelCallByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesGelCall( cfcore::ICFGenKbGelCallObj* Obj ) = 0;
