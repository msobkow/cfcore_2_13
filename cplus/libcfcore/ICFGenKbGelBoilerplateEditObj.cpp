// Description: C++18 Instance Edit Object interface implementation for CFGenKb GelBoilerplate.
...
namespace cfcore {
	...
	const std::string ICFGenKbGelBoilerplateEditObj::CLASS_NAME( "ICFGenKbGelBoilerplateEditObj" );

	ICFGenKbGelBoilerplateEditObj::ICFGenKbGelBoilerplateEditObj()
