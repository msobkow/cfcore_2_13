...
// Description: C++18 Interface for an in-memory RAM DbIO declementation for GelModifier.
...
namespace cfcore {
	...
	class CFGenKbRamGelModifierTable
	: public virtual cfcore::ICFGenKbGelModifierTable
	{
	protected:
		cfcore::ICFGenKbSchema* schema;
		std::map<cfcore::CFGenKbGelInstructionPKey,
			cfcore::CFGenKbGelModifierBuff*>* dictByPKey;
		std::map<cfcore::CFGenKbGelModifierByRemainderIdxKey,
			std::map<cfcore::CFGenKbGelInstructionPKey,
				cfcore::CFGenKbGelModifierBuff*>*>* dictByRemainderIdx;
	public:
		static const std::string CLASS_NAME;
		CFGenKbRamGelModifierTable( cfcore::ICFGenKbSchema* argSchema );

		virtual ~CFGenKbRamGelModifierTable();
		...
		virtual std::TCFLibOwningVector<cfcore::CFGenKbGelModifierBuff*> readAllDerived( const cfcore::CFGenKbAuthorization* Authorization );
		...
		virtual std::TCFLibOwningVector<cfcore::CFGenKbGelModifierBuff*> readAllBuff( const cfcore::CFGenKbAuthorization* Authorization );
		...
		virtual std::TCFLibOwningVector<cfcore::CFGenKbGelModifierBuff*> pageBuffByRemainderIdx( const cfcore::CFGenKbAuthorization* Authorization,
			const int64_t* RemainderTenantId,
			const int64_t RemainderGelCacheId,
			const int64_t* RemainderInstId,
