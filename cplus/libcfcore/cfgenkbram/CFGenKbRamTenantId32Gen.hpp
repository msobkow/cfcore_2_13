...
namespace cfcore {
	...
	size_t hashCode() const;
		...
		bool operator <( const cfcore::CFGenKbRamTenantId32Gen& rhs );
		...
		bool operator >( const cfcore::CFGenKbRamTenantId32Gen& rhs );
		CFGenKbRamTenantId32Gen operator =( CFGenKbRamTenantId32Gen& src );
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbRamTenantId32Gen> {
		typedef cfcore::CFGenKbRamTenantId32Gen argument_type;
