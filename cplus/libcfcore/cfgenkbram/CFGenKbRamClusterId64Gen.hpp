...
namespace cfcore {
	...
	class CFGenKbRamClusterId64Gen
	{
	protected:
		int64_t requiredId;
		int16_t sliceId = 0;
	...
	size_t hashCode() const;
		...
		bool operator <( const cfcore::CFGenKbRamClusterId64Gen& rhs );
		...
		bool operator >( const cfcore::CFGenKbRamClusterId64Gen& rhs );
		CFGenKbRamClusterId64Gen operator =( CFGenKbRamClusterId64Gen& src );
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbRamClusterId64Gen> {
		typedef cfcore::CFGenKbRamClusterId64Gen argument_type;
