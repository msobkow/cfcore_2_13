// Description: C++18 implementation for a GelBoilerplate buffer object.
...
namespace cfcore {
	...
	const std::string CFGenKbGelBoilerplateBuff::GENDEFNAME( "GelBoilerplate" );
	const classcode_t CFGenKbGelBoilerplateBuff::CLASS_CODE = 0xa929L;
	const std::string CFGenKbGelBoilerplateBuff::CLASS_NAME( "CFGenKbGelBoilerplateBuff" );
	const int64_t CFGenKbGelBoilerplateBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFGenKbGelBoilerplateBuff::GELCACHEID_INIT_VALUE = 0LL;
	const int64_t CFGenKbGelBoilerplateBuff::GELINSTID_INIT_VALUE = 0LL;
	const int64_t CFGenKbGelBoilerplateBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFGenKbGelBoilerplateBuff::GELCACHEID_MIN_VALUE = 0LL;
	const int64_t CFGenKbGelBoilerplateBuff::GELINSTID_MIN_VALUE = 0LL;

	CFGenKbGelBoilerplateBuff::CFGenKbGelBoilerplateBuff()
	: CFGenKbGelInstructionBuff()
	{
	}

	CFGenKbGelBoilerplateBuff::CFGenKbGelBoilerplateBuff( const CFGenKbGelBoilerplateBuff& src )
	: CFGenKbGelInstructionBuff()
	{
	...
	cflib::ICFLibCloneableObj* CFGenKbGelBoilerplateBuff::clone() {
		CFGenKbGelBoilerplateBuff* copy = new CFGenKbGelBoilerplateBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFGenKbGelBoilerplateBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFGenKbGelBoilerplateBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFGenKbGelBoilerplateBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	size_t CFGenKbGelBoilerplateBuff::hashCode() const {
		size_t hashCode = CFGenKbGelInstructionBuff::hashCode();
		return( hashCode );
	}

	CFGenKbGelBoilerplateBuff CFGenKbGelBoilerplateBuff::operator =( cfcore::CFGenKbGelBoilerplateBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredGelCacheId( src.getRequiredGelCacheId() );
		setRequiredGelInstId( src.getRequiredGelInstId() );
		setRequiredRevision( src.getRequiredRevision() );
	...
	bool CFGenKbGelBoilerplateBuff::operator <( const CFGenKbGelInstructionPKey& rhs ) {
	...
	bool CFGenKbGelBoilerplateBuff::operator <( const CFGenKbGelBoilerplateBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFGenKbGelBoilerplateBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFGenKbGelBoilerplateBuff" );
