// Description: C++18 Instance Edit Object interface implementation for CFGenKb GelError.
...
namespace cfcore {
	...
	const std::string ICFGenKbGelErrorEditObj::CLASS_NAME( "ICFGenKbGelErrorEditObj" );

	ICFGenKbGelErrorEditObj::ICFGenKbGelErrorEditObj()
