// Description: C++18 Instance Edit Object interface implementation for CFGenKb GelCounter.
...
namespace cfcore {
	...
	const std::string ICFGenKbGelCounterEditObj::CLASS_NAME( "ICFGenKbGelCounterEditObj" );

	ICFGenKbGelCounterEditObj::ICFGenKbGelCounterEditObj()
