// Description: C++18 implementation for a GenReference buffer object.
...
namespace cfcore {
	...
	const std::string CFGenKbGenReferenceBuff::GENDEFNAME( "GenReference" );
	const classcode_t CFGenKbGenReferenceBuff::CLASS_CODE = 0xa922L;
	const std::string CFGenKbGenReferenceBuff::CLASS_NAME( "CFGenKbGenReferenceBuff" );
	const int64_t CFGenKbGenReferenceBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFGenKbGenReferenceBuff::CARTRIDGEID_INIT_VALUE = 0LL;
	const int64_t CFGenKbGenReferenceBuff::ITEMID_INIT_VALUE = 0LL;
	const int64_t CFGenKbGenReferenceBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFGenKbGenReferenceBuff::CARTRIDGEID_MIN_VALUE = 0LL;
	const int64_t CFGenKbGenReferenceBuff::ITEMID_MIN_VALUE = 0LL;
	const int64_t CFGenKbGenReferenceBuff::ITEMID_MAX_VALUE = 2147483647LL;

	CFGenKbGenReferenceBuff::CFGenKbGenReferenceBuff()
	: CFGenKbGenItemBuff()
	{
	}

	CFGenKbGenReferenceBuff::CFGenKbGenReferenceBuff( const CFGenKbGenReferenceBuff& src )
	: CFGenKbGenItemBuff()
	{
	...
	cflib::ICFLibCloneableObj* CFGenKbGenReferenceBuff::clone() {
		CFGenKbGenReferenceBuff* copy = new CFGenKbGenReferenceBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFGenKbGenReferenceBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFGenKbGenReferenceBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFGenKbGenReferenceBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	size_t CFGenKbGenReferenceBuff::hashCode() const {
		size_t hashCode = CFGenKbGenItemBuff::hashCode();
		return( hashCode );
	}

	CFGenKbGenReferenceBuff CFGenKbGenReferenceBuff::operator =( cfcore::CFGenKbGenReferenceBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredCartridgeId( src.getRequiredCartridgeId() );
		setRequiredItemId( src.getRequiredItemId() );
		setRequiredRevision( src.getRequiredRevision() );
	...
	bool CFGenKbGenReferenceBuff::operator <( const CFGenKbGenItemPKey& rhs ) {
	...
	bool CFGenKbGenReferenceBuff::operator <( const CFGenKbGenReferenceBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFGenKbGenReferenceBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFGenKbGenReferenceBuff" );
