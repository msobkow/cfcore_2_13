// Description: C++18 implementation for a GelInstruction buffer object.
...
namespace cfcore {
	...
	const std::string CFGenKbGelInstructionBuff::S_VALUE( "value" );
	const std::string CFGenKbGelInstructionBuff::S_VALUE_LENGTH( "value.length()" );

	const std::string CFGenKbGelInstructionBuff::GENDEFNAME( "GelInstruction" );
	const classcode_t CFGenKbGelInstructionBuff::CLASS_CODE = 0xa916L;
	const std::string CFGenKbGelInstructionBuff::CLASS_NAME( "CFGenKbGelInstructionBuff" );
		const std::string CFGenKbGelInstructionBuff::COLNAME_TENANTID( "TenantId" );
		const std::string CFGenKbGelInstructionBuff::COLNAME_GELCACHEID( "GelCacheId" );
		const std::string CFGenKbGelInstructionBuff::COLNAME_GELINSTID( "GelInstId" );
		const std::string CFGenKbGelInstructionBuff::COLNAME_CHAININSTTENANTID( "ChainInstTenantId" );
		const std::string CFGenKbGelInstructionBuff::COLNAME_CHAININSTGELCACHEID( "ChainInstGelCacheId" );
		const std::string CFGenKbGelInstructionBuff::COLNAME_CHAININSTGELINSTID( "ChainInstGelInstId" );
		const std::string CFGenKbGelInstructionBuff::COLNAME_SOURCETEXT( "SourceText" );
	const int64_t CFGenKbGelInstructionBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFGenKbGelInstructionBuff::GELCACHEID_INIT_VALUE = 0LL;
	const int64_t CFGenKbGelInstructionBuff::GELINSTID_INIT_VALUE = 0LL;
	const int64_t CFGenKbGelInstructionBuff::CHAININSTTENANTID_INIT_VALUE = 0LL;
	const int64_t CFGenKbGelInstructionBuff::CHAININSTGELCACHEID_INIT_VALUE = 0LL;
	const int64_t CFGenKbGelInstructionBuff::CHAININSTGELINSTID_INIT_VALUE = 0LL;
	const std::string CFGenKbGelInstructionBuff::SOURCETEXT_INIT_VALUE( "" );
	const int64_t CFGenKbGelInstructionBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFGenKbGelInstructionBuff::GELCACHEID_MIN_VALUE = 0LL;
	const int64_t CFGenKbGelInstructionBuff::GELINSTID_MIN_VALUE = 0LL;
	const int64_t CFGenKbGelInstructionBuff::CHAININSTTENANTID_MIN_VALUE = 0LL;
	const int64_t CFGenKbGelInstructionBuff::CHAININSTGELCACHEID_MIN_VALUE = 0LL;
	const int64_t CFGenKbGelInstructionBuff::CHAININSTGELINSTID_MIN_VALUE = 0LL;
	const std::string::size_type CFGenKbGelInstructionBuff::SOURCETEXT_MAX_LEN = 2000000;

	CFGenKbGelInstructionBuff::CFGenKbGelInstructionBuff()
	: cflib::ICFLibCloneableObj()
	{
		...
		requiredSourceText = new std::string( cfcore::CFGenKbGelInstructionBuff::SOURCETEXT_INIT_VALUE );
	}

	CFGenKbGelInstructionBuff::CFGenKbGelInstructionBuff( const CFGenKbGelInstructionBuff& src )
	: cflib::ICFLibCloneableObj()
	{
		requiredRevision = 1;
		requiredTenantId = cfcore::CFGenKbGelInstructionBuff::TENANTID_INIT_VALUE;
	...
	CFGenKbGelInstructionBuff::~CFGenKbGelInstructionBuff() {
		if( requiredSourceText != NULL ) {
			delete requiredSourceText;
			requiredSourceText = NULL;
		}
	}

	cflib::ICFLibCloneableObj* CFGenKbGelInstructionBuff::clone() {
		CFGenKbGelInstructionBuff* copy = new CFGenKbGelInstructionBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFGenKbGelInstructionBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFGenKbGelInstructionBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFGenKbGelInstructionBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFGenKbGelInstructionBuff::getRequiredTenantId() const {
		return( requiredTenantId );
	}

	const int64_t* CFGenKbGelInstructionBuff::getRequiredTenantIdReference() const {
		return( &requiredTenantId );
	}

	void CFGenKbGelInstructionBuff::setRequiredTenantId( const int64_t value ) {
	...
	const int64_t CFGenKbGelInstructionBuff::getRequiredGelCacheId() const {
		return( requiredGelCacheId );
	}

	const int64_t* CFGenKbGelInstructionBuff::getRequiredGelCacheIdReference() const {
		return( &requiredGelCacheId );
	}

	void CFGenKbGelInstructionBuff::setRequiredGelCacheId( const int64_t value ) {
	...
	const int64_t CFGenKbGelInstructionBuff::getRequiredGelInstId() const {
		return( requiredGelInstId );
	}

	const int64_t* CFGenKbGelInstructionBuff::getRequiredGelInstIdReference() const {
		return( &requiredGelInstId );
	}

	void CFGenKbGelInstructionBuff::setRequiredGelInstId( const int64_t value ) {
	...
	const bool CFGenKbGelInstructionBuff::isOptionalChainInstTenantIdNull() const {
		return( optionalChainInstTenantId.isNull() );
	}

	const int64_t CFGenKbGelInstructionBuff::getOptionalChainInstTenantIdValue() const {
		return( optionalChainInstTenantId.getValue() );
	}

	const int64_t* CFGenKbGelInstructionBuff::getOptionalChainInstTenantIdReference() const {
		return( optionalChainInstTenantId.getReference() );
	}

	void CFGenKbGelInstructionBuff::setOptionalChainInstTenantIdNull() {
		optionalChainInstTenantId.setNull();
	}

	void CFGenKbGelInstructionBuff::setOptionalChainInstTenantIdValue( const int64_t value ) {
	...
	const bool CFGenKbGelInstructionBuff::isOptionalChainInstGelCacheIdNull() const {
		return( optionalChainInstGelCacheId.isNull() );
	}

	const int64_t CFGenKbGelInstructionBuff::getOptionalChainInstGelCacheIdValue() const {
		return( optionalChainInstGelCacheId.getValue() );
	}

	const int64_t* CFGenKbGelInstructionBuff::getOptionalChainInstGelCacheIdReference() const {
		return( optionalChainInstGelCacheId.getReference() );
	}

	void CFGenKbGelInstructionBuff::setOptionalChainInstGelCacheIdNull() {
		optionalChainInstGelCacheId.setNull();
	}

	void CFGenKbGelInstructionBuff::setOptionalChainInstGelCacheIdValue( const int64_t value ) {
	...
	const bool CFGenKbGelInstructionBuff::isOptionalChainInstGelInstIdNull() const {
		return( optionalChainInstGelInstId.isNull() );
	}

	const int64_t CFGenKbGelInstructionBuff::getOptionalChainInstGelInstIdValue() const {
		return( optionalChainInstGelInstId.getValue() );
	}

	const int64_t* CFGenKbGelInstructionBuff::getOptionalChainInstGelInstIdReference() const {
		return( optionalChainInstGelInstId.getReference() );
	}

	void CFGenKbGelInstructionBuff::setOptionalChainInstGelInstIdNull() {
		optionalChainInstGelInstId.setNull();
	}

	void CFGenKbGelInstructionBuff::setOptionalChainInstGelInstIdValue( const int64_t value ) {
	...
	const std::string& CFGenKbGelInstructionBuff::getRequiredSourceText() const {
		return( *requiredSourceText );
	}

	const std::string* CFGenKbGelInstructionBuff::getRequiredSourceTextReference() const {
		return( requiredSourceText );
	}

	void CFGenKbGelInstructionBuff::setRequiredSourceText( const std::string& value ) {
		static const std::string S_ProcName( "setRequiredSourceText" );
		if( value.length() > CFGenKbGelInstructionBuff::SOURCETEXT_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE_LENGTH,
				value.length(),
				CFGenKbGelInstructionBuff::SOURCETEXT_MAX_LEN );
		}
		if( requiredSourceText != NULL ) {
			delete requiredSourceText;
			requiredSourceText = NULL;
		}
		requiredSourceText = new std::string( value );
	}

	int32_t CFGenKbGelInstructionBuff::getRequiredRevision() const {
		return( requiredRevision );
	}

	void CFGenKbGelInstructionBuff::setRequiredRevision( int32_t value ) {
		requiredRevision = value;
	}

	size_t CFGenKbGelInstructionBuff::hashCode() const {
		size_t hashCode = 0L;
		...
		hashCode = hashCode + cflib::CFLib::hash( getRequiredSourceText() );
		return( hashCode );
	}

	CFGenKbGelInstructionBuff CFGenKbGelInstructionBuff::operator =( cfcore::CFGenKbGelInstructionBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredGelCacheId( src.getRequiredGelCacheId() );
		setRequiredGelInstId( src.getRequiredGelInstId() );
		setRequiredRevision( src.getRequiredRevision() );
	...
	bool CFGenKbGelInstructionBuff::operator <( const CFGenKbGelInstructionByTenantIdxKey& rhs ) {
	...
	bool CFGenKbGelInstructionBuff::operator <( const CFGenKbGelInstructionByGelCacheIdxKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFGenKbGelInstructionBuff::operator <( const CFGenKbGelInstructionByChainIdxKey& rhs ) {
		if( ! isOptionalChainInstTenantIdNull() ) {
	...
	bool CFGenKbGelInstructionBuff::operator <( const CFGenKbGelInstructionPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFGenKbGelInstructionBuff::operator <( const CFGenKbGelInstructionBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFGenKbGelInstructionBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFGenKbGelInstructionBuff" );
