// Description: C++18 Instance Edit Object interface implementation for CFGenKb GelBuiltin.
...
namespace cfcore {
	...
	const std::string ICFGenKbGelBuiltinEditObj::CLASS_NAME( "ICFGenKbGelBuiltinEditObj" );

	ICFGenKbGelBuiltinEditObj::ICFGenKbGelBuiltinEditObj()
