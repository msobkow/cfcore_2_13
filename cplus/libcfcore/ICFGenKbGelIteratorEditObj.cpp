// Description: C++18 Instance Edit Object interface implementation for CFGenKb GelIterator.
...
namespace cfcore {
	...
	const std::string ICFGenKbGelIteratorEditObj::CLASS_NAME( "ICFGenKbGelIteratorEditObj" );

	ICFGenKbGelIteratorEditObj::ICFGenKbGelIteratorEditObj()
