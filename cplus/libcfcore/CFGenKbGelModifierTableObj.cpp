...
namespace cfcore {
	...
	const std::string CFGenKbGelModifierTableObj::CLASS_NAME( "CFGenKbGelModifierTableObj" );
	const std::string CFGenKbGelModifierTableObj::TABLE_NAME( "GelModifier" );
	const std::string CFGenKbGelModifierTableObj::TABLE_DBNAME( "gelmodifier" );

	CFGenKbGelModifierTableObj::CFGenKbGelModifierTableObj() {
		schema = NULL;
		members = new std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>();
		allGelModifier = NULL;
		indexByTenantIdx = new std::map< cfcore::CFGenKbGelInstructionByTenantIdxKey,
			std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>*>();
		...
		indexByChainIdx = new std::map< cfcore::CFGenKbGelInstructionByChainIdxKey,
			std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>*>();
		indexByRemainderIdx = new std::map< cfcore::CFGenKbGelModifierByRemainderIdxKey,
			std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>*>();
	}

	CFGenKbGelModifierTableObj::CFGenKbGelModifierTableObj( cfcore::ICFGenKbSchemaObj* argSchema ) {
	...
	cfcore::ICFGenKbSchemaObj* CFGenKbGelModifierTableObj::getSchema() {
		return( schema );
	}

	void CFGenKbGelModifierTableObj::setSchema( cfcore::ICFGenKbSchemaObj* value ) {
		schema = dynamic_cast<cfcore::ICFGenKbSchemaObj*>( value );
	}

	const std::string CFGenKbGelModifierTableObj::getTableName() {
		return( TABLE_NAME );
	}

	const std::string CFGenKbGelModifierTableObj::getTableDbName() {
		return( TABLE_DBNAME );
	}
	const classcode_t* CFGenKbGelModifierTableObj::getObjQualifyingClassCode() {
		return( NULL );
	}


	void CFGenKbGelModifierTableObj::minimizeMemory() {
		if( allGelModifier != NULL ) {
			allGelModifier->clear();
			delete allGelModifier;
			allGelModifier = NULL;
		}
		if( indexByTenantIdx != NULL ) {
			std::map< cfcore::CFGenKbGelInstructionByTenantIdxKey,
				std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* >::iterator iterByTenantIdx = indexByTenantIdx->begin();
			std::map< cfcore::CFGenKbGelInstructionByTenantIdxKey,
				std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* >::iterator endByTenantIdx = indexByTenantIdx->end();
			std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* curByTenantIdx = NULL;
		...
		if( indexByGelCacheIdx != NULL ) {
			std::map< cfcore::CFGenKbGelInstructionByGelCacheIdxKey,
				std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* >::iterator iterByGelCacheIdx = indexByGelCacheIdx->begin();
			std::map< cfcore::CFGenKbGelInstructionByGelCacheIdxKey,
				std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* >::iterator endByGelCacheIdx = indexByGelCacheIdx->end();
			std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* curByGelCacheIdx = NULL;
		...
		if( indexByChainIdx != NULL ) {
			std::map< cfcore::CFGenKbGelInstructionByChainIdxKey,
				std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* >::iterator iterByChainIdx = indexByChainIdx->begin();
			std::map< cfcore::CFGenKbGelInstructionByChainIdxKey,
				std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* >::iterator endByChainIdx = indexByChainIdx->end();
			std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* curByChainIdx = NULL;
		...
		if( indexByRemainderIdx != NULL ) {
			std::map< cfcore::CFGenKbGelModifierByRemainderIdxKey,
				std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* >::iterator iterByRemainderIdx = indexByRemainderIdx->begin();
			std::map< cfcore::CFGenKbGelModifierByRemainderIdxKey,
				std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* >::iterator endByRemainderIdx = indexByRemainderIdx->end();
			std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* curByRemainderIdx = NULL;
	...
	cfcore::ICFGenKbGelModifierObj* CFGenKbGelModifierTableObj::newInstance() {
		cfcore::ICFGenKbGelModifierObj* inst = dynamic_cast<cfcore::ICFGenKbGelModifierObj*>( new CFGenKbGelModifierObj( schema ) );
		return( inst );
	}

	cfcore::ICFGenKbGelModifierEditObj* CFGenKbGelModifierTableObj::newEditInstance( cfcore::ICFGenKbGelModifierObj* orig ) {
		cfcore::ICFGenKbGelModifierEditObj* edit = dynamic_cast<cfcore::ICFGenKbGelModifierEditObj*>( new CFGenKbGelModifierEditObj( orig ));
		return( edit );
	}

	cfcore::ICFGenKbGelModifierObj* CFGenKbGelModifierTableObj::realizeGelModifier( cfcore::ICFGenKbGelModifierObj* Obj ) {
		static const std::string S_ProcName( "realizeGelModifier" );
		...
		cfcore::ICFGenKbGelModifierObj* obj = Obj;
		cfcore::ICFGenKbGelModifierObj* existingObj = NULL;
		cfcore::CFGenKbGelInstructionPKey* pkey = obj->getPKey();
		cfcore::ICFGenKbGelModifierObj* keepObj = NULL;
		...
		if( searchMembers != members->end() ) {
			...
			if( indexByTenantIdx != NULL ) {
				...
				if( searchTenantIdx != indexByTenantIdx->end() ) {
					std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* mapTenantIdx = searchTenantIdx->second;
			...
			if( indexByGelCacheIdx != NULL ) {
				...
				if( searchGelCacheIdx != indexByGelCacheIdx->end() ) {
					std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* mapGelCacheIdx = searchGelCacheIdx->second;
			...
			if( indexByChainIdx != NULL ) {
				...
				if( searchChainIdx != indexByChainIdx->end() ) {
					std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* mapChainIdx = searchChainIdx->second;
					if( mapChainIdx != NULL ) {
			...
			if( indexByRemainderIdx != NULL ) {
				...
				if( searchRemainderIdx != indexByRemainderIdx->end() ) {
					std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* mapRemainderIdx = searchRemainderIdx->second;
			...
			keepObj = dynamic_cast<cfcore::ICFGenKbGelModifierObj*>( dynamic_cast<cfcore::CFGenKbGelInstructionTableObj*>( schema->getGelInstructionTableObj() )->realizeGelInstruction( Obj ) );
			if( keepObj == NULL ) {
				throw cflib::CFLibNullArgumentException( CLASS_NAME,
					S_ProcName,
					0,
			...
			if( indexByTenantIdx != NULL ) {
				...
				cfcore::ICFGenKbGelModifierObj* aTenantIdxObj =
					dynamic_cast<cfcore::ICFGenKbGelModifierObj*>( keepObj );
				...
				if( searchIndexByTenantIdx != indexByTenantIdx->end() ) {
					std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* mapTenantIdx = searchIndexByTenantIdx->second;
					if( mapTenantIdx != NULL ) {
						mapTenantIdx->insert( std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj* >::value_type( *(keepObj->getPKey()), aTenantIdxObj ) );
					}
				}
			}
			...
			if( indexByGelCacheIdx != NULL ) {
				...
				cfcore::ICFGenKbGelModifierObj* aGelCacheIdxObj =
					dynamic_cast<cfcore::ICFGenKbGelModifierObj*>( keepObj );
				...
				if( searchIndexByGelCacheIdx != indexByGelCacheIdx->end() ) {
					std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* mapGelCacheIdx = searchIndexByGelCacheIdx->second;
					if( mapGelCacheIdx != NULL ) {
						mapGelCacheIdx->insert( std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj* >::value_type( *(keepObj->getPKey()), aGelCacheIdxObj ) );
					}
				}
			}
			...
			if( indexByChainIdx != NULL ) {
				...
				cfcore::ICFGenKbGelModifierObj* aChainIdxObj =
					dynamic_cast<cfcore::ICFGenKbGelModifierObj*>( keepObj );
				...
				if( searchIndexByChainIdx != indexByChainIdx->end() ) {
					std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* mapChainIdx = searchIndexByChainIdx->second;
					if( mapChainIdx != NULL ) {
						mapChainIdx->insert( std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj* >::value_type( *(keepObj->getPKey()), aChainIdxObj ) );
					}
				}
			}
			...
			if( indexByRemainderIdx != NULL ) {
				...
				cfcore::ICFGenKbGelModifierObj* aRemainderIdxObj =
					dynamic_cast<cfcore::ICFGenKbGelModifierObj*>( keepObj );
				...
				if( searchIndexByRemainderIdx != indexByRemainderIdx->end() ) {
					std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* mapRemainderIdx = searchIndexByRemainderIdx->second;
					if( mapRemainderIdx != NULL ) {
						mapRemainderIdx->insert( std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj* >::value_type( *(keepObj->getPKey()), aRemainderIdxObj ) );
					}
				}
			}

			if( allGelModifier != NULL ) {
				allGelModifier->insert( std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj* >::value_type( *(keepObj->getPKey()), keepObj ) );
			}
		}
		else {
			keepObj = obj;
			...
			members->insert( std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj* >::value_type( *(keepObj->getPKey()), keepObj ) );
	...
	void CFGenKbGelModifierTableObj::deepDisposeByPIdx( const int64_t TenantId,
			const int64_t GelCacheId,
			const int64_t GelInstId ) {
		static const std::string S_ProcName( "deepDisposeByPIdx" );
		std::vector<cfcore::ICFGenKbGelModifierObj*> list;
		cfcore::ICFGenKbGelModifierObj* existingObj = readCachedGelModifierByPIdx( TenantId,
				GelCacheId,
				GelInstId );
		if( existingObj != NULL ) {
			list.push_back( existingObj );
		}
		cfcore::ICFGenKbGelModifierObj* cur = NULL;
		...
		while( listIter != listEnd ) {
			...
			if( cur != NULL ) {
				...
				if( classCode == cfcore::CFGenKbGelModifierBuff::CLASS_CODE ) {
	...
	void CFGenKbGelModifierTableObj::deepDisposeByTenantIdx( const int64_t TenantId ) {
		static const std::string S_ProcName( "deepDisposeByTenantIdx" );
		std::vector<cfcore::ICFGenKbGelModifierObj*> list;
		std::vector<cfcore::ICFGenKbGelModifierObj*> matchesFound = readCachedGelModifierByTenantIdx( TenantId );
	...
	void CFGenKbGelModifierTableObj::deepDisposeByGelCacheIdx( const int64_t TenantId,
			const int64_t GelCacheId ) {
		static const std::string S_ProcName( "deepDisposeByGelCacheIdx" );
		std::vector<cfcore::ICFGenKbGelModifierObj*> list;
		std::vector<cfcore::ICFGenKbGelModifierObj*> matchesFound = readCachedGelModifierByGelCacheIdx( TenantId,
				GelCacheId );
		auto iterMatches = matchesFound.begin();
		auto endMatches = matchesFound.end();
		while( iterMatches != endMatches ) {
	...
	void CFGenKbGelModifierTableObj::deepDisposeByChainIdx( const int64_t* ChainInstTenantId,
			const int64_t* ChainInstGelCacheId,
			const int64_t* ChainInstGelInstId ) {
		static const std::string S_ProcName( "deepDisposeByChainIdx" );
		std::vector<cfcore::ICFGenKbGelModifierObj*> list;
		std::vector<cfcore::ICFGenKbGelModifierObj*> matchesFound = readCachedGelModifierByChainIdx( ChainInstTenantId,
				ChainInstGelCacheId,
				ChainInstGelInstId );
		auto iterMatches = matchesFound.begin();
		auto endMatches = matchesFound.end();
	...
	void CFGenKbGelModifierTableObj::reallyDeepDisposeGelModifier( cfcore::ICFGenKbGelModifierObj* Obj ) {
		static const std::string S_ProcName( "reallyDeepDisposeGelModifier" );
	...
	void CFGenKbGelModifierTableObj::deepDisposeByRemainderIdx( const int64_t* RemainderTenantId,
		...
		std::vector<cfcore::ICFGenKbGelModifierObj*> list;
		std::vector<cfcore::ICFGenKbGelModifierObj*> matchesFound = readCachedGelModifierByRemainderIdx( RemainderTenantId,
				RemainderGelCacheId,
				RemainderInstId );
		auto iterMatches = matchesFound.begin();
		auto endMatches = matchesFound.end();
	...
	cfcore::ICFGenKbGelModifierObj* CFGenKbGelModifierTableObj::createGelModifier( cfcore::ICFGenKbGelModifierEditObj* Obj ) {
		static const std::string S_ProcName( "createGelModifier" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Cloneable( "cloneable" );
		static const std::string S_ClonedBuff( "clonedbuff" );
		CFLIB_EXCEPTION_DECLINFO
		cfcore::ICFGenKbGelModifierObj* obj = dynamic_cast<cfcore::ICFGenKbGelModifierObj*>( Obj->getOrig() );
		try {
			cfcore::CFGenKbGelModifierBuff* buff = dynamic_cast<cfcore::CFGenKbGelModifierBuff*>( Obj->getBuff()->clone() );
			// C++18 version of create returns a new buffer instance and takes over ownership of the passed-in buffer
			// MSS TODO WORKING The xmsg client will need to return the buffer instance created by processing
			// the response message, while xmsg rqst will have to delete the backing store instance
			// it receives after preparing the reply message so that memory doesn't leak on every request.
			cflib::ICFLibCloneableObj* cloneable = dynamic_cast<ICFGenKbSchema*>( schema->getBackingStore() )->getTableGelModifier()->createGelModifier(
			...
			Obj->endEdit();
			obj->setBuff( dynamic_cast<cfcore::CFGenKbGelModifierBuff*>( cloneable ) );
			obj = dynamic_cast<cfcore::ICFGenKbGelModifierObj*>( obj->realize() );
			if( obj == NULL ) {
				throw cflib::CFLibNullArgumentException( CLASS_NAME,
					S_ProcName,
					0,
	...
	cfcore::ICFGenKbGelModifierObj* CFGenKbGelModifierTableObj::readGelModifier( cfcore::CFGenKbGelInstructionPKey* pkey, bool forceRead ) {
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		static const std::string S_ProcName( "readGelModifier" );
		cfcore::ICFGenKbGelModifierObj* obj = NULL;
		cfcore::ICFGenKbGelModifierObj* realized = NULL;
		if( ! forceRead ) {
			auto searchMembers = members->find( *pkey );
			if( searchMembers != members->end() ) {
		...
		if( forceRead || ( obj == NULL ) ) {
			cfcore::CFGenKbGelModifierBuff* readBuff = dynamic_cast<ICFGenKbSchema*>( schema->getBackingStore() )->getTableGelModifier()->readDerivedByPIdx( schema->getAuthorization(),
			pkey->getRequiredTenantId(),
			pkey->getRequiredGelCacheId(),
			pkey->getRequiredGelInstId() );
			if( readBuff != NULL ) {
			obj = dynamic_cast<cfcore::ICFGenKbGelModifierObj*>( dynamic_cast<cfcore::CFGenKbGelInstructionTableObj*>( schema->getGelInstructionTableObj() )->constructByClassCode( readBuff->getClassCode() ) );
				obj->setBuff( readBuff );
				realized = dynamic_cast<cfcore::ICFGenKbGelModifierObj*>( obj->realize() );
				if( realized == NULL ) {
					throw cflib::CFLibNullArgumentException( CLASS_NAME,
						S_ProcName,
						0,
	...
	cfcore::ICFGenKbGelModifierObj* CFGenKbGelModifierTableObj::lockGelModifier( cfcore::CFGenKbGelInstructionPKey* pkey ) {
		static const std::string S_ProcName( "lockGelModifier" );
		cfcore::ICFGenKbGelModifierObj* locked = NULL;
		cfcore::CFGenKbGelModifierBuff* lockBuff = dynamic_cast<ICFGenKbSchema*>( schema->getBackingStore() )->getTableGelModifier()->lockDerived( schema->getAuthorization(), pkey );
		if( lockBuff != NULL ) {
			locked = dynamic_cast<cfcore::ICFGenKbGelModifierObj*>( dynamic_cast<cfcore::CFGenKbGelInstructionTableObj*>( schema->getGelInstructionTableObj() )->constructByClassCode( lockBuff->getClassCode() ) );
			locked->setBuff( lockBuff );
			locked = dynamic_cast<cfcore::ICFGenKbGelModifierObj*>( locked->realize() );
		}
		else {
			return( NULL );
		}
	...
	std::vector<cfcore::ICFGenKbGelModifierObj*> CFGenKbGelModifierTableObj::readAllGelModifier( bool forceRead ) {
		static const std::string S_ProcName( "readAllGelModifier" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Realized( "realized" );
		CFLIB_EXCEPTION_DECLINFO
		cfcore::ICFGenKbGelModifierObj* realized = NULL;
		if( forceRead || ( allGelModifier == NULL ) ) {
			std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* map = new std::map<cfcore::CFGenKbGelInstructionPKey,cfcore::ICFGenKbGelModifierObj*>();
			allGelModifier = map;
			std::TCFLibOwningVector<cfcore::CFGenKbGelModifierBuff*> buffList = dynamic_cast<ICFGenKbSchema*>( schema->getBackingStore() )->getTableGelModifier()->readAllDerived( schema->getAuthorization() );
			cfcore::CFGenKbGelModifierBuff* buff = NULL;
			cfcore::ICFGenKbGelModifierObj* obj = NULL;
			try {
				for( size_t idx = 0; idx < buffList.size(); idx ++ ) {
					buff = buffList[ idx ];
					buffList[ idx ] = NULL;
				obj = dynamic_cast<cfcore::ICFGenKbGelModifierObj*>( dynamic_cast<cfcore::CFGenKbGelInstructionTableObj*>( schema->getGelInstructionTableObj() )->constructByClassCode( buff->getClassCode() ) );
					obj->setBuff( buff );
					realized = dynamic_cast<cfcore::ICFGenKbGelModifierObj*>( obj->realize() );
					if( realized == NULL ) {
						throw cflib::CFLibNullArgumentException( CLASS_NAME,
					...
					allGelModifier->insert( std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj* >::value_type( *(realized->getPKey()), realized ) );
					// No need to delete obj -- realize() auto-destructs the instance it decided to discard
					obj = NULL;
				}
			}
		...
		size_t len = allGelModifier->size();
		std::vector<cfcore::ICFGenKbGelModifierObj*> arr;
		auto valIter = allGelModifier->begin();
		size_t idx = 0;
		while( valIter != allGelModifier->end() ) {
	...
	cfcore::ICFGenKbGelModifierObj* CFGenKbGelModifierTableObj::readGelModifierByPIdx( const int64_t TenantId,
			const int64_t GelCacheId,
			const int64_t GelInstId, bool forceRead )
	{
		static const std::string S_ProcName( "readGelModifierByPIdx" );
		static const std::string S_Realized( "realized" );
		cfcore::CFGenKbGelInstructionPKey pkey;
		pkey.setRequiredTenantId( TenantId );
		pkey.setRequiredGelCacheId( GelCacheId );
		pkey.setRequiredGelInstId( GelInstId );
		cfcore::ICFGenKbGelModifierObj* obj = readGelModifier( &pkey, forceRead );
		return( obj );
	}

	std::vector<cfcore::ICFGenKbGelModifierObj*> CFGenKbGelModifierTableObj::readGelModifierByTenantIdx( const int64_t TenantId,
		bool forceRead )
	{
		static const std::string S_ProcName( "readGelModifierByTenantIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		cfcore::CFGenKbGelInstructionByTenantIdxKey key;
		key.setRequiredTenantId( TenantId );
		std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* dict;
		std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>* oldDict;
		if( indexByTenantIdx == NULL ) {
			indexByTenantIdx = new std::map< cfcore::CFGenKbGelInstructionByTenantIdxKey,
				std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>*>();
		}
		...
		if( ( oldDict != NULL ) && ( ! forceRead ) ) {
			...
			dict = new std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>();
			...
			for( size_t idx = 0; idx < buffList.size(); idx ++ ) {
				buff = buffList[ idx ];
				buffList[ idx ] = NULL;
				obj = dynamic_cast<cfcore::ICFGenKbGelModifierObj*>(
				...
				obj->setBuff( buff );
				cfcore::ICFGenKbGelModifierObj* realized = dynamic_cast<cfcore::ICFGenKbGelModifierObj*>( obj->realize() );
				if( realized == NULL ) {
					throw cflib::CFLibNullArgumentException( CLASS_NAME,
						S_ProcName,
						0,
				...
				dict->insert( std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj* >::value_type( *(realized->getPKey()), realized ) );
				// No need to delete obj -- realize() auto-destructs the instance it decided to discard
				obj = NULL;
			}
			if( oldDict != NULL ) {
			...
			indexByTenantIdx->insert( std::map< cfcore::CFGenKbGelInstructionByTenantIdxKey,
				std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj* >* >::value_type( key, dict ) );
		}
	...
	std::vector<cfcore::ICFGenKbGelModifierObj*> CFGenKbGelModifierTableObj::readGelModifierByGelCacheIdx( const int64_t TenantId,
			const int64_t GelCacheId,
		bool forceRead )
	{
		static const std::string S_ProcName( "readGelModifierByGelCacheIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
	...
	std::vector<cfcore::ICFGenKbGelModifierObj*> CFGenKbGelModifierTableObj::readGelModifierByChainIdx( const int64_t* ChainInstTenantId,
			const int64_t* ChainInstGelCacheId,
			const int64_t* ChainInstGelInstId,
		bool forceRead )
	{
		static const std::string S_ProcName( "readGelModifierByChainIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
	...
	std::vector<cfcore::ICFGenKbGelModifierObj*> CFGenKbGelModifierTableObj::readGelModifierByRemainderIdx( const int64_t* RemainderTenantId,
			const int64_t RemainderGelCacheId,
			const int64_t* RemainderInstId,
		bool forceRead )
	{
		static const std::string S_ProcName( "readGelModifierByRemainderIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		...
		if( ( oldDict != NULL ) && ( ! forceRead ) ) {
			...
			dict = new std::map<cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj*>();
			cfcore::ICFGenKbGelModifierObj* obj;
			std::TCFLibOwningVector<cfcore::CFGenKbGelModifierBuff*> buffList = dynamic_cast<ICFGenKbSchema*>( schema->getBackingStore() )->getTableGelModifier()->readDerivedByRemainderIdx( schema->getAuthorization(),
				RemainderTenantId,
				RemainderGelCacheId,
				RemainderInstId );
			...
			indexByRemainderIdx->insert( std::map< cfcore::CFGenKbGelModifierByRemainderIdxKey,
				std::map< cfcore::CFGenKbGelInstructionPKey, cfcore::ICFGenKbGelModifierObj* >* >::value_type( key, dict ) );
		}
		size_t len = dict->size();
		std::vector<cfcore::ICFGenKbGelModifierObj*> arr;
	...
	cfcore::ICFGenKbGelModifierObj* CFGenKbGelModifierTableObj::readCachedGelModifier( cfcore::CFGenKbGelInstructionPKey* pkey ) {
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		static const std::string S_ProcName( "readGelModifier" );
		cfcore::ICFGenKbGelModifierObj* obj = NULL;
	...
	cfcore::ICFGenKbGelModifierObj* CFGenKbGelModifierTableObj::readCachedGelModifierByPIdx( const int64_t TenantId,
			const int64_t GelCacheId,
			const int64_t GelInstId )
	{
		static const std::string S_ProcName( "readCachedGelModifierByPIdx" );
		static const std::string S_Realized( "realized" );
		cfcore::CFGenKbGelInstructionPKey pkey;
		pkey.setRequiredTenantId( TenantId );
		pkey.setRequiredGelCacheId( GelCacheId );
		pkey.setRequiredGelInstId( GelInstId );
		cfcore::ICFGenKbGelModifierObj* obj = readCachedGelModifier( &pkey );
		return( obj );
	}

	std::vector<cfcore::ICFGenKbGelModifierObj*> CFGenKbGelModifierTableObj::readCachedGelModifierByTenantIdx( const int64_t TenantId )
	{
		static const std::string S_ProcName( "readCachedGelModifierByTenantIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		std::vector<cfcore::ICFGenKbGelModifierObj*> arr;
	...
	std::vector<cfcore::ICFGenKbGelModifierObj*> CFGenKbGelModifierTableObj::readCachedGelModifierByGelCacheIdx( const int64_t TenantId,
			const int64_t GelCacheId )
	{
		static const std::string S_ProcName( "readCachedGelModifierByGelCacheIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		std::vector<cfcore::ICFGenKbGelModifierObj*> arr;
	...
	std::vector<cfcore::ICFGenKbGelModifierObj*> CFGenKbGelModifierTableObj::readCachedGelModifierByChainIdx( const int64_t* ChainInstTenantId,
			const int64_t* ChainInstGelCacheId,
			const int64_t* ChainInstGelInstId )
	{
		static const std::string S_ProcName( "readCachedGelModifierByChainIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		std::vector<cfcore::ICFGenKbGelModifierObj*> arr;
	...
	std::vector<cfcore::ICFGenKbGelModifierObj*> CFGenKbGelModifierTableObj::readCachedGelModifierByRemainderIdx( const int64_t* RemainderTenantId,
			const int64_t RemainderGelCacheId,
			const int64_t* RemainderInstId )
	{
		static const std::string S_ProcName( "readCachedGelModifierByRemainderIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		std::vector<cfcore::ICFGenKbGelModifierObj*> arr;
		...
		if( searchIndexByRemainderIdx != indexByRemainderIdx->end() ) {
			...
			for( auto iterMembers = members->begin(); iterMembers != members->end(); iterMembers ++ ) {
				obj = iterMembers->second;
				if( obj != NULL ) {
					if( *(dynamic_cast<cfcore::CFGenKbGelModifierBuff*>( obj->getBuff() ) ) == key ) {
						arr.push_back( obj );
					}
				}
			}
	...
	cfcore::ICFGenKbGelModifierObj* CFGenKbGelModifierTableObj::updateGelModifier( cfcore::ICFGenKbGelModifierEditObj* Obj ) {
		...
		cfcore::ICFGenKbGelModifierObj* obj = dynamic_cast<cfcore::ICFGenKbGelModifierObj*>( Obj->getOrig() );
		try {
			cfcore::CFGenKbGelModifierBuff* updated = dynamic_cast<ICFGenKbSchema*>( schema->getBackingStore() )->getTableGelModifier()->updateGelModifier( schema->getAuthorization(),
				dynamic_cast<cfcore::CFGenKbGelModifierBuff*>( Obj->getGelModifierBuff()->clone() ) );
			if( updated == NULL ) {
				throw cflib::CFLibNullArgumentException( CLASS_NAME,
					S_ProcName,
					0,
			...
			obj = dynamic_cast<cfcore::ICFGenKbGelModifierObj*>( dynamic_cast<cfcore::CFGenKbGelModifierTableObj*>( schema->getGelModifierTableObj() )->newInstance() );
			obj->setBuff( updated );
			obj = dynamic_cast<cfcore::ICFGenKbGelModifierObj*>( obj->realize() );
			if( obj == NULL ) {
				throw cflib::CFLibNullArgumentException( CLASS_NAME,
	...
	void CFGenKbGelModifierTableObj::deleteGelModifier( cfcore::ICFGenKbGelModifierEditObj* Obj ) {
		cfcore::ICFGenKbGelModifierObj* obj = Obj;
		dynamic_cast<ICFGenKbSchema*>( schema->getBackingStore() )->getTableGelModifier()->deleteGelModifier( schema->getAuthorization(),
	...
	void CFGenKbGelModifierTableObj::deleteGelModifierByPIdx( const int64_t TenantId,
			const int64_t GelCacheId,
			const int64_t GelInstId )
	{
		cfcore::CFGenKbGelInstructionPKey pkey;
		...
		pkey.setRequiredGelCacheId( GelCacheId );
		pkey.setRequiredGelInstId( GelInstId );
		cfcore::ICFGenKbGelModifierObj* obj = readGelModifier( &pkey, true );
		if( obj != NULL ) {
			cfcore::ICFGenKbGelModifierEditObj* editObj = dynamic_cast<cfcore::ICFGenKbGelModifierEditObj*>( obj->getEdit() );
			if( editObj == NULL ) {
				editObj = dynamic_cast<cfcore::ICFGenKbGelModifierEditObj*>( obj->beginEdit() );
			}
			if( editObj != NULL ) {
	...
	void CFGenKbGelModifierTableObj::deleteGelModifierByTenantIdx( const int64_t TenantId )
	{
		dynamic_cast<cfcore::ICFGenKbSchema*>( schema->getBackingStore() )->getTableGelModifier()->deleteGelModifierByTenantIdx( schema->getAuthorization(),
				TenantId );
		deepDisposeByTenantIdx( TenantId );
	}

	void CFGenKbGelModifierTableObj::deleteGelModifierByGelCacheIdx( const int64_t TenantId,
			const int64_t GelCacheId )
	{
		dynamic_cast<cfcore::ICFGenKbSchema*>( schema->getBackingStore() )->getTableGelModifier()->deleteGelModifierByGelCacheIdx( schema->getAuthorization(),
				TenantId,
				GelCacheId );
	...
	void CFGenKbGelModifierTableObj::deleteGelModifierByChainIdx( const int64_t* ChainInstTenantId,
			const int64_t* ChainInstGelCacheId,
			const int64_t* ChainInstGelInstId )
	{
		dynamic_cast<cfcore::ICFGenKbSchema*>( schema->getBackingStore() )->getTableGelModifier()->deleteGelModifierByChainIdx( schema->getAuthorization(),
				ChainInstTenantId,
				ChainInstGelCacheId,
				ChainInstGelInstId );
	...
	void CFGenKbGelModifierTableObj::deleteGelModifierByRemainderIdx( const int64_t* RemainderTenantId,
			const int64_t RemainderGelCacheId,
			const int64_t* RemainderInstId )
	{
		dynamic_cast<cfcore::ICFGenKbSchema*>( schema->getBackingStore() )->getTableGelModifier()->deleteGelModifierByRemainderIdx( schema->getAuthorization(),
				RemainderTenantId,
				RemainderGelCacheId,
				RemainderInstId );
	...
	void CFGenKbGelModifierTableObj::reallyDetachFromIndexesGelModifier( cfcore::ICFGenKbGelModifierObj* Obj ) {
		static const std::string S_ProcName( "reallyDetachFromIndexesGelModifier" );
		static const std::string S_Obj( "Obj" );
		static const std::string S_ExistingObj( "ExistingObj" );
		if( Obj == NULL ) {
			throw cflib::CFLibNullArgumentException( CLASS_NAME, S_ProcName, 1, S_Obj );
		...
		auto searchMembers = members->find( *pkey );
		if( searchMembers != members->end() ) {
			cfcore::ICFGenKbGelModifierObj* existingObj = searchMembers->second;
			if( existingObj == NULL ) {
				throw cflib::CFLibNullArgumentException( CLASS_NAME,
					S_ProcName,
					0,
