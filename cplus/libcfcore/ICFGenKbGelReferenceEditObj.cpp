// Description: C++18 Instance Edit Object interface implementation for CFGenKb GelReference.
...
namespace cfcore {
	...
	const std::string ICFGenKbGelReferenceEditObj::CLASS_NAME( "ICFGenKbGelReferenceEditObj" );

	ICFGenKbGelReferenceEditObj::ICFGenKbGelReferenceEditObj()
