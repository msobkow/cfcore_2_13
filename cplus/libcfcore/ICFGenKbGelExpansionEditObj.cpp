// Description: C++18 Instance Edit Object interface implementation for CFGenKb GelExpansion.
...
namespace cfcore {
	...
	const std::string ICFGenKbGelExpansionEditObj::CLASS_NAME( "ICFGenKbGelExpansionEditObj" );

	ICFGenKbGelExpansionEditObj::ICFGenKbGelExpansionEditObj()
