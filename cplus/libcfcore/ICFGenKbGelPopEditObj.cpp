// Description: C++18 Instance Edit Object interface implementation for CFGenKb GelPop.
...
namespace cfcore {
	...
	const std::string ICFGenKbGelPopEditObj::CLASS_NAME( "ICFGenKbGelPopEditObj" );

	ICFGenKbGelPopEditObj::ICFGenKbGelPopEditObj()
