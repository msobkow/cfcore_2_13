...
namespace cfcore {
	...
	const std::string CFGenKbGenTruncTableObj::CLASS_NAME( "CFGenKbGenTruncTableObj" );
	const std::string CFGenKbGenTruncTableObj::TABLE_NAME( "GenTrunc" );
	const std::string CFGenKbGenTruncTableObj::TABLE_DBNAME( "kbgentrunc" );

	CFGenKbGenTruncTableObj::CFGenKbGenTruncTableObj() {
		schema = NULL;
		members = new std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>();
		allGenTrunc = NULL;
		indexByTenantIdx = new std::map< cfcore::CFGenKbGenItemByTenantIdxKey,
			std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>*>();
	...
	CFGenKbGenTruncTableObj::CFGenKbGenTruncTableObj( cfcore::ICFGenKbSchemaObj* argSchema ) {
	...
	cfcore::ICFGenKbSchemaObj* CFGenKbGenTruncTableObj::getSchema() {
		return( schema );
	}

	void CFGenKbGenTruncTableObj::setSchema( cfcore::ICFGenKbSchemaObj* value ) {
		schema = dynamic_cast<cfcore::ICFGenKbSchemaObj*>( value );
	}

	const std::string CFGenKbGenTruncTableObj::getTableName() {
		return( TABLE_NAME );
	}

	const std::string CFGenKbGenTruncTableObj::getTableDbName() {
		return( TABLE_DBNAME );
	}
	const classcode_t* CFGenKbGenTruncTableObj::getObjQualifyingClassCode() {
		return( NULL );
	}


	void CFGenKbGenTruncTableObj::minimizeMemory() {
		if( allGenTrunc != NULL ) {
			allGenTrunc->clear();
			delete allGenTrunc;
			allGenTrunc = NULL;
		...
		if( indexByTenantIdx != NULL ) {
			std::map< cfcore::CFGenKbGenItemByTenantIdxKey,
				std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* >::iterator iterByTenantIdx = indexByTenantIdx->begin();
			std::map< cfcore::CFGenKbGenItemByTenantIdxKey,
				std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* >::iterator endByTenantIdx = indexByTenantIdx->end();
			std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* curByTenantIdx = NULL;
		...
		if( indexByCartIdx != NULL ) {
			std::map< cfcore::CFGenKbGenItemByCartIdxKey,
				std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* >::iterator iterByCartIdx = indexByCartIdx->begin();
			std::map< cfcore::CFGenKbGenItemByCartIdxKey,
				std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* >::iterator endByCartIdx = indexByCartIdx->end();
			std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* curByCartIdx = NULL;
		...
		if( indexByRuleTypeIdx != NULL ) {
			std::map< cfcore::CFGenKbGenItemByRuleTypeIdxKey,
				std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* >::iterator iterByRuleTypeIdx = indexByRuleTypeIdx->begin();
			std::map< cfcore::CFGenKbGenItemByRuleTypeIdxKey,
				std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* >::iterator endByRuleTypeIdx = indexByRuleTypeIdx->end();
			std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* curByRuleTypeIdx = NULL;
		...
		if( indexByToolSetIdx != NULL ) {
			std::map< cfcore::CFGenKbGenItemByToolSetIdxKey,
				std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* >::iterator iterByToolSetIdx = indexByToolSetIdx->begin();
			std::map< cfcore::CFGenKbGenItemByToolSetIdxKey,
				std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* >::iterator endByToolSetIdx = indexByToolSetIdx->end();
			std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* curByToolSetIdx = NULL;
		...
		if( indexByScopeIdx != NULL ) {
			std::map< cfcore::CFGenKbGenItemByScopeIdxKey,
				std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* >::iterator iterByScopeIdx = indexByScopeIdx->begin();
			std::map< cfcore::CFGenKbGenItemByScopeIdxKey,
				std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* >::iterator endByScopeIdx = indexByScopeIdx->end();
			std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* curByScopeIdx = NULL;
		...
		if( indexByGenDefIdx != NULL ) {
			std::map< cfcore::CFGenKbGenItemByGenDefIdxKey,
				std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* >::iterator iterByGenDefIdx = indexByGenDefIdx->begin();
			std::map< cfcore::CFGenKbGenItemByGenDefIdxKey,
				std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* >::iterator endByGenDefIdx = indexByGenDefIdx->end();
			std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* curByGenDefIdx = NULL;
		...
		if( indexByGelExecIdx != NULL ) {
			std::map< cfcore::CFGenKbGenItemByGelExecIdxKey,
				std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* >::iterator iterByGelExecIdx = indexByGelExecIdx->begin();
			std::map< cfcore::CFGenKbGenItemByGelExecIdxKey,
				std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* >::iterator endByGelExecIdx = indexByGelExecIdx->end();
			std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* curByGelExecIdx = NULL;
		...
		if( indexByProbeIdx != NULL ) {
			std::map< cfcore::CFGenKbGenItemByProbeIdxKey,
				std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* >::iterator iterByProbeIdx = indexByProbeIdx->begin();
			std::map< cfcore::CFGenKbGenItemByProbeIdxKey,
				std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* >::iterator endByProbeIdx = indexByProbeIdx->end();
			std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* curByProbeIdx = NULL;
		...
		if( indexByBodyIdx != NULL ) {
			std::map< cfcore::CFGenKbGenRuleByBodyIdxKey,
				std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* >::iterator iterByBodyIdx = indexByBodyIdx->begin();
			std::map< cfcore::CFGenKbGenRuleByBodyIdxKey,
				std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* >::iterator endByBodyIdx = indexByBodyIdx->end();
			std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* curByBodyIdx = NULL;
	...
	cfcore::ICFGenKbGenTruncObj* CFGenKbGenTruncTableObj::newInstance() {
		cfcore::ICFGenKbGenTruncObj* inst = dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( new CFGenKbGenTruncObj( schema ) );
		return( inst );
	}

	cfcore::ICFGenKbGenTruncEditObj* CFGenKbGenTruncTableObj::newEditInstance( cfcore::ICFGenKbGenTruncObj* orig ) {
		cfcore::ICFGenKbGenTruncEditObj* edit = dynamic_cast<cfcore::ICFGenKbGenTruncEditObj*>( new CFGenKbGenTruncEditObj( orig ));
		return( edit );
	}

	cfcore::ICFGenKbGenTruncObj* CFGenKbGenTruncTableObj::realizeGenTrunc( cfcore::ICFGenKbGenTruncObj* Obj ) {
		static const std::string S_ProcName( "realizeGenTrunc" );
		...
		cfcore::ICFGenKbGenTruncObj* obj = Obj;
		cfcore::ICFGenKbGenTruncObj* existingObj = NULL;
		cfcore::CFGenKbGenItemPKey* pkey = obj->getPKey();
		cfcore::ICFGenKbGenTruncObj* keepObj = NULL;
		...
		if( searchMembers != members->end() ) {
			...
			if( indexByTenantIdx != NULL ) {
				...
				if( searchTenantIdx != indexByTenantIdx->end() ) {
					std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* mapTenantIdx = searchTenantIdx->second;
			...
			if( indexByCartIdx != NULL ) {
				...
				if( searchCartIdx != indexByCartIdx->end() ) {
					std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* mapCartIdx = searchCartIdx->second;
					if( mapCartIdx != NULL ) {
			...
			if( indexByRuleTypeIdx != NULL ) {
				...
				if( searchRuleTypeIdx != indexByRuleTypeIdx->end() ) {
					std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* mapRuleTypeIdx = searchRuleTypeIdx->second;
			...
			if( indexByToolSetIdx != NULL ) {
				...
				if( searchToolSetIdx != indexByToolSetIdx->end() ) {
					std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* mapToolSetIdx = searchToolSetIdx->second;
			...
			if( indexByScopeIdx != NULL ) {
				...
				if( searchScopeIdx != indexByScopeIdx->end() ) {
					std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* mapScopeIdx = searchScopeIdx->second;
					if( mapScopeIdx != NULL ) {
			...
			if( indexByGenDefIdx != NULL ) {
				...
				if( searchGenDefIdx != indexByGenDefIdx->end() ) {
					std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* mapGenDefIdx = searchGenDefIdx->second;
			...
			if( indexByGelExecIdx != NULL ) {
				...
				if( searchGelExecIdx != indexByGelExecIdx->end() ) {
					std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* mapGelExecIdx = searchGelExecIdx->second;
			...
			if( indexByProbeIdx != NULL ) {
				...
				if( searchProbeIdx != indexByProbeIdx->end() ) {
					std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* mapProbeIdx = searchProbeIdx->second;
					if( mapProbeIdx != NULL ) {
			...
			if( indexByBodyIdx != NULL ) {
				...
				if( searchBodyIdx != indexByBodyIdx->end() ) {
					std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* mapBodyIdx = searchBodyIdx->second;
					if( mapBodyIdx != NULL ) {
			...
			keepObj = dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( dynamic_cast<cfcore::CFGenKbGenRuleTableObj*>( schema->getGenRuleTableObj() )->realizeGenRule( Obj ) );
			if( keepObj == NULL ) {
				throw cflib::CFLibNullArgumentException( CLASS_NAME,
					S_ProcName,
					0,
			...
			if( indexByTenantIdx != NULL ) {
				...
				cfcore::ICFGenKbGenTruncObj* aTenantIdxObj =
					dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( keepObj );
				...
				if( searchIndexByTenantIdx != indexByTenantIdx->end() ) {
					std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* mapTenantIdx = searchIndexByTenantIdx->second;
					if( mapTenantIdx != NULL ) {
						mapTenantIdx->insert( std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj* >::value_type( *(keepObj->getPKey()), aTenantIdxObj ) );
					}
				}
			}
			...
			if( indexByCartIdx != NULL ) {
				...
				cfcore::ICFGenKbGenTruncObj* aCartIdxObj =
					dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( keepObj );
				if( aCartIdxObj == NULL ) {
					throw cflib::CFLibNullArgumentException( CLASS_NAME,
						S_ProcName,
				...
				if( searchIndexByCartIdx != indexByCartIdx->end() ) {
					std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* mapCartIdx = searchIndexByCartIdx->second;
					if( mapCartIdx != NULL ) {
						mapCartIdx->insert( std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj* >::value_type( *(keepObj->getPKey()), aCartIdxObj ) );
					}
				}
			}
			...
			if( indexByRuleTypeIdx != NULL ) {
				...
				cfcore::ICFGenKbGenTruncObj* aRuleTypeIdxObj =
					dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( keepObj );
				...
				if( searchIndexByRuleTypeIdx != indexByRuleTypeIdx->end() ) {
					std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* mapRuleTypeIdx = searchIndexByRuleTypeIdx->second;
					if( mapRuleTypeIdx != NULL ) {
						mapRuleTypeIdx->insert( std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj* >::value_type( *(keepObj->getPKey()), aRuleTypeIdxObj ) );
					}
				}
			}
			...
			if( indexByToolSetIdx != NULL ) {
				...
				cfcore::ICFGenKbGenTruncObj* aToolSetIdxObj =
					dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( keepObj );
				...
				if( searchIndexByToolSetIdx != indexByToolSetIdx->end() ) {
					std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* mapToolSetIdx = searchIndexByToolSetIdx->second;
					if( mapToolSetIdx != NULL ) {
						mapToolSetIdx->insert( std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj* >::value_type( *(keepObj->getPKey()), aToolSetIdxObj ) );
					}
				}
			}
			...
			if( indexByScopeIdx != NULL ) {
				...
				cfcore::ICFGenKbGenTruncObj* aScopeIdxObj =
					dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( keepObj );
				...
				if( searchIndexByScopeIdx != indexByScopeIdx->end() ) {
					std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* mapScopeIdx = searchIndexByScopeIdx->second;
					if( mapScopeIdx != NULL ) {
						mapScopeIdx->insert( std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj* >::value_type( *(keepObj->getPKey()), aScopeIdxObj ) );
					}
				}
			}
			...
			if( indexByGenDefIdx != NULL ) {
				...
				cfcore::ICFGenKbGenTruncObj* aGenDefIdxObj =
					dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( keepObj );
				...
				if( searchIndexByGenDefIdx != indexByGenDefIdx->end() ) {
					std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* mapGenDefIdx = searchIndexByGenDefIdx->second;
					if( mapGenDefIdx != NULL ) {
						mapGenDefIdx->insert( std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj* >::value_type( *(keepObj->getPKey()), aGenDefIdxObj ) );
					}
				}
			}
			...
			if( indexByAltIdx != NULL ) {
				...
				cfcore::ICFGenKbGenTruncObj* aAltIdxObj =
					dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( keepObj );
				if( aAltIdxObj == NULL ) {
					throw cflib::CFLibNullArgumentException( CLASS_NAME,
						S_ProcName,
				...
				keyAltIdx.setRequiredGenDefId( keepObj->getRequiredGenDefId() );
				indexByAltIdx->insert( std::map< cfcore::CFGenKbGenItemByAltIdxKey, cfcore::ICFGenKbGenTruncObj* >::value_type( keyAltIdx, aAltIdxObj ) );
			}

			if( indexByGelExecIdx != NULL ) {
				static const std::string S_AGelExecIdxObj( "aGelExecIdxObj" );
				cfcore::ICFGenKbGenTruncObj* aGelExecIdxObj =
					dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( keepObj );
				...
				if( searchIndexByGelExecIdx != indexByGelExecIdx->end() ) {
					std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* mapGelExecIdx = searchIndexByGelExecIdx->second;
					if( mapGelExecIdx != NULL ) {
						mapGelExecIdx->insert( std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj* >::value_type( *(keepObj->getPKey()), aGelExecIdxObj ) );
					}
				}
			}
			...
			if( indexByProbeIdx != NULL ) {
				...
				cfcore::ICFGenKbGenTruncObj* aProbeIdxObj =
					dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( keepObj );
				...
				if( searchIndexByProbeIdx != indexByProbeIdx->end() ) {
					std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* mapProbeIdx = searchIndexByProbeIdx->second;
					if( mapProbeIdx != NULL ) {
						mapProbeIdx->insert( std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj* >::value_type( *(keepObj->getPKey()), aProbeIdxObj ) );
					}
				}
			}
			...
			if( indexByBodyIdx != NULL ) {
				...
				cfcore::ICFGenKbGenTruncObj* aBodyIdxObj =
					dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( keepObj );
				if( aBodyIdxObj == NULL ) {
					throw cflib::CFLibNullArgumentException( CLASS_NAME,
						S_ProcName,
				...
				if( searchIndexByBodyIdx != indexByBodyIdx->end() ) {
					std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* mapBodyIdx = searchIndexByBodyIdx->second;
					if( mapBodyIdx != NULL ) {
						mapBodyIdx->insert( std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj* >::value_type( *(keepObj->getPKey()), aBodyIdxObj ) );
					}
				}
			}

			if( allGenTrunc != NULL ) {
				allGenTrunc->insert( std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj* >::value_type( *(keepObj->getPKey()), keepObj ) );
			}
		}
		else {
			keepObj = obj;
			...
			members->insert( std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj* >::value_type( *(keepObj->getPKey()), keepObj ) );
	...
	void CFGenKbGenTruncTableObj::deepDisposeByItemIdIdx( const int64_t TenantId,
			const int64_t CartridgeId,
			const int64_t ItemId ) {
		static const std::string S_ProcName( "deepDisposeByItemIdIdx" );
		std::vector<cfcore::ICFGenKbGenTruncObj*> list;
		cfcore::ICFGenKbGenTruncObj* existingObj = readCachedGenTruncByItemIdIdx( TenantId,
				CartridgeId,
				ItemId );
		if( existingObj != NULL ) {
			list.push_back( existingObj );
		}
		cfcore::ICFGenKbGenTruncObj* cur = NULL;
		...
		while( listIter != listEnd ) {
			...
			if( cur != NULL ) {
				...
				if( classCode == cfcore::CFGenKbGenTruncBuff::CLASS_CODE ) {
	...
	void CFGenKbGenTruncTableObj::deepDisposeByTenantIdx( const int64_t TenantId ) {
		static const std::string S_ProcName( "deepDisposeByTenantIdx" );
		std::vector<cfcore::ICFGenKbGenTruncObj*> list;
		std::vector<cfcore::ICFGenKbGenTruncObj*> matchesFound = readCachedGenTruncByTenantIdx( TenantId );
	...
	void CFGenKbGenTruncTableObj::deepDisposeByCartIdx( const int64_t TenantId,
			const int64_t CartridgeId ) {
		static const std::string S_ProcName( "deepDisposeByCartIdx" );
		std::vector<cfcore::ICFGenKbGenTruncObj*> list;
		std::vector<cfcore::ICFGenKbGenTruncObj*> matchesFound = readCachedGenTruncByCartIdx( TenantId,
				CartridgeId );
		auto iterMatches = matchesFound.begin();
		auto endMatches = matchesFound.end();
		while( iterMatches != endMatches ) {
	...
	void CFGenKbGenTruncTableObj::deepDisposeByRuleTypeIdx( const int16_t RuleTypeId ) {
		static const std::string S_ProcName( "deepDisposeByRuleTypeIdx" );
		std::vector<cfcore::ICFGenKbGenTruncObj*> list;
		std::vector<cfcore::ICFGenKbGenTruncObj*> matchesFound = readCachedGenTruncByRuleTypeIdx( RuleTypeId );
		auto iterMatches = matchesFound.begin();
		auto endMatches = matchesFound.end();
		while( iterMatches != endMatches ) {
			if( *iterMatches != NULL ) {
	...
	void CFGenKbGenTruncTableObj::deepDisposeByToolSetIdx( const int16_t ToolSetId ) {
		static const std::string S_ProcName( "deepDisposeByToolSetIdx" );
		std::vector<cfcore::ICFGenKbGenTruncObj*> list;
		std::vector<cfcore::ICFGenKbGenTruncObj*> matchesFound = readCachedGenTruncByToolSetIdx( ToolSetId );
		auto iterMatches = matchesFound.begin();
		auto endMatches = matchesFound.end();
		while( iterMatches != endMatches ) {
			if( *iterMatches != NULL ) {
	...
	void CFGenKbGenTruncTableObj::deepDisposeByScopeIdx( const int16_t* ScopeDefId ) {
		static const std::string S_ProcName( "deepDisposeByScopeIdx" );
		std::vector<cfcore::ICFGenKbGenTruncObj*> list;
		std::vector<cfcore::ICFGenKbGenTruncObj*> matchesFound = readCachedGenTruncByScopeIdx( ScopeDefId );
		auto iterMatches = matchesFound.begin();
		auto endMatches = matchesFound.end();
		while( iterMatches != endMatches ) {
			if( *iterMatches != NULL ) {
	...
	void CFGenKbGenTruncTableObj::deepDisposeByGenDefIdx( const int16_t GenDefId ) {
		static const std::string S_ProcName( "deepDisposeByGenDefIdx" );
		std::vector<cfcore::ICFGenKbGenTruncObj*> list;
		std::vector<cfcore::ICFGenKbGenTruncObj*> matchesFound = readCachedGenTruncByGenDefIdx( GenDefId );
		auto iterMatches = matchesFound.begin();
		auto endMatches = matchesFound.end();
		while( iterMatches != endMatches ) {
			if( *iterMatches != NULL ) {
	...
	void CFGenKbGenTruncTableObj::deepDisposeByAltIdx( const std::string& Name,
		...
		std::vector<cfcore::ICFGenKbGenTruncObj*> list;
		cfcore::ICFGenKbGenTruncObj* existingObj = readCachedGenTruncByAltIdx( Name,
				ToolSetId,
				ScopeDefId,
				GenDefId );
		if( existingObj != NULL ) {
	...
	void CFGenKbGenTruncTableObj::deepDisposeByGelExecIdx( const int64_t* GelExecutableTenantId,
		...
		std::vector<cfcore::ICFGenKbGenTruncObj*> list;
		std::vector<cfcore::ICFGenKbGenTruncObj*> matchesFound = readCachedGenTruncByGelExecIdx( GelExecutableTenantId,
	...
	void CFGenKbGenTruncTableObj::deepDisposeByProbeIdx( const int64_t* ProbeTenantId,
			const int64_t* ProbeCartridgeId,
			const int64_t* ProbeGenItemId ) {
		static const std::string S_ProcName( "deepDisposeByProbeIdx" );
		std::vector<cfcore::ICFGenKbGenTruncObj*> list;
		std::vector<cfcore::ICFGenKbGenTruncObj*> matchesFound = readCachedGenTruncByProbeIdx( ProbeTenantId,
				ProbeCartridgeId,
				ProbeGenItemId );
		auto iterMatches = matchesFound.begin();
		auto endMatches = matchesFound.end();
	...
	void CFGenKbGenTruncTableObj::reallyDeepDisposeGenTrunc( cfcore::ICFGenKbGenTruncObj* Obj ) {
		static const std::string S_ProcName( "reallyDeepDisposeGenTrunc" );
	...
	void CFGenKbGenTruncTableObj::deepDisposeByBodyIdx( const int64_t* BodyTenantId,
			const int64_t* BodyGelCacheId,
			const int64_t* BodyGelId ) {
		static const std::string S_ProcName( "deepDisposeByBodyIdx" );
		std::vector<cfcore::ICFGenKbGenTruncObj*> list;
		std::vector<cfcore::ICFGenKbGenTruncObj*> matchesFound = readCachedGenTruncByBodyIdx( BodyTenantId,
				BodyGelCacheId,
				BodyGelId );
		auto iterMatches = matchesFound.begin();
		auto endMatches = matchesFound.end();
	...
	cfcore::ICFGenKbGenTruncObj* CFGenKbGenTruncTableObj::createGenTrunc( cfcore::ICFGenKbGenTruncEditObj* Obj ) {
		static const std::string S_ProcName( "createGenTrunc" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Cloneable( "cloneable" );
		static const std::string S_ClonedBuff( "clonedbuff" );
		CFLIB_EXCEPTION_DECLINFO
		cfcore::ICFGenKbGenTruncObj* obj = dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( Obj->getOrig() );
		try {
			cfcore::CFGenKbGenTruncBuff* buff = dynamic_cast<cfcore::CFGenKbGenTruncBuff*>( Obj->getBuff()->clone() );
			// C++18 version of create returns a new buffer instance and takes over ownership of the passed-in buffer
			// MSS TODO WORKING The xmsg client will need to return the buffer instance created by processing
			// the response message, while xmsg rqst will have to delete the backing store instance
			// it receives after preparing the reply message so that memory doesn't leak on every request.
			cflib::ICFLibCloneableObj* cloneable = dynamic_cast<ICFGenKbSchema*>( schema->getBackingStore() )->getTableGenTrunc()->createGenTrunc(
			...
			Obj->endEdit();
			obj->setBuff( dynamic_cast<cfcore::CFGenKbGenTruncBuff*>( cloneable ) );
			obj = dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( obj->realize() );
			if( obj == NULL ) {
				throw cflib::CFLibNullArgumentException( CLASS_NAME,
					S_ProcName,
					0,
	...
	cfcore::ICFGenKbGenTruncObj* CFGenKbGenTruncTableObj::readGenTrunc( cfcore::CFGenKbGenItemPKey* pkey, bool forceRead ) {
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		static const std::string S_ProcName( "readGenTrunc" );
		cfcore::ICFGenKbGenTruncObj* obj = NULL;
		cfcore::ICFGenKbGenTruncObj* realized = NULL;
		if( ! forceRead ) {
			auto searchMembers = members->find( *pkey );
			if( searchMembers != members->end() ) {
		...
		if( forceRead || ( obj == NULL ) ) {
			cfcore::CFGenKbGenTruncBuff* readBuff = dynamic_cast<ICFGenKbSchema*>( schema->getBackingStore() )->getTableGenTrunc()->readDerivedByItemIdIdx( schema->getAuthorization(),
			pkey->getRequiredTenantId(),
			pkey->getRequiredCartridgeId(),
			pkey->getRequiredItemId() );
			if( readBuff != NULL ) {
			obj = dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( dynamic_cast<cfcore::CFGenKbGenItemTableObj*>( schema->getGenItemTableObj() )->constructByClassCode( readBuff->getClassCode() ) );
				obj->setBuff( readBuff );
				realized = dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( obj->realize() );
				if( realized == NULL ) {
					throw cflib::CFLibNullArgumentException( CLASS_NAME,
						S_ProcName,
						0,
	...
	cfcore::ICFGenKbGenTruncObj* CFGenKbGenTruncTableObj::lockGenTrunc( cfcore::CFGenKbGenItemPKey* pkey ) {
		static const std::string S_ProcName( "lockGenTrunc" );
		cfcore::ICFGenKbGenTruncObj* locked = NULL;
		cfcore::CFGenKbGenTruncBuff* lockBuff = dynamic_cast<ICFGenKbSchema*>( schema->getBackingStore() )->getTableGenTrunc()->lockDerived( schema->getAuthorization(), pkey );
		if( lockBuff != NULL ) {
			locked = dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( dynamic_cast<cfcore::CFGenKbGenItemTableObj*>( schema->getGenItemTableObj() )->constructByClassCode( lockBuff->getClassCode() ) );
			locked->setBuff( lockBuff );
			locked = dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( locked->realize() );
		}
		else {
			return( NULL );
		}
	...
	std::vector<cfcore::ICFGenKbGenTruncObj*> CFGenKbGenTruncTableObj::readAllGenTrunc( bool forceRead ) {
		static const std::string S_ProcName( "readAllGenTrunc" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Realized( "realized" );
		CFLIB_EXCEPTION_DECLINFO
		cfcore::ICFGenKbGenTruncObj* realized = NULL;
		if( forceRead || ( allGenTrunc == NULL ) ) {
			std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* map = new std::map<cfcore::CFGenKbGenItemPKey,cfcore::ICFGenKbGenTruncObj*>();
			allGenTrunc = map;
			std::TCFLibOwningVector<cfcore::CFGenKbGenTruncBuff*> buffList = dynamic_cast<ICFGenKbSchema*>( schema->getBackingStore() )->getTableGenTrunc()->readAllDerived( schema->getAuthorization() );
			cfcore::CFGenKbGenTruncBuff* buff = NULL;
			cfcore::ICFGenKbGenTruncObj* obj = NULL;
			try {
				for( size_t idx = 0; idx < buffList.size(); idx ++ ) {
					buff = buffList[ idx ];
					buffList[ idx ] = NULL;
				obj = dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( dynamic_cast<cfcore::CFGenKbGenItemTableObj*>( schema->getGenItemTableObj() )->constructByClassCode( buff->getClassCode() ) );
					obj->setBuff( buff );
					realized = dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( obj->realize() );
					if( realized == NULL ) {
						throw cflib::CFLibNullArgumentException( CLASS_NAME,
					...
					allGenTrunc->insert( std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj* >::value_type( *(realized->getPKey()), realized ) );
					// No need to delete obj -- realize() auto-destructs the instance it decided to discard
					obj = NULL;
				}
			}
		...
		size_t len = allGenTrunc->size();
		std::vector<cfcore::ICFGenKbGenTruncObj*> arr;
		auto valIter = allGenTrunc->begin();
		size_t idx = 0;
		while( valIter != allGenTrunc->end() ) {
	...
	cfcore::ICFGenKbGenTruncObj* CFGenKbGenTruncTableObj::readGenTruncByItemIdIdx( const int64_t TenantId,
			const int64_t CartridgeId,
			const int64_t ItemId, bool forceRead )
	{
		static const std::string S_ProcName( "readGenTruncByItemIdIdx" );
		static const std::string S_Realized( "realized" );
		cfcore::CFGenKbGenItemPKey pkey;
		pkey.setRequiredTenantId( TenantId );
		pkey.setRequiredCartridgeId( CartridgeId );
		pkey.setRequiredItemId( ItemId );
		cfcore::ICFGenKbGenTruncObj* obj = readGenTrunc( &pkey, forceRead );
		return( obj );
	}

	std::vector<cfcore::ICFGenKbGenTruncObj*> CFGenKbGenTruncTableObj::readGenTruncByTenantIdx( const int64_t TenantId,
		bool forceRead )
	{
		static const std::string S_ProcName( "readGenTruncByTenantIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		cfcore::CFGenKbGenItemByTenantIdxKey key;
		key.setRequiredTenantId( TenantId );
		std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* dict;
		std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>* oldDict;
		if( indexByTenantIdx == NULL ) {
			indexByTenantIdx = new std::map< cfcore::CFGenKbGenItemByTenantIdxKey,
				std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>*>();
		}
		...
		if( ( oldDict != NULL ) && ( ! forceRead ) ) {
			...
			dict = new std::map<cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj*>();
			...
			for( size_t idx = 0; idx < buffList.size(); idx ++ ) {
				buff = buffList[ idx ];
				buffList[ idx ] = NULL;
				obj = dynamic_cast<cfcore::ICFGenKbGenTruncObj*>(
				...
				obj->setBuff( buff );
				cfcore::ICFGenKbGenTruncObj* realized = dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( obj->realize() );
				if( realized == NULL ) {
					throw cflib::CFLibNullArgumentException( CLASS_NAME,
						S_ProcName,
						0,
				...
				dict->insert( std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj* >::value_type( *(realized->getPKey()), realized ) );
				// No need to delete obj -- realize() auto-destructs the instance it decided to discard
				obj = NULL;
			}
			if( oldDict != NULL ) {
			...
			indexByTenantIdx->insert( std::map< cfcore::CFGenKbGenItemByTenantIdxKey,
				std::map< cfcore::CFGenKbGenItemPKey, cfcore::ICFGenKbGenTruncObj* >* >::value_type( key, dict ) );
		}
	...
	std::vector<cfcore::ICFGenKbGenTruncObj*> CFGenKbGenTruncTableObj::readGenTruncByCartIdx( const int64_t TenantId,
			const int64_t CartridgeId,
		bool forceRead )
	{
		static const std::string S_ProcName( "readGenTruncByCartIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
	...
	std::vector<cfcore::ICFGenKbGenTruncObj*> CFGenKbGenTruncTableObj::readGenTruncByRuleTypeIdx( const int16_t RuleTypeId,
		bool forceRead )
	{
		static const std::string S_ProcName( "readGenTruncByRuleTypeIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
	...
	std::vector<cfcore::ICFGenKbGenTruncObj*> CFGenKbGenTruncTableObj::readGenTruncByToolSetIdx( const int16_t ToolSetId,
		bool forceRead )
	{
		static const std::string S_ProcName( "readGenTruncByToolSetIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
	...
	std::vector<cfcore::ICFGenKbGenTruncObj*> CFGenKbGenTruncTableObj::readGenTruncByScopeIdx( const int16_t* ScopeDefId,
		bool forceRead )
	{
		static const std::string S_ProcName( "readGenTruncByScopeIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
	...
	std::vector<cfcore::ICFGenKbGenTruncObj*> CFGenKbGenTruncTableObj::readGenTruncByGenDefIdx( const int16_t GenDefId,
		bool forceRead )
	{
		static const std::string S_ProcName( "readGenTruncByGenDefIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
	...
	cfcore::ICFGenKbGenTruncObj* CFGenKbGenTruncTableObj::readGenTruncByAltIdx( const std::string& Name,
			const int16_t ToolSetId,
			const int16_t* ScopeDefId,
			const int16_t GenDefId, bool forceRead )
	{
		static const std::string S_ProcName( "readGenTruncByAltIdx" );
		static const std::string S_Realized( "realized" );
		if( indexByAltIdx == NULL ) {
			indexByAltIdx = new std::map< cfcore::CFGenKbGenItemByAltIdxKey,
				cfcore::ICFGenKbGenTruncObj*>();
		...
		if( forceRead || ( obj == NULL ) ) {
			...
			if( buff != NULL ) {
				...
				indexByAltIdx->insert( std::map< cfcore::CFGenKbGenItemByAltIdxKey, cfcore::ICFGenKbGenTruncObj*>::value_type( key, dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( realized ) ) );
				// No need to delete obj -- realize() auto-destructs the instance it decided to discard
				obj = realized;
			}
		}
	...
	std::vector<cfcore::ICFGenKbGenTruncObj*> CFGenKbGenTruncTableObj::readGenTruncByGelExecIdx( const int64_t* GelExecutableTenantId,
			const int64_t* GelExecutableGelCacheId,
			const int64_t* GelExecutableId,
		bool forceRead )
	{
		static const std::string S_ProcName( "readGenTruncByGelExecIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
	...
	std::vector<cfcore::ICFGenKbGenTruncObj*> CFGenKbGenTruncTableObj::readGenTruncByProbeIdx( const int64_t* ProbeTenantId,
			const int64_t* ProbeCartridgeId,
			const int64_t* ProbeGenItemId,
		bool forceRead )
	{
		static const std::string S_ProcName( "readGenTruncByProbeIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
	...
	std::vector<cfcore::ICFGenKbGenTruncObj*> CFGenKbGenTruncTableObj::readGenTruncByBodyIdx( const int64_t* BodyTenantId,
			const int64_t* BodyGelCacheId,
			const int64_t* BodyGelId,
		bool forceRead )
	{
		static const std::string S_ProcName( "readGenTruncByBodyIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
	...
	cfcore::ICFGenKbGenTruncObj* CFGenKbGenTruncTableObj::readCachedGenTrunc( cfcore::CFGenKbGenItemPKey* pkey ) {
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		static const std::string S_ProcName( "readGenTrunc" );
		cfcore::ICFGenKbGenTruncObj* obj = NULL;
	...
	cfcore::ICFGenKbGenTruncObj* CFGenKbGenTruncTableObj::readCachedGenTruncByItemIdIdx( const int64_t TenantId,
			const int64_t CartridgeId,
			const int64_t ItemId )
	{
		static const std::string S_ProcName( "readCachedGenTruncByItemIdIdx" );
		static const std::string S_Realized( "realized" );
		cfcore::CFGenKbGenItemPKey pkey;
		pkey.setRequiredTenantId( TenantId );
		pkey.setRequiredCartridgeId( CartridgeId );
		pkey.setRequiredItemId( ItemId );
		cfcore::ICFGenKbGenTruncObj* obj = readCachedGenTrunc( &pkey );
		return( obj );
	}

	std::vector<cfcore::ICFGenKbGenTruncObj*> CFGenKbGenTruncTableObj::readCachedGenTruncByTenantIdx( const int64_t TenantId )
	{
		static const std::string S_ProcName( "readCachedGenTruncByTenantIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		std::vector<cfcore::ICFGenKbGenTruncObj*> arr;
		...
		if( searchIndexByTenantIdx != indexByTenantIdx->end() ) {
			...
			cfcore::ICFGenKbGenTruncObj* obj;
	...
	std::vector<cfcore::ICFGenKbGenTruncObj*> CFGenKbGenTruncTableObj::readCachedGenTruncByCartIdx( const int64_t TenantId,
			const int64_t CartridgeId )
	{
		static const std::string S_ProcName( "readCachedGenTruncByCartIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		std::vector<cfcore::ICFGenKbGenTruncObj*> arr;
	...
	std::vector<cfcore::ICFGenKbGenTruncObj*> CFGenKbGenTruncTableObj::readCachedGenTruncByRuleTypeIdx( const int16_t RuleTypeId )
	{
		static const std::string S_ProcName( "readCachedGenTruncByRuleTypeIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		std::vector<cfcore::ICFGenKbGenTruncObj*> arr;
	...
	std::vector<cfcore::ICFGenKbGenTruncObj*> CFGenKbGenTruncTableObj::readCachedGenTruncByToolSetIdx( const int16_t ToolSetId )
	{
		static const std::string S_ProcName( "readCachedGenTruncByToolSetIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		std::vector<cfcore::ICFGenKbGenTruncObj*> arr;
	...
	std::vector<cfcore::ICFGenKbGenTruncObj*> CFGenKbGenTruncTableObj::readCachedGenTruncByScopeIdx( const int16_t* ScopeDefId )
	{
		static const std::string S_ProcName( "readCachedGenTruncByScopeIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		std::vector<cfcore::ICFGenKbGenTruncObj*> arr;
	...
	std::vector<cfcore::ICFGenKbGenTruncObj*> CFGenKbGenTruncTableObj::readCachedGenTruncByGenDefIdx( const int16_t GenDefId )
	{
		static const std::string S_ProcName( "readCachedGenTruncByGenDefIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		std::vector<cfcore::ICFGenKbGenTruncObj*> arr;
	...
	cfcore::ICFGenKbGenTruncObj* CFGenKbGenTruncTableObj::readCachedGenTruncByAltIdx( const std::string& Name,
			const int16_t ToolSetId,
			const int16_t* ScopeDefId,
			const int16_t GenDefId )
	{
		static const std::string S_ProcName( "readCachedGenTruncByAltIdx" );
		static const std::string S_Realized( "realized" );
		if( indexByAltIdx == NULL ) {
			indexByAltIdx = new std::map< cfcore::CFGenKbGenItemByAltIdxKey,
				cfcore::ICFGenKbGenTruncObj*>();
	...
	std::vector<cfcore::ICFGenKbGenTruncObj*> CFGenKbGenTruncTableObj::readCachedGenTruncByGelExecIdx( const int64_t* GelExecutableTenantId,
			const int64_t* GelExecutableGelCacheId,
			const int64_t* GelExecutableId )
	{
		static const std::string S_ProcName( "readCachedGenTruncByGelExecIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		std::vector<cfcore::ICFGenKbGenTruncObj*> arr;
	...
	std::vector<cfcore::ICFGenKbGenTruncObj*> CFGenKbGenTruncTableObj::readCachedGenTruncByProbeIdx( const int64_t* ProbeTenantId,
			const int64_t* ProbeCartridgeId,
			const int64_t* ProbeGenItemId )
	{
		static const std::string S_ProcName( "readCachedGenTruncByProbeIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		std::vector<cfcore::ICFGenKbGenTruncObj*> arr;
	...
	std::vector<cfcore::ICFGenKbGenTruncObj*> CFGenKbGenTruncTableObj::readCachedGenTruncByBodyIdx( const int64_t* BodyTenantId,
			const int64_t* BodyGelCacheId,
			const int64_t* BodyGelId )
	{
		static const std::string S_ProcName( "readCachedGenTruncByBodyIdx" );
		static const std::string S_Idx( "idx" );
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		std::vector<cfcore::ICFGenKbGenTruncObj*> arr;
	...
	cfcore::ICFGenKbGenTruncObj* CFGenKbGenTruncTableObj::updateGenTrunc( cfcore::ICFGenKbGenTruncEditObj* Obj ) {
		...
		cfcore::ICFGenKbGenTruncObj* obj = dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( Obj->getOrig() );
		try {
			cfcore::CFGenKbGenTruncBuff* updated = dynamic_cast<ICFGenKbSchema*>( schema->getBackingStore() )->getTableGenTrunc()->updateGenTrunc( schema->getAuthorization(),
				dynamic_cast<cfcore::CFGenKbGenTruncBuff*>( Obj->getGenTruncBuff()->clone() ) );
			if( updated == NULL ) {
				throw cflib::CFLibNullArgumentException( CLASS_NAME,
					S_ProcName,
					0,
			...
			obj = dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( dynamic_cast<cfcore::CFGenKbGenTruncTableObj*>( schema->getGenTruncTableObj() )->newInstance() );
			obj->setBuff( updated );
			obj = dynamic_cast<cfcore::ICFGenKbGenTruncObj*>( obj->realize() );
			if( obj == NULL ) {
				throw cflib::CFLibNullArgumentException( CLASS_NAME,
	...
	void CFGenKbGenTruncTableObj::deleteGenTrunc( cfcore::ICFGenKbGenTruncEditObj* Obj ) {
		cfcore::ICFGenKbGenTruncObj* obj = Obj;
		dynamic_cast<ICFGenKbSchema*>( schema->getBackingStore() )->getTableGenTrunc()->deleteGenTrunc( schema->getAuthorization(),
			obj->getGenTruncBuff() );
	...
	void CFGenKbGenTruncTableObj::deleteGenTruncByItemIdIdx( const int64_t TenantId,
			const int64_t CartridgeId,
			const int64_t ItemId )
	{
		cfcore::CFGenKbGenItemPKey pkey;
		...
		pkey.setRequiredCartridgeId( CartridgeId );
		pkey.setRequiredItemId( ItemId );
		cfcore::ICFGenKbGenTruncObj* obj = readGenTrunc( &pkey, true );
		if( obj != NULL ) {
			cfcore::ICFGenKbGenTruncEditObj* editObj = dynamic_cast<cfcore::ICFGenKbGenTruncEditObj*>( obj->getEdit() );
			if( editObj == NULL ) {
				editObj = dynamic_cast<cfcore::ICFGenKbGenTruncEditObj*>( obj->beginEdit() );
			}
			if( editObj != NULL ) {
	...
	void CFGenKbGenTruncTableObj::deleteGenTruncByTenantIdx( const int64_t TenantId )
	{
		dynamic_cast<cfcore::ICFGenKbSchema*>( schema->getBackingStore() )->getTableGenTrunc()->deleteGenTruncByTenantIdx( schema->getAuthorization(),
				TenantId );
		deepDisposeByTenantIdx( TenantId );
	}

	void CFGenKbGenTruncTableObj::deleteGenTruncByCartIdx( const int64_t TenantId,
			const int64_t CartridgeId )
	{
		dynamic_cast<cfcore::ICFGenKbSchema*>( schema->getBackingStore() )->getTableGenTrunc()->deleteGenTruncByCartIdx( schema->getAuthorization(),
				TenantId,
				CartridgeId );
	...
	void CFGenKbGenTruncTableObj::deleteGenTruncByRuleTypeIdx( const int16_t RuleTypeId )
	{
		dynamic_cast<cfcore::ICFGenKbSchema*>( schema->getBackingStore() )->getTableGenTrunc()->deleteGenTruncByRuleTypeIdx( schema->getAuthorization(),
				RuleTypeId );
		deepDisposeByRuleTypeIdx( RuleTypeId );
	}

	void CFGenKbGenTruncTableObj::deleteGenTruncByToolSetIdx( const int16_t ToolSetId )
	{
		dynamic_cast<cfcore::ICFGenKbSchema*>( schema->getBackingStore() )->getTableGenTrunc()->deleteGenTruncByToolSetIdx( schema->getAuthorization(),
				ToolSetId );
		deepDisposeByToolSetIdx( ToolSetId );
	}

	void CFGenKbGenTruncTableObj::deleteGenTruncByScopeIdx( const int16_t* ScopeDefId )
	{
		dynamic_cast<cfcore::ICFGenKbSchema*>( schema->getBackingStore() )->getTableGenTrunc()->deleteGenTruncByScopeIdx( schema->getAuthorization(),
				ScopeDefId );
		deepDisposeByScopeIdx( ScopeDefId );
	}

	void CFGenKbGenTruncTableObj::deleteGenTruncByGenDefIdx( const int16_t GenDefId )
	{
		dynamic_cast<cfcore::ICFGenKbSchema*>( schema->getBackingStore() )->getTableGenTrunc()->deleteGenTruncByGenDefIdx( schema->getAuthorization(),
				GenDefId );
		deepDisposeByGenDefIdx( GenDefId );
	}

	void CFGenKbGenTruncTableObj::deleteGenTruncByAltIdx( const std::string& Name,
			const int16_t ToolSetId,
			const int16_t* ScopeDefId,
			const int16_t GenDefId )
	{
		...
		auto searchIndexByAltIdx = indexByAltIdx->find( key );
		if( searchIndexByAltIdx != indexByAltIdx->end() ) {
			dynamic_cast<ICFGenKbSchema*>( schema->getBackingStore() )->getTableGenTrunc()->deleteGenTruncByAltIdx( schema->getAuthorization(),
				Name,
				ToolSetId,
				ScopeDefId,
				GenDefId );
	...
	void CFGenKbGenTruncTableObj::deleteGenTruncByGelExecIdx( const int64_t* GelExecutableTenantId,
			const int64_t* GelExecutableGelCacheId,
			const int64_t* GelExecutableId )
	{
		dynamic_cast<cfcore::ICFGenKbSchema*>( schema->getBackingStore() )->getTableGenTrunc()->deleteGenTruncByGelExecIdx( schema->getAuthorization(),
				GelExecutableTenantId,
				GelExecutableGelCacheId,
				GelExecutableId );
	...
	void CFGenKbGenTruncTableObj::deleteGenTruncByProbeIdx( const int64_t* ProbeTenantId,
			const int64_t* ProbeCartridgeId,
			const int64_t* ProbeGenItemId )
	{
		dynamic_cast<cfcore::ICFGenKbSchema*>( schema->getBackingStore() )->getTableGenTrunc()->deleteGenTruncByProbeIdx( schema->getAuthorization(),
				ProbeTenantId,
				ProbeCartridgeId,
				ProbeGenItemId );
	...
	void CFGenKbGenTruncTableObj::deleteGenTruncByBodyIdx( const int64_t* BodyTenantId,
			const int64_t* BodyGelCacheId,
			const int64_t* BodyGelId )
	{
		dynamic_cast<cfcore::ICFGenKbSchema*>( schema->getBackingStore() )->getTableGenTrunc()->deleteGenTruncByBodyIdx( schema->getAuthorization(),
				BodyTenantId,
				BodyGelCacheId,
				BodyGelId );
	...
	void CFGenKbGenTruncTableObj::reallyDetachFromIndexesGenTrunc( cfcore::ICFGenKbGenTruncObj* Obj ) {
		static const std::string S_ProcName( "reallyDetachFromIndexesGenTrunc" );
		static const std::string S_Obj( "Obj" );
		static const std::string S_ExistingObj( "ExistingObj" );
		if( Obj == NULL ) {
			throw cflib::CFLibNullArgumentException( CLASS_NAME, S_ProcName, 1, S_Obj );
		...
		auto searchMembers = members->find( *pkey );
		if( searchMembers != members->end() ) {
			cfcore::ICFGenKbGenTruncObj* existingObj = searchMembers->second;
			if( existingObj == NULL ) {
				throw cflib::CFLibNullArgumentException( CLASS_NAME,
					S_ProcName,
					0,
