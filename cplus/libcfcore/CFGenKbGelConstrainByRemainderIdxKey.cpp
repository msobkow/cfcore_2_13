// Description: C++18 implementation for a GelConstrain by RemainderIdx index key object.
...
namespace cfcore {
	const std::string CFGenKbGelConstrainByRemainderIdxKey::CLASS_NAME( "CFGenKbGelConstrainByRemainderIdxKey" );
	const std::string CFGenKbGelConstrainByRemainderIdxKey::S_VALUE( "value" );
	const std::string CFGenKbGelConstrainByRemainderIdxKey::S_VALUE_LENGTH( "value.length()" );


	CFGenKbGelConstrainByRemainderIdxKey::CFGenKbGelConstrainByRemainderIdxKey() {
	...
	CFGenKbGelConstrainByRemainderIdxKey::CFGenKbGelConstrainByRemainderIdxKey( const CFGenKbGelConstrainByRemainderIdxKey& src ) {
		optionalRemainderTenantId.setNull();
		requiredRemainderGelCacheId = cfcore::CFGenKbGelConstrainBuff::REMAINDERGELCACHEID_INIT_VALUE;
		optionalRemainderInstId.setNull();
	...
	const int64_t CFGenKbGelConstrainByRemainderIdxKey::getOptionalRemainderTenantIdValue() const {
		return( optionalRemainderTenantId.getValue() );
	}

	const int64_t* CFGenKbGelConstrainByRemainderIdxKey::getOptionalRemainderTenantIdReference() const {
		return( optionalRemainderTenantId.getReference() );
	}

	const bool CFGenKbGelConstrainByRemainderIdxKey::isOptionalRemainderTenantIdNull() const {
		return( optionalRemainderTenantId.isNull() );
	}

	void CFGenKbGelConstrainByRemainderIdxKey::setOptionalRemainderTenantIdNull() {
		optionalRemainderTenantId.setNull();
	}

	void CFGenKbGelConstrainByRemainderIdxKey::setOptionalRemainderTenantIdValue( const int64_t value ) {
	...
	const int64_t CFGenKbGelConstrainByRemainderIdxKey::getRequiredRemainderGelCacheId() const {
		return( requiredRemainderGelCacheId );
	}

	const int64_t* CFGenKbGelConstrainByRemainderIdxKey::getRequiredRemainderGelCacheIdReference() const {
		return( &requiredRemainderGelCacheId );
	}

	void CFGenKbGelConstrainByRemainderIdxKey::setRequiredRemainderGelCacheId( const int64_t value ) {
	...
	const int64_t CFGenKbGelConstrainByRemainderIdxKey::getOptionalRemainderInstIdValue() const {
		return( optionalRemainderInstId.getValue() );
	}

	const int64_t* CFGenKbGelConstrainByRemainderIdxKey::getOptionalRemainderInstIdReference() const {
		return( optionalRemainderInstId.getReference() );
	}

	const bool CFGenKbGelConstrainByRemainderIdxKey::isOptionalRemainderInstIdNull() const {
		return( optionalRemainderInstId.isNull() );
	}

	void CFGenKbGelConstrainByRemainderIdxKey::setOptionalRemainderInstIdNull() {
		optionalRemainderInstId.setNull();
	}

	void CFGenKbGelConstrainByRemainderIdxKey::setOptionalRemainderInstIdValue( const int64_t value ) {
	...
	size_t CFGenKbGelConstrainByRemainderIdxKey::hashCode() const {
		size_t hashCode = 0;
	...
	std::string CFGenKbGelConstrainByRemainderIdxKey::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFGenKbGelConstrainByRemainderIdxKey" );
	...
	bool CFGenKbGelConstrainByRemainderIdxKey::operator <( const CFGenKbGelConstrainByRemainderIdxKey& rhs ) {
		if( ! isOptionalRemainderTenantIdNull() ) {
	...
	bool CFGenKbGelConstrainByRemainderIdxKey::operator <( const CFGenKbGelConstrainBuff& rhs ) {
		if( ! isOptionalRemainderTenantIdNull() ) {
			if( rhs.isOptionalRemainderTenantIdNull() ) {
				return( false );
			}
	...
	CFGenKbGelConstrainByRemainderIdxKey CFGenKbGelConstrainByRemainderIdxKey::operator =( cfcore::CFGenKbGelConstrainByRemainderIdxKey& src ) {
		if( src.isOptionalRemainderTenantIdNull() ) {
			setOptionalRemainderTenantIdNull();
		}
		else {
	...
	CFGenKbGelConstrainByRemainderIdxKey CFGenKbGelConstrainByRemainderIdxKey::operator =( cfcore::CFGenKbGelConstrainBuff& src ) {
		if( src.isOptionalRemainderTenantIdNull() ) {
			setOptionalRemainderTenantIdNull();
		}
		else {
