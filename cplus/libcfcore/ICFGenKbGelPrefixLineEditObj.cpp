// Description: C++18 Instance Edit Object interface implementation for CFGenKb GelPrefixLine.
...
namespace cfcore {
	...
	const std::string ICFGenKbGelPrefixLineEditObj::CLASS_NAME( "ICFGenKbGelPrefixLineEditObj" );

	ICFGenKbGelPrefixLineEditObj::ICFGenKbGelPrefixLineEditObj()
