...
namespace cfcore {
	...
	public:
		CFGenKbSecGroupByUNameIdxKey();
		CFGenKbSecGroupByUNameIdxKey( const CFGenKbSecGroupByUNameIdxKey& src );
		virtual ~CFGenKbSecGroupByUNameIdxKey();
		...
		bool operator >( const CFGenKbSecGroupByUNameIdxKey& rhs );
		bool operator >( const CFGenKbSecGroupBuff& rhs );
		cfcore::CFGenKbSecGroupByUNameIdxKey operator =( cfcore::CFGenKbSecGroupByUNameIdxKey& src );
		cfcore::CFGenKbSecGroupByUNameIdxKey operator =( cfcore::CFGenKbSecGroupBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbSecGroupByUNameIdxKey> {
		typedef cfcore::CFGenKbSecGroupByUNameIdxKey argument_type;
