...
namespace cfcore {
	...
	public:
		CFGenKbHostNodeByHostNameIdxKey();
		CFGenKbHostNodeByHostNameIdxKey( const CFGenKbHostNodeByHostNameIdxKey& src );
		virtual ~CFGenKbHostNodeByHostNameIdxKey();
		...
		bool operator >( const CFGenKbHostNodeByHostNameIdxKey& rhs );
		bool operator >( const CFGenKbHostNodeBuff& rhs );
		cfcore::CFGenKbHostNodeByHostNameIdxKey operator =( cfcore::CFGenKbHostNodeByHostNameIdxKey& src );
		cfcore::CFGenKbHostNodeByHostNameIdxKey operator =( cfcore::CFGenKbHostNodeBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbHostNodeByHostNameIdxKey> {
		typedef cfcore::CFGenKbHostNodeByHostNameIdxKey argument_type;
