...
namespace cfcore {
	...
	public:
		...
		CFGenKbClusterPKey();
		CFGenKbClusterPKey( const CFGenKbClusterPKey& src );
		virtual ~CFGenKbClusterPKey();
		...
		cfcore::CFGenKbClusterPKey operator =( cfcore::CFGenKbClusterPKey& src );
		cfcore::CFGenKbClusterPKey operator =( cfcore::CFGenKbClusterBuff& src );
	};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbClusterPKey> {
		typedef cfcore::CFGenKbClusterPKey argument_type;
