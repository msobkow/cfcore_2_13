...
namespace cfcore {
	...
	public:
		CFGenKbSecGrpMembByUUserIdxKey();
		CFGenKbSecGrpMembByUUserIdxKey( const CFGenKbSecGrpMembByUUserIdxKey& src );
		virtual ~CFGenKbSecGrpMembByUUserIdxKey();
		...
		bool operator >( const CFGenKbSecGrpMembByUUserIdxKey& rhs );
		bool operator >( const CFGenKbSecGrpMembBuff& rhs );
		cfcore::CFGenKbSecGrpMembByUUserIdxKey operator =( cfcore::CFGenKbSecGrpMembByUUserIdxKey& src );
		cfcore::CFGenKbSecGrpMembByUUserIdxKey operator =( cfcore::CFGenKbSecGrpMembBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbSecGrpMembByUUserIdxKey> {
		typedef cfcore::CFGenKbSecGrpMembByUUserIdxKey argument_type;
