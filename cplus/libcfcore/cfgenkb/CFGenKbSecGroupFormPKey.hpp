...
namespace cfcore {
	...
	public:
		...
		CFGenKbSecGroupFormPKey();
		CFGenKbSecGroupFormPKey( const CFGenKbSecGroupFormPKey& src );
		virtual ~CFGenKbSecGroupFormPKey();
		...
		cfcore::CFGenKbSecGroupFormPKey operator =( cfcore::CFGenKbSecGroupFormPKey& src );
		cfcore::CFGenKbSecGroupFormPKey operator =( cfcore::CFGenKbSecGroupFormBuff& src );
	};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbSecGroupFormPKey> {
		typedef cfcore::CFGenKbSecGroupFormPKey argument_type;
