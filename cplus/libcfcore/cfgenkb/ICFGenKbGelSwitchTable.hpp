...
// Description: C++18 DbIO interface for GelSwitch.
...
namespace cfcore {
	...
	public:
		...
		virtual std::TCFLibOwningVector<cfcore::CFGenKbGelSwitchBuff*> readAllDerived( const cfcore::CFGenKbAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfcore::CFGenKbGelSwitchBuff*> readAllBuff( const cfcore::CFGenKbAuthorization* Authorization ) = 0;
