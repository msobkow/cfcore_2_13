...
// Description: C++18 specification for a GelIterator by LastIdx index key object.
...
namespace cfcore {
	...
	public:
		CFGenKbGelIteratorByLastIdxKey();
		CFGenKbGelIteratorByLastIdxKey( const CFGenKbGelIteratorByLastIdxKey& src );
		virtual ~CFGenKbGelIteratorByLastIdxKey();
		...
		bool operator >( const CFGenKbGelIteratorByLastIdxKey& rhs );
		bool operator >( const CFGenKbGelIteratorBuff& rhs );
		cfcore::CFGenKbGelIteratorByLastIdxKey operator =( cfcore::CFGenKbGelIteratorByLastIdxKey& src );
		cfcore::CFGenKbGelIteratorByLastIdxKey operator =( cfcore::CFGenKbGelIteratorBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGelIteratorByLastIdxKey> {
		typedef cfcore::CFGenKbGelIteratorByLastIdxKey argument_type;
