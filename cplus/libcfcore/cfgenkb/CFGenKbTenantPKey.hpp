...
namespace cfcore {
	...
	public:
		...
		CFGenKbTenantPKey();
		CFGenKbTenantPKey( const CFGenKbTenantPKey& src );
		virtual ~CFGenKbTenantPKey();
		...
		cfcore::CFGenKbTenantPKey operator =( cfcore::CFGenKbTenantPKey& src );
		cfcore::CFGenKbTenantPKey operator =( cfcore::CFGenKbTenantBuff& src );
	};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbTenantPKey> {
		typedef cfcore::CFGenKbTenantPKey argument_type;
