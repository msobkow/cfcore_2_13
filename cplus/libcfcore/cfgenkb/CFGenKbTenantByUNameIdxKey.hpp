...
namespace cfcore {
	...
	public:
		CFGenKbTenantByUNameIdxKey();
		CFGenKbTenantByUNameIdxKey( const CFGenKbTenantByUNameIdxKey& src );
		virtual ~CFGenKbTenantByUNameIdxKey();
		...
		bool operator >( const CFGenKbTenantByUNameIdxKey& rhs );
		bool operator >( const CFGenKbTenantBuff& rhs );
		cfcore::CFGenKbTenantByUNameIdxKey operator =( cfcore::CFGenKbTenantByUNameIdxKey& src );
		cfcore::CFGenKbTenantByUNameIdxKey operator =( cfcore::CFGenKbTenantBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbTenantByUNameIdxKey> {
		typedef cfcore::CFGenKbTenantByUNameIdxKey argument_type;
