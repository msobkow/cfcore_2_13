...
namespace cfcore {
	...
	public:
		...
		CFGenKbSecGroupPKey();
		CFGenKbSecGroupPKey( const CFGenKbSecGroupPKey& src );
		virtual ~CFGenKbSecGroupPKey();
		...
		cfcore::CFGenKbSecGroupPKey operator =( cfcore::CFGenKbSecGroupPKey& src );
		cfcore::CFGenKbSecGroupPKey operator =( cfcore::CFGenKbSecGroupBuff& src );
	};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbSecGroupPKey> {
		typedef cfcore::CFGenKbSecGroupPKey argument_type;
