...
// Description: C++18 specification for a GenItem by CartIdx index key object.
...
namespace cfcore {
	...
	public:
		CFGenKbGenItemByCartIdxKey();
		CFGenKbGenItemByCartIdxKey( const CFGenKbGenItemByCartIdxKey& src );
		virtual ~CFGenKbGenItemByCartIdxKey();
		...
		bool operator >( const CFGenKbGenItemByCartIdxKey& rhs );
		bool operator >( const CFGenKbGenItemBuff& rhs );
		cfcore::CFGenKbGenItemByCartIdxKey operator =( cfcore::CFGenKbGenItemByCartIdxKey& src );
		cfcore::CFGenKbGenItemByCartIdxKey operator =( cfcore::CFGenKbGenItemBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGenItemByCartIdxKey> {
		typedef cfcore::CFGenKbGenItemByCartIdxKey argument_type;
