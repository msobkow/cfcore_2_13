...
// Description: C++18 specification for a GelSpread by BetweenIdx index key object.
...
namespace cfcore {
	...
	public:
		CFGenKbGelSpreadByBetweenIdxKey();
		CFGenKbGelSpreadByBetweenIdxKey( const CFGenKbGelSpreadByBetweenIdxKey& src );
		virtual ~CFGenKbGelSpreadByBetweenIdxKey();
		...
		bool operator >( const CFGenKbGelSpreadByBetweenIdxKey& rhs );
		bool operator >( const CFGenKbGelSpreadBuff& rhs );
		cfcore::CFGenKbGelSpreadByBetweenIdxKey operator =( cfcore::CFGenKbGelSpreadByBetweenIdxKey& src );
		cfcore::CFGenKbGelSpreadByBetweenIdxKey operator =( cfcore::CFGenKbGelSpreadBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGelSpreadByBetweenIdxKey> {
		typedef cfcore::CFGenKbGelSpreadByBetweenIdxKey argument_type;
