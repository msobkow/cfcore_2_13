...
// Description: C++18 DbIO interface for GelExpansion.
...
namespace cfcore {
	...
	public:
		...
		virtual std::TCFLibOwningVector<cfcore::CFGenKbGelExpansionBuff*> readAllDerived( const cfcore::CFGenKbAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfcore::CFGenKbGelExpansionBuff*> readAllBuff( const cfcore::CFGenKbAuthorization* Authorization ) = 0;
