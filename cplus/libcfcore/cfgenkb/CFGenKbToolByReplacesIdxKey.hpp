...
// Description: C++18 specification for a Tool by ReplacesIdx index key object.
...
namespace cfcore {
	...
	public:
		CFGenKbToolByReplacesIdxKey();
		CFGenKbToolByReplacesIdxKey( const CFGenKbToolByReplacesIdxKey& src );
		virtual ~CFGenKbToolByReplacesIdxKey();
		...
		bool operator >( const CFGenKbToolByReplacesIdxKey& rhs );
		bool operator >( const CFGenKbToolBuff& rhs );
		cfcore::CFGenKbToolByReplacesIdxKey operator =( cfcore::CFGenKbToolByReplacesIdxKey& src );
		cfcore::CFGenKbToolByReplacesIdxKey operator =( cfcore::CFGenKbToolBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbToolByReplacesIdxKey> {
		typedef cfcore::CFGenKbToolByReplacesIdxKey argument_type;
