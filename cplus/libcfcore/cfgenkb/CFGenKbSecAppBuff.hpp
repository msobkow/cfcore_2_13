...
namespace cfcore {
	...
	class CFGenKbSecAppBuff : public cflib::ICFLibCloneableObj
	{
	public:
	...
	public:
		...
		CFGenKbSecAppBuff( const CFGenKbSecAppBuff& src );

		virtual ~CFGenKbSecAppBuff();
		...
		bool operator >( const CFGenKbSecAppPKey& rhs );
		bool operator >( const CFGenKbSecAppBuff& rhs );
		cfcore::CFGenKbSecAppBuff operator =( cfcore::CFGenKbSecAppBuff& src );
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbSecAppBuff> {
		typedef cfcore::CFGenKbSecAppBuff argument_type;
