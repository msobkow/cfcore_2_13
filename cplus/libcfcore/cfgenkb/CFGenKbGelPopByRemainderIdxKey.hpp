...
// Description: C++18 specification for a GelPop by RemainderIdx index key object.
...
namespace cfcore {
	...
	public:
		CFGenKbGelPopByRemainderIdxKey();
		CFGenKbGelPopByRemainderIdxKey( const CFGenKbGelPopByRemainderIdxKey& src );
		virtual ~CFGenKbGelPopByRemainderIdxKey();
		...
		bool operator >( const CFGenKbGelPopByRemainderIdxKey& rhs );
		bool operator >( const CFGenKbGelPopBuff& rhs );
		cfcore::CFGenKbGelPopByRemainderIdxKey operator =( cfcore::CFGenKbGelPopByRemainderIdxKey& src );
		cfcore::CFGenKbGelPopByRemainderIdxKey operator =( cfcore::CFGenKbGelPopBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGelPopByRemainderIdxKey> {
		typedef cfcore::CFGenKbGelPopByRemainderIdxKey argument_type;
