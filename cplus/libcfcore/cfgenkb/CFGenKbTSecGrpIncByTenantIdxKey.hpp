...
namespace cfcore {
	...
	public:
		CFGenKbTSecGrpIncByTenantIdxKey();
		CFGenKbTSecGrpIncByTenantIdxKey( const CFGenKbTSecGrpIncByTenantIdxKey& src );
		virtual ~CFGenKbTSecGrpIncByTenantIdxKey();
		...
		bool operator >( const CFGenKbTSecGrpIncByTenantIdxKey& rhs );
		bool operator >( const CFGenKbTSecGrpIncBuff& rhs );
		cfcore::CFGenKbTSecGrpIncByTenantIdxKey operator =( cfcore::CFGenKbTSecGrpIncByTenantIdxKey& src );
		cfcore::CFGenKbTSecGrpIncByTenantIdxKey operator =( cfcore::CFGenKbTSecGrpIncBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbTSecGrpIncByTenantIdxKey> {
		typedef cfcore::CFGenKbTSecGrpIncByTenantIdxKey argument_type;
