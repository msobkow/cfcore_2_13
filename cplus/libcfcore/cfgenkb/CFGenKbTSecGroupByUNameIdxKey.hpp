...
namespace cfcore {
	...
	public:
		CFGenKbTSecGroupByUNameIdxKey();
		CFGenKbTSecGroupByUNameIdxKey( const CFGenKbTSecGroupByUNameIdxKey& src );
		virtual ~CFGenKbTSecGroupByUNameIdxKey();
		...
		bool operator >( const CFGenKbTSecGroupByUNameIdxKey& rhs );
		bool operator >( const CFGenKbTSecGroupBuff& rhs );
		cfcore::CFGenKbTSecGroupByUNameIdxKey operator =( cfcore::CFGenKbTSecGroupByUNameIdxKey& src );
		cfcore::CFGenKbTSecGroupByUNameIdxKey operator =( cfcore::CFGenKbTSecGroupBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbTSecGroupByUNameIdxKey> {
		typedef cfcore::CFGenKbTSecGroupByUNameIdxKey argument_type;
