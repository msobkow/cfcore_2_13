...
// Description: C++18 specification for a DefClass by BaseIdx index key object.
...
namespace cfcore {
	...
	public:
		CFGenKbDefClassByBaseIdxKey();
		CFGenKbDefClassByBaseIdxKey( const CFGenKbDefClassByBaseIdxKey& src );
		virtual ~CFGenKbDefClassByBaseIdxKey();
		...
		bool operator >( const CFGenKbDefClassByBaseIdxKey& rhs );
		bool operator >( const CFGenKbDefClassBuff& rhs );
		cfcore::CFGenKbDefClassByBaseIdxKey operator =( cfcore::CFGenKbDefClassByBaseIdxKey& src );
		cfcore::CFGenKbDefClassByBaseIdxKey operator =( cfcore::CFGenKbDefClassBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbDefClassByBaseIdxKey> {
		typedef cfcore::CFGenKbDefClassByBaseIdxKey argument_type;
