...
// Description: C++18 specification for a GelReference buffer object.
...
namespace cfcore {
	...
	class CFGenKbGelReferenceBuff : public CFGenKbGelInstructionBuff
	{
	public:
		static const std::string GENDEFNAME;
		static const classcode_t CLASS_CODE;
		static const std::string CLASS_NAME;
		static const std::string COLNAME_REFERENCENAME;
		...
		static const std::string REFERENCENAME_INIT_VALUE;
		...
		static const std::string::size_type REFERENCENAME_MAX_LEN;
	protected:
		std::string* requiredReferenceName;
	...
	public:
		...
		CFGenKbGelReferenceBuff( const CFGenKbGelReferenceBuff& src );
		virtual ~CFGenKbGelReferenceBuff();
		...
		virtual const std::string& getRequiredReferenceName() const;
		virtual const std::string* getRequiredReferenceNameReference() const;
		...
		bool operator >( const CFGenKbGelInstructionPKey& rhs );
		bool operator >( const CFGenKbGelReferenceBuff& rhs );
		cfcore::CFGenKbGelReferenceBuff operator =( cfcore::CFGenKbGelReferenceBuff& src );
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGelReferenceBuff> {
		typedef cfcore::CFGenKbGelReferenceBuff argument_type;
