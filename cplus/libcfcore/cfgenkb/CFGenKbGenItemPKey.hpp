...
// Description: C++18 specification of a GenItem primary key object.
...
namespace cfcore {
	...
	public:
		...
		CFGenKbGenItemPKey();
		CFGenKbGenItemPKey( const CFGenKbGenItemPKey& src );
		virtual ~CFGenKbGenItemPKey();
		...
		cfcore::CFGenKbGenItemPKey operator =( cfcore::CFGenKbGenItemPKey& src );
		cfcore::CFGenKbGenItemPKey operator =( cfcore::CFGenKbGenItemBuff& src );
	};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGenItemPKey> {
		typedef cfcore::CFGenKbGenItemPKey argument_type;
