...
// Description: C++18 specification for a GelSpread by LoneIdx index key object.
...
namespace cfcore {
	...
	public:
		CFGenKbGelSpreadByLoneIdxKey();
		CFGenKbGelSpreadByLoneIdxKey( const CFGenKbGelSpreadByLoneIdxKey& src );
		virtual ~CFGenKbGelSpreadByLoneIdxKey();
		...
		bool operator >( const CFGenKbGelSpreadByLoneIdxKey& rhs );
		bool operator >( const CFGenKbGelSpreadBuff& rhs );
		cfcore::CFGenKbGelSpreadByLoneIdxKey operator =( cfcore::CFGenKbGelSpreadByLoneIdxKey& src );
		cfcore::CFGenKbGelSpreadByLoneIdxKey operator =( cfcore::CFGenKbGelSpreadBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGelSpreadByLoneIdxKey> {
		typedef cfcore::CFGenKbGelSpreadByLoneIdxKey argument_type;
