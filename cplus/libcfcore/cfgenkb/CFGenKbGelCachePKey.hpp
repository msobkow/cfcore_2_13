...
// Description: C++18 specification of a GelCache primary key object.
...
namespace cfcore {
	...
	public:
		...
		CFGenKbGelCachePKey();
		CFGenKbGelCachePKey( const CFGenKbGelCachePKey& src );
		virtual ~CFGenKbGelCachePKey();
		...
		cfcore::CFGenKbGelCachePKey operator =( cfcore::CFGenKbGelCachePKey& src );
		cfcore::CFGenKbGelCachePKey operator =( cfcore::CFGenKbGelCacheBuff& src );
	};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGelCachePKey> {
		typedef cfcore::CFGenKbGelCachePKey argument_type;
