...
namespace cfcore {
	...
	public:
		...
		CFGenKbTSecGrpMembPKey();
		CFGenKbTSecGrpMembPKey( const CFGenKbTSecGrpMembPKey& src );
		virtual ~CFGenKbTSecGrpMembPKey();
		...
		cfcore::CFGenKbTSecGrpMembPKey operator =( cfcore::CFGenKbTSecGrpMembPKey& src );
		cfcore::CFGenKbTSecGrpMembPKey operator =( cfcore::CFGenKbTSecGrpMembBuff& src );
	};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbTSecGrpMembPKey> {
		typedef cfcore::CFGenKbTSecGrpMembPKey argument_type;
