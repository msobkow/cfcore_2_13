...
// Description: C++18 specification for a GenBind buffer object.
...
namespace cfcore {
	...
	class CFGenKbGenBindBuff : public CFGenKbGenItemBuff
	{
	public:
	...
	public:
		CFGenKbGenBindBuff();
		CFGenKbGenBindBuff( const CFGenKbGenBindBuff& src );
		virtual ~CFGenKbGenBindBuff();
		...
		bool operator <( const CFGenKbGenBindBuff& rhs );
		...
		bool operator >( const CFGenKbGenItemPKey& rhs );
		bool operator >( const CFGenKbGenBindBuff& rhs );
		cfcore::CFGenKbGenBindBuff operator =( cfcore::CFGenKbGenBindBuff& src );
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGenBindBuff> {
		typedef cfcore::CFGenKbGenBindBuff argument_type;
