...
namespace cfcore {
	...
	public:
		CFGenKbTSecGrpIncByIncludeIdxKey();
		CFGenKbTSecGrpIncByIncludeIdxKey( const CFGenKbTSecGrpIncByIncludeIdxKey& src );
		virtual ~CFGenKbTSecGrpIncByIncludeIdxKey();
		...
		bool operator >( const CFGenKbTSecGrpIncByIncludeIdxKey& rhs );
		bool operator >( const CFGenKbTSecGrpIncBuff& rhs );
		cfcore::CFGenKbTSecGrpIncByIncludeIdxKey operator =( cfcore::CFGenKbTSecGrpIncByIncludeIdxKey& src );
		cfcore::CFGenKbTSecGrpIncByIncludeIdxKey operator =( cfcore::CFGenKbTSecGrpIncBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbTSecGrpIncByIncludeIdxKey> {
		typedef cfcore::CFGenKbTSecGrpIncByIncludeIdxKey argument_type;
