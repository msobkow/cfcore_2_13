...
namespace cfcore {
	...
	public:
		CFGenKbHostNodeByUDescrIdxKey();
		CFGenKbHostNodeByUDescrIdxKey( const CFGenKbHostNodeByUDescrIdxKey& src );
		virtual ~CFGenKbHostNodeByUDescrIdxKey();
		...
		bool operator >( const CFGenKbHostNodeByUDescrIdxKey& rhs );
		bool operator >( const CFGenKbHostNodeBuff& rhs );
		cfcore::CFGenKbHostNodeByUDescrIdxKey operator =( cfcore::CFGenKbHostNodeByUDescrIdxKey& src );
		cfcore::CFGenKbHostNodeByUDescrIdxKey operator =( cfcore::CFGenKbHostNodeBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbHostNodeByUDescrIdxKey> {
		typedef cfcore::CFGenKbHostNodeByUDescrIdxKey argument_type;
