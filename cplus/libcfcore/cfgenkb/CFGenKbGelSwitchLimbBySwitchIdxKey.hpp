...
// Description: C++18 specification for a GelSwitchLimb by SwitchIdx index key object.
...
namespace cfcore {
	...
	public:
		CFGenKbGelSwitchLimbBySwitchIdxKey();
		CFGenKbGelSwitchLimbBySwitchIdxKey( const CFGenKbGelSwitchLimbBySwitchIdxKey& src );
		virtual ~CFGenKbGelSwitchLimbBySwitchIdxKey();
		...
		bool operator >( const CFGenKbGelSwitchLimbBySwitchIdxKey& rhs );
		bool operator >( const CFGenKbGelSwitchLimbBuff& rhs );
		cfcore::CFGenKbGelSwitchLimbBySwitchIdxKey operator =( cfcore::CFGenKbGelSwitchLimbBySwitchIdxKey& src );
		cfcore::CFGenKbGelSwitchLimbBySwitchIdxKey operator =( cfcore::CFGenKbGelSwitchLimbBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGelSwitchLimbBySwitchIdxKey> {
		typedef cfcore::CFGenKbGelSwitchLimbBySwitchIdxKey argument_type;
