...
namespace cfcore {
	...
	public:
		CFGenKbSecDeviceByNameIdxKey();
		CFGenKbSecDeviceByNameIdxKey( const CFGenKbSecDeviceByNameIdxKey& src );
		virtual ~CFGenKbSecDeviceByNameIdxKey();
		...
		bool operator <( const CFGenKbSecDeviceByNameIdxKey& rhs );
		...
		bool operator >( const CFGenKbSecDeviceByNameIdxKey& rhs );
		bool operator >( const CFGenKbSecDeviceBuff& rhs );
		cfcore::CFGenKbSecDeviceByNameIdxKey operator =( cfcore::CFGenKbSecDeviceByNameIdxKey& src );
		cfcore::CFGenKbSecDeviceByNameIdxKey operator =( cfcore::CFGenKbSecDeviceBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbSecDeviceByNameIdxKey> {
		typedef cfcore::CFGenKbSecDeviceByNameIdxKey argument_type;
