...
namespace cfcore {
	...
	public:
		CFGenKbSecFormByClusterIdxKey();
		CFGenKbSecFormByClusterIdxKey( const CFGenKbSecFormByClusterIdxKey& src );
		virtual ~CFGenKbSecFormByClusterIdxKey();
		...
		bool operator >( const CFGenKbSecFormByClusterIdxKey& rhs );
		bool operator >( const CFGenKbSecFormBuff& rhs );
		cfcore::CFGenKbSecFormByClusterIdxKey operator =( cfcore::CFGenKbSecFormByClusterIdxKey& src );
		cfcore::CFGenKbSecFormByClusterIdxKey operator =( cfcore::CFGenKbSecFormBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbSecFormByClusterIdxKey> {
		typedef cfcore::CFGenKbSecFormByClusterIdxKey argument_type;
