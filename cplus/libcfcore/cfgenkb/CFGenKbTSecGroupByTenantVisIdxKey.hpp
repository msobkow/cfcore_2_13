...
namespace cfcore {
	...
	public:
		CFGenKbTSecGroupByTenantVisIdxKey();
		CFGenKbTSecGroupByTenantVisIdxKey( const CFGenKbTSecGroupByTenantVisIdxKey& src );
		virtual ~CFGenKbTSecGroupByTenantVisIdxKey();
		...
		bool operator >( const CFGenKbTSecGroupByTenantVisIdxKey& rhs );
		bool operator >( const CFGenKbTSecGroupBuff& rhs );
		cfcore::CFGenKbTSecGroupByTenantVisIdxKey operator =( cfcore::CFGenKbTSecGroupByTenantVisIdxKey& src );
		cfcore::CFGenKbTSecGroupByTenantVisIdxKey operator =( cfcore::CFGenKbTSecGroupBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbTSecGroupByTenantVisIdxKey> {
		typedef cfcore::CFGenKbTSecGroupByTenantVisIdxKey argument_type;
