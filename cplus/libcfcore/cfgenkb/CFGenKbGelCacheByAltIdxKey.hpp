...
// Description: C++18 specification for a GelCache by AltIdx index key object.
...
namespace cfcore {
	...
	public:
		CFGenKbGelCacheByAltIdxKey();
		CFGenKbGelCacheByAltIdxKey( const CFGenKbGelCacheByAltIdxKey& src );
		virtual ~CFGenKbGelCacheByAltIdxKey();
		...
		bool operator >( const CFGenKbGelCacheByAltIdxKey& rhs );
		bool operator >( const CFGenKbGelCacheBuff& rhs );
		cfcore::CFGenKbGelCacheByAltIdxKey operator =( cfcore::CFGenKbGelCacheByAltIdxKey& src );
		cfcore::CFGenKbGelCacheByAltIdxKey operator =( cfcore::CFGenKbGelCacheBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGelCacheByAltIdxKey> {
		typedef cfcore::CFGenKbGelCacheByAltIdxKey argument_type;
