...
// Description: C++18 specification for a GelSpread by BeforeIdx index key object.
...
namespace cfcore {
	...
	public:
		CFGenKbGelSpreadByBeforeIdxKey();
		CFGenKbGelSpreadByBeforeIdxKey( const CFGenKbGelSpreadByBeforeIdxKey& src );
		virtual ~CFGenKbGelSpreadByBeforeIdxKey();
		...
		bool operator >( const CFGenKbGelSpreadByBeforeIdxKey& rhs );
		bool operator >( const CFGenKbGelSpreadBuff& rhs );
		cfcore::CFGenKbGelSpreadByBeforeIdxKey operator =( cfcore::CFGenKbGelSpreadByBeforeIdxKey& src );
		cfcore::CFGenKbGelSpreadByBeforeIdxKey operator =( cfcore::CFGenKbGelSpreadBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGelSpreadByBeforeIdxKey> {
		typedef cfcore::CFGenKbGelSpreadByBeforeIdxKey argument_type;
