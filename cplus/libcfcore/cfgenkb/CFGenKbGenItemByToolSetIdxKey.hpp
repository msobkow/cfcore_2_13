...
// Description: C++18 specification for a GenItem by ToolSetIdx index key object.
...
namespace cfcore {
	...
	public:
		CFGenKbGenItemByToolSetIdxKey();
		CFGenKbGenItemByToolSetIdxKey( const CFGenKbGenItemByToolSetIdxKey& src );
		virtual ~CFGenKbGenItemByToolSetIdxKey();
		...
		bool operator >( const CFGenKbGenItemByToolSetIdxKey& rhs );
		bool operator >( const CFGenKbGenItemBuff& rhs );
		cfcore::CFGenKbGenItemByToolSetIdxKey operator =( cfcore::CFGenKbGenItemByToolSetIdxKey& src );
		cfcore::CFGenKbGenItemByToolSetIdxKey operator =( cfcore::CFGenKbGenItemBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGenItemByToolSetIdxKey> {
		typedef cfcore::CFGenKbGenItemByToolSetIdxKey argument_type;
