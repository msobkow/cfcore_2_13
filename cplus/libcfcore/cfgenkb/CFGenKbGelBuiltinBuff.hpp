...
// Description: C++18 specification for a GelBuiltin buffer object.
...
namespace cfcore {
	...
	class CFGenKbGelBuiltinBuff : public CFGenKbGelInstructionBuff
	{
	public:
	...
	public:
		...
		CFGenKbGelBuiltinBuff( const CFGenKbGelBuiltinBuff& src );
		virtual ~CFGenKbGelBuiltinBuff();
		...
		bool operator <( const CFGenKbGelBuiltinBuff& rhs );
		...
		bool operator >( const CFGenKbGelInstructionPKey& rhs );
		bool operator >( const CFGenKbGelBuiltinBuff& rhs );
		cfcore::CFGenKbGelBuiltinBuff operator =( cfcore::CFGenKbGelBuiltinBuff& src );
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGelBuiltinBuff> {
		typedef cfcore::CFGenKbGelBuiltinBuff argument_type;
