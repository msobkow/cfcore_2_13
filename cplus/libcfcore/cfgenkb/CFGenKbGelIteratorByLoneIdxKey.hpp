...
// Description: C++18 specification for a GelIterator by LoneIdx index key object.
...
namespace cfcore {
	...
	public:
		CFGenKbGelIteratorByLoneIdxKey();
		CFGenKbGelIteratorByLoneIdxKey( const CFGenKbGelIteratorByLoneIdxKey& src );
		virtual ~CFGenKbGelIteratorByLoneIdxKey();
		...
		bool operator >( const CFGenKbGelIteratorByLoneIdxKey& rhs );
		bool operator >( const CFGenKbGelIteratorBuff& rhs );
		cfcore::CFGenKbGelIteratorByLoneIdxKey operator =( cfcore::CFGenKbGelIteratorByLoneIdxKey& src );
		cfcore::CFGenKbGelIteratorByLoneIdxKey operator =( cfcore::CFGenKbGelIteratorBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGelIteratorByLoneIdxKey> {
		typedef cfcore::CFGenKbGelIteratorByLoneIdxKey argument_type;
