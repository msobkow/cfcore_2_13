...
// Description: C++18 specification for a GelIterator by EachIdx index key object.
...
namespace cfcore {
	...
	public:
		CFGenKbGelIteratorByEachIdxKey();
		CFGenKbGelIteratorByEachIdxKey( const CFGenKbGelIteratorByEachIdxKey& src );
		virtual ~CFGenKbGelIteratorByEachIdxKey();
		...
		bool operator >( const CFGenKbGelIteratorByEachIdxKey& rhs );
		bool operator >( const CFGenKbGelIteratorBuff& rhs );
		cfcore::CFGenKbGelIteratorByEachIdxKey operator =( cfcore::CFGenKbGelIteratorByEachIdxKey& src );
		cfcore::CFGenKbGelIteratorByEachIdxKey operator =( cfcore::CFGenKbGelIteratorBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGelIteratorByEachIdxKey> {
		typedef cfcore::CFGenKbGelIteratorByEachIdxKey argument_type;
