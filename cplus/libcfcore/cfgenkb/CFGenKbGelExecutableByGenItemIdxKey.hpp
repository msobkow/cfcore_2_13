...
// Description: C++18 specification for a GelExecutable by GenItemIdx index key object.
...
namespace cfcore {
	...
	public:
		CFGenKbGelExecutableByGenItemIdxKey();
		CFGenKbGelExecutableByGenItemIdxKey( const CFGenKbGelExecutableByGenItemIdxKey& src );
		virtual ~CFGenKbGelExecutableByGenItemIdxKey();
		...
		bool operator >( const CFGenKbGelExecutableByGenItemIdxKey& rhs );
		bool operator >( const CFGenKbGelExecutableBuff& rhs );
		cfcore::CFGenKbGelExecutableByGenItemIdxKey operator =( cfcore::CFGenKbGelExecutableByGenItemIdxKey& src );
		cfcore::CFGenKbGelExecutableByGenItemIdxKey operator =( cfcore::CFGenKbGelExecutableBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGelExecutableByGenItemIdxKey> {
		typedef cfcore::CFGenKbGelExecutableByGenItemIdxKey argument_type;
