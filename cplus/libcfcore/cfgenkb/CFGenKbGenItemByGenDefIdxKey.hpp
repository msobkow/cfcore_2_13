...
// Description: C++18 specification for a GenItem by GenDefIdx index key object.
...
namespace cfcore {
	...
	public:
		CFGenKbGenItemByGenDefIdxKey();
		CFGenKbGenItemByGenDefIdxKey( const CFGenKbGenItemByGenDefIdxKey& src );
		virtual ~CFGenKbGenItemByGenDefIdxKey();
		...
		bool operator >( const CFGenKbGenItemByGenDefIdxKey& rhs );
		bool operator >( const CFGenKbGenItemBuff& rhs );
		cfcore::CFGenKbGenItemByGenDefIdxKey operator =( cfcore::CFGenKbGenItemByGenDefIdxKey& src );
		cfcore::CFGenKbGenItemByGenDefIdxKey operator =( cfcore::CFGenKbGenItemBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGenItemByGenDefIdxKey> {
		typedef cfcore::CFGenKbGenItemByGenDefIdxKey argument_type;
