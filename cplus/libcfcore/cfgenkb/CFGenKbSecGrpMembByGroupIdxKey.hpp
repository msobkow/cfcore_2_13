...
namespace cfcore {
	...
	public:
		CFGenKbSecGrpMembByGroupIdxKey();
		CFGenKbSecGrpMembByGroupIdxKey( const CFGenKbSecGrpMembByGroupIdxKey& src );
		virtual ~CFGenKbSecGrpMembByGroupIdxKey();
		...
		bool operator >( const CFGenKbSecGrpMembByGroupIdxKey& rhs );
		bool operator >( const CFGenKbSecGrpMembBuff& rhs );
		cfcore::CFGenKbSecGrpMembByGroupIdxKey operator =( cfcore::CFGenKbSecGrpMembByGroupIdxKey& src );
		cfcore::CFGenKbSecGrpMembByGroupIdxKey operator =( cfcore::CFGenKbSecGrpMembBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbSecGrpMembByGroupIdxKey> {
		typedef cfcore::CFGenKbSecGrpMembByGroupIdxKey argument_type;
