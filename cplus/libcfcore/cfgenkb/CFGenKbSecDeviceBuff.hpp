...
namespace cfcore {
	...
	class CFGenKbSecDeviceBuff : public cflib::ICFLibCloneableObj
	{
	public:
	...
	public:
		...
		CFGenKbSecDeviceBuff( const CFGenKbSecDeviceBuff& src );

		virtual ~CFGenKbSecDeviceBuff();
		...
		bool operator >( const CFGenKbSecDevicePKey& rhs );
		bool operator >( const CFGenKbSecDeviceBuff& rhs );
		cfcore::CFGenKbSecDeviceBuff operator =( cfcore::CFGenKbSecDeviceBuff& src );
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbSecDeviceBuff> {
		typedef cfcore::CFGenKbSecDeviceBuff argument_type;
