...
// Description: C++18 specification of a GelInstruction primary key object.
...
namespace cfcore {
	...
	public:
		...
		CFGenKbGelInstructionPKey();
		CFGenKbGelInstructionPKey( const CFGenKbGelInstructionPKey& src );
		virtual ~CFGenKbGelInstructionPKey();
		...
		cfcore::CFGenKbGelInstructionPKey operator =( cfcore::CFGenKbGelInstructionPKey& src );
		cfcore::CFGenKbGelInstructionPKey operator =( cfcore::CFGenKbGelInstructionBuff& src );
	};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGelInstructionPKey> {
		typedef cfcore::CFGenKbGelInstructionPKey argument_type;
