...
namespace cfcore {
	...
	public:
		CFGenKbSecGrpMembByClusterIdxKey();
		CFGenKbSecGrpMembByClusterIdxKey( const CFGenKbSecGrpMembByClusterIdxKey& src );
		virtual ~CFGenKbSecGrpMembByClusterIdxKey();
		...
		bool operator >( const CFGenKbSecGrpMembByClusterIdxKey& rhs );
		bool operator >( const CFGenKbSecGrpMembBuff& rhs );
		cfcore::CFGenKbSecGrpMembByClusterIdxKey operator =( cfcore::CFGenKbSecGrpMembByClusterIdxKey& src );
		cfcore::CFGenKbSecGrpMembByClusterIdxKey operator =( cfcore::CFGenKbSecGrpMembBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbSecGrpMembByClusterIdxKey> {
		typedef cfcore::CFGenKbSecGrpMembByClusterIdxKey argument_type;
