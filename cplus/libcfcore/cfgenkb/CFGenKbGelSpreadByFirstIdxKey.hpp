...
// Description: C++18 specification for a GelSpread by FirstIdx index key object.
...
namespace cfcore {
	...
	public:
		CFGenKbGelSpreadByFirstIdxKey();
		CFGenKbGelSpreadByFirstIdxKey( const CFGenKbGelSpreadByFirstIdxKey& src );
		virtual ~CFGenKbGelSpreadByFirstIdxKey();
		...
		bool operator >( const CFGenKbGelSpreadByFirstIdxKey& rhs );
		bool operator >( const CFGenKbGelSpreadBuff& rhs );
		cfcore::CFGenKbGelSpreadByFirstIdxKey operator =( cfcore::CFGenKbGelSpreadByFirstIdxKey& src );
		cfcore::CFGenKbGelSpreadByFirstIdxKey operator =( cfcore::CFGenKbGelSpreadBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGelSpreadByFirstIdxKey> {
		typedef cfcore::CFGenKbGelSpreadByFirstIdxKey argument_type;
