...
namespace cfcore {
	...
	public:
		CFGenKbSysClusterByClusterIdxKey();
		CFGenKbSysClusterByClusterIdxKey( const CFGenKbSysClusterByClusterIdxKey& src );
		virtual ~CFGenKbSysClusterByClusterIdxKey();
		...
		bool operator >( const CFGenKbSysClusterByClusterIdxKey& rhs );
		bool operator >( const CFGenKbSysClusterBuff& rhs );
		cfcore::CFGenKbSysClusterByClusterIdxKey operator =( cfcore::CFGenKbSysClusterByClusterIdxKey& src );
		cfcore::CFGenKbSysClusterByClusterIdxKey operator =( cfcore::CFGenKbSysClusterBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbSysClusterByClusterIdxKey> {
		typedef cfcore::CFGenKbSysClusterByClusterIdxKey argument_type;
