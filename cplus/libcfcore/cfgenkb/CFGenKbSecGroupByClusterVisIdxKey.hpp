...
namespace cfcore {
	...
	public:
		CFGenKbSecGroupByClusterVisIdxKey();
		CFGenKbSecGroupByClusterVisIdxKey( const CFGenKbSecGroupByClusterVisIdxKey& src );
		virtual ~CFGenKbSecGroupByClusterVisIdxKey();
		...
		bool operator >( const CFGenKbSecGroupByClusterVisIdxKey& rhs );
		bool operator >( const CFGenKbSecGroupBuff& rhs );
		cfcore::CFGenKbSecGroupByClusterVisIdxKey operator =( cfcore::CFGenKbSecGroupByClusterVisIdxKey& src );
		cfcore::CFGenKbSecGroupByClusterVisIdxKey operator =( cfcore::CFGenKbSecGroupBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbSecGroupByClusterVisIdxKey> {
		typedef cfcore::CFGenKbSecGroupByClusterVisIdxKey argument_type;
