...
// Description: C++18 specification for a GelIterator by FirstIdx index key object.
...
namespace cfcore {
	...
	public:
		CFGenKbGelIteratorByFirstIdxKey();
		CFGenKbGelIteratorByFirstIdxKey( const CFGenKbGelIteratorByFirstIdxKey& src );
		virtual ~CFGenKbGelIteratorByFirstIdxKey();
		...
		bool operator >( const CFGenKbGelIteratorByFirstIdxKey& rhs );
		bool operator >( const CFGenKbGelIteratorBuff& rhs );
		cfcore::CFGenKbGelIteratorByFirstIdxKey operator =( cfcore::CFGenKbGelIteratorByFirstIdxKey& src );
		cfcore::CFGenKbGelIteratorByFirstIdxKey operator =( cfcore::CFGenKbGelIteratorBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGelIteratorByFirstIdxKey> {
		typedef cfcore::CFGenKbGelIteratorByFirstIdxKey argument_type;
