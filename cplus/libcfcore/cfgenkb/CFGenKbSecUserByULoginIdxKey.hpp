...
namespace cfcore {
	...
	public:
		CFGenKbSecUserByULoginIdxKey();
		CFGenKbSecUserByULoginIdxKey( const CFGenKbSecUserByULoginIdxKey& src );
		virtual ~CFGenKbSecUserByULoginIdxKey();
		...
		bool operator >( const CFGenKbSecUserByULoginIdxKey& rhs );
		bool operator >( const CFGenKbSecUserBuff& rhs );
		cfcore::CFGenKbSecUserByULoginIdxKey operator =( cfcore::CFGenKbSecUserByULoginIdxKey& src );
		cfcore::CFGenKbSecUserByULoginIdxKey operator =( cfcore::CFGenKbSecUserBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbSecUserByULoginIdxKey> {
		typedef cfcore::CFGenKbSecUserByULoginIdxKey argument_type;
