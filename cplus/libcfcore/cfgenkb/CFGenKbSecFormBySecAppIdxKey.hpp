...
namespace cfcore {
	...
	public:
		CFGenKbSecFormBySecAppIdxKey();
		CFGenKbSecFormBySecAppIdxKey( const CFGenKbSecFormBySecAppIdxKey& src );
		virtual ~CFGenKbSecFormBySecAppIdxKey();
		...
		bool operator >( const CFGenKbSecFormBySecAppIdxKey& rhs );
		bool operator >( const CFGenKbSecFormBuff& rhs );
		cfcore::CFGenKbSecFormBySecAppIdxKey operator =( cfcore::CFGenKbSecFormBySecAppIdxKey& src );
		cfcore::CFGenKbSecFormBySecAppIdxKey operator =( cfcore::CFGenKbSecFormBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbSecFormBySecAppIdxKey> {
		typedef cfcore::CFGenKbSecFormBySecAppIdxKey argument_type;
