...
// Description: C++18 specification for a GelSpread by LastIdx index key object.
...
namespace cfcore {
	...
	public:
		CFGenKbGelSpreadByLastIdxKey();
		CFGenKbGelSpreadByLastIdxKey( const CFGenKbGelSpreadByLastIdxKey& src );
		virtual ~CFGenKbGelSpreadByLastIdxKey();
		...
		bool operator >( const CFGenKbGelSpreadByLastIdxKey& rhs );
		bool operator >( const CFGenKbGelSpreadBuff& rhs );
		cfcore::CFGenKbGelSpreadByLastIdxKey operator =( cfcore::CFGenKbGelSpreadByLastIdxKey& src );
		cfcore::CFGenKbGelSpreadByLastIdxKey operator =( cfcore::CFGenKbGelSpreadBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfcore::CFGenKbGelSpreadByLastIdxKey> {
		typedef cfcore::CFGenKbGelSpreadByLastIdxKey argument_type;
