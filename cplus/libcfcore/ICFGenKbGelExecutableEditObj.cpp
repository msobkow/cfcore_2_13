// Description: C++18 Instance Edit Object interface implementation for CFGenKb GelExecutable.
...
namespace cfcore {
	...
	const std::string ICFGenKbGelExecutableEditObj::CLASS_NAME( "ICFGenKbGelExecutableEditObj" );

	ICFGenKbGelExecutableEditObj::ICFGenKbGelExecutableEditObj()
