// Description: C++18 Instance Edit Object interface implementation for CFGenKb GelSpread.
...
namespace cfcore {
	...
	const std::string ICFGenKbGelSpreadEditObj::CLASS_NAME( "ICFGenKbGelSpreadEditObj" );

	ICFGenKbGelSpreadEditObj::ICFGenKbGelSpreadEditObj()
