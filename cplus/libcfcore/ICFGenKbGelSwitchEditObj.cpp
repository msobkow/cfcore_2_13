// Description: C++18 Instance Edit Object interface implementation for CFGenKb GelSwitch.
...
namespace cfcore {
	...
	const std::string ICFGenKbGelSwitchEditObj::CLASS_NAME( "ICFGenKbGelSwitchEditObj" );

	ICFGenKbGelSwitchEditObj::ICFGenKbGelSwitchEditObj()
